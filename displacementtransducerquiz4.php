...
1) LVDT windings wounds on ?</div>
<div class="qselections">
<input type="radio" value="a" name="question1">a) Aluminum<br>
<input type="radio" value="b" name="question1">b) Ferrite<br>
<input type="radio" value="c" name="question1">c) Copper<br>
...
<div class="qheader">
2) In a transducer, the observed output deviates from the correct value by a constant factor the resulting error is called ?</div>
<div class="qselections">
<input type="radio" value="a" name="question2">a) Zero Error<br>
<input type="radio" value="b" name="question2">b) Sensitivity Error<br>
<input type="radio" value="c" name="question1">c) Non-conformity Error<br>
<input type="radio" value="d" name="question1">d) Hysteresis Error<br>
</div>

<br>

<div class="qheader">
3) A transducer has an output impedance of 1KW and the load resistance is 1MW, the transducer behaves as ?</div>
<div class="qselections">

<input type="radio" value="a" name="question3">a) A constant current source <br>
<input type="radio" value="b" name="question3">b) A constant voltage source <br>
<input type="radio" value="c" name="question1">c) A constant power source<br>
...
<div class="qheader">
4) The lower limit of useful working range of a transducer is determined by ?</div>
<div class="qselections">
<input type="radio" value="a" name="question4">a) Minimum useful input level <br>
<input type="radio" value="b" name="question4">b) By transducer error and noise<br>
<input type="radio" value="c" name="question1">c) Cross sensitivity<br>
<input type="radio" value="d" name="question1">d) Dynamic response<br>
</div>

<br>

<div class="qheader">
5) While selecting a transducer for a particular application ?</div>
<div class="qselections">
<input type="radio" value="a" name="question5">a) Only the input characteristics should be considered <br>
<input type="radio" value="b" name="question5">b) Only the output characteristics should be considered <br>
<input type="radio" value="c" name="question1">c) Only the transfer characteristics should be considered <br>
<input type="radio" value="d" name="question1">d) Only the transfer characteristics should be considered <br>
</div>

<br>

<div class="qheader">
6) A resistance potentiometer is a ?</div>
<div class="qselections">
<input type="radio" value="a" name="question6">a) First order instrument   <br>
<input type="radio" value="b" name="question6">b) Zero order instrument <br>
<input type="radio" value="c" name="question6">c) Second order instrument<br>
...
<div class="qheader">
7) Reactive current through the capacitive load produces ?</div>
<div class="qselections">
<input type="radio" value="a" name="question7">a)Magnetic field<br>
<input type="radio" value="b" name="question7">b)Electric field<br>
<input type="radio" value="c" name="question7">c)Super magnetic field<br>
<input type="radio" value="d" name="question7">d)None  <br>
...
<div class="qheader">
8) One of the following types of capacitor which is polarized is ?</div>
<div class="qselections">
<input type="radio" value="a" name="question8">a) Electrolytic <br>
<input type="radio" value="b" name="question8">b) Ceramic<br>
<input type="radio" value="c" name="question8">c) Paper<br>
<input type="radio" value="d" name="question8">d) Mica <br>
...
<div class="qheader">
9) Strain gauge, LVDT and thermocouple are examples of ?</div>
<div class="qselections">
<input type="radio" value="a" name="question9">a) Active transducers<br>
<input type="radio" value="b" name="question9">b) Passive transducers<br>
<input type="radio" value="c" name="question9">c) Analog transducers<br>
<input type="radio" value="d" name="question9">d) Primary transducers<br>
</div>

<br>

<div class="qheader">
10) LVDT is transducer ?</div>
<div class="qselections">
<input type="radio" value="a" name="question10">a) Active type<br>
<input type="radio" value="b" name="question10">b) Passive type<br>
