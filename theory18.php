...
<?php if (isset($_SESSION['user'])) { ?>
	...
	<div id="page-bgbtm">
		...
		<div class="post-bgbtm">
				...
				<div class="entry">
				<div align="center"><img src="images/Graph Displacement Vs Output Voltage.bmp" alt=""/><br/><font color="#000000">Graph Displacement Vs Output Voltage</font></div><br/>
				<p>The output is not linear as the core travels near the boundaries of its range. This is because less magnetic flux is coupled to the core from the primary.</p>
                <p><strong><font color="#000000">Why Use Of A.C. L.V.D.T.&nbsp;&nbsp;:</font></strong><br>
LVDT is an electrical transformer, it requires AC power of an amplitude and frequency quite different from ordinary power lines to operate properly. The AC LVDT is able to tolerate the extreme variations in operating temperature that the internal circuitry of the DC LVDT could not tolerate.</p>
<p><strong><font color="#000000">Advantages of L.V.D.T.&nbsp;&nbsp;&nbsp;:</font></strong><br>
LVDTs have certain significant features and benefits, most of which derive from its fundamental physical principles of operation or from the materials and techniques used in its construction.</p>
<p><strong><font color="#000000">Friction-Free Operation&nbsp;&nbsp;&nbsp;:</font></strong><br>
One of the most important features of an LVDT is its friction-free operation. In normal use, there is no mechanical contact between the LVDT's core and coil assembly, so there is no rubbing, dragging or other source of friction. This feature is particularly useful in materials testing, vibration displacement measurements, and high resolution dimensional gaging systems.</p>
<p><strong><font color="#000000">Infinite Resolution&nbsp;&nbsp;&nbsp;:</font></strong><br>
...
<p><strong><font color="#000000">Unlimited Mechanical Life&nbsp;&nbsp;&nbsp;:</font></strong><br>
Because there is normally no contact between the LVDT's core and coil structure, no parts can rub together or wear out. This means that an LVDT features unlimited mechanical life. This factor is especially important in high reliability applications such as aircraft, satellites and space vehicles, and nuclear installations. It is also highly desirable in many industrial process control and factory automation systems.</p>
<p><strong><font color="#000000">Over travel Damage Resistant&nbsp;&nbsp;&nbsp;:</font></strong><br>
The internal bore of most LVDTs is open at both ends. In the event of unanticipated over travel, the core is able to pass completely through the sensor coil assembly without causing damage. This invulnerability to position input overload makes an LVDT the ideal sensor for applications like extensometers that are attached to tensile test samples in destructive materials testing apparatus.</p>
<p><strong><font color="#000000">Single Axis Sensitivity&nbsp;&nbsp;&nbsp;:</font></strong><br>
An LVDT responds to motion of the core along the coil's axis, but is generally insensitive to cross-axis motion of the core or to its radial position. Thus, an LVDT can usually function without adverse effect in applications involving misaligned or floating moving members, and in cases where the core doesn't travel in a precisely straight line.</p>
<p><strong><font color="#000000">Separable Coil And Core&nbsp;&nbsp;&nbsp;:</font></strong><br>
Because the only interaction between an LVDT's core and coil is magnetic coupling, the coil assembly can be isolated from the core by inserting a non-magnetic tube between the core and the bore. By doing so, a pressurized fluid can be contained within the tube, in which the core is free to move, while the coil assembly is unpressurized. This feature is often utilized in LVDTs used for
spool position feedback in hydraulic proportional and/or servo valves.</p>
<div ><strong></strong>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="theory8.php"><INPUT 
                        TYPE=IMAGE 
                         SRC="images/back copy.jpg" />
</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="theory118.php">
<INPUT 
                        TYPE=IMAGE 
