...
1)Thermocouples are?</div>
<div class="qselections">
<input type="radio" value="a" name="question1">a)passive transducers<br>
<input type="radio" value="b" name="question1">b)active transducers<br>
<input type="radio" value="c" name="question1">c)both active and passive transducers<br>
<input type="radio" value="d" name="question1">d)output transducers.<br>
</div>

<br>

<div class="qheader">
2)A device that changes one form of energy to another is called ?</div>
<div class="qselections">
<input type="radio" value="a" name="question2">a)rheostat<br>
<input type="radio" value="b" name="question2">b)oscillator<br>
<input type="radio" value="c" name="question2">c)transducer<br>
<input type="radio" value="d" name="question2">d)varicap.<br>
</div>

<br>

<div class="qheader">
3)Which of the following electrical equipment cannot convert ac into dc ?</div>
<div class="qselections">

<input type="radio" value="a" name="question3">a)diode<br>
<input type="radio" value="b" name="question3">b)converter<br>
<input type="radio" value="c" name="question3">c)Transformer<br>
<input type="radio" value="d" name="question3">d)mercury arc rectifier<br>
</div>

<br>

<div class="qheader">
4)The insulation resistance of a transformer winding can be easily measured with?</div>
<div class="qselections">
<input type="radio" value="a" name="question4">a)Wheatstone bridge<br>
<input type="radio" value="b" name="question4">b)megger<br>
<input type="radio" value="c" name="question4">c)Kelvin bridge<br>
<input type="radio" value="d" name="question4">d)voltmeter.<br>
</div>

<br>

<div class="qheader">
5)The resistance of a field coil may be correctly measured by using ?</div>
<div class="qselections">
<input type="radio" value="a" name="question5">a)a voltmeter and an ammeter<br>
<input type="radio" value="b" name="question5">b)Schering bridge<br>
<input type="radio" value="c" name="question5">c)a Kelvin double bridge<br>
<input type="radio" value="d" name="question5">d)a Maxwell bridge.<br>
</div>

<br>

<div class="qheader">
6)Which of the following electrical equipment cannot convert ac into dc ?</div>
<div class="qselections">
<input type="radio" value="a" name="question6">a)diode <br>
<input type="radio" value="b" name="question6">b)converter<br>
<input type="radio" value="c" name="question6">c)transformer<br>
<input type="radio" value="d" name="question6">d)mercury arc rectifier.<br>
</div>

<br>

<div class="qheader">
7)The resistance of a field coil may be correctly measured by using ?</div>
<div class="qselections">
<input type="radio" value="a" name="question7">a)a voltmeter and an ammeter<br>
<input type="radio" value="b" name="question7">b)Schering bridge<br>
<input type="radio" value="c" name="question7">c)a Kelvin double bridge<br>
<input type="radio" value="d" name="question7">d)a Maxwell bridge.<br>
...
<div class="qheader">
8)The wein bridge uses only  ?</div>
<div class="qselections">
<input type="radio" value="a" name="question8">a)Inductors<br>
<input type="radio" value="b" name="question8">b)Capacitors<br>
<input type="radio" value="c" name="question8">c)Resistors<br>
<input type="radio" value="d" name="question8">d)Capacitors and Resistors.<br>
...
<div class="qheader">
9)The most serious source of error in a c bridge measurement is  ?</div>
<div class="qselections">
<input type="radio" value="a" name="question9">a)eddy currents<br>
<input type="radio" value="b" name="question9">b)leakage currents<br>
<input type="radio" value="c" name="question9">c)residual imperfectness<br>
<input type="radio" value="d" name="question9">d)stray fields.<br>
</div>

<br>

<div class="qheader">
10)Moving iron instruments ?</div>
<div class="qselections">
<input type="radio" value="a" name="question10">a)have a linear scale<br>
<input type="radio" value="b" name="question10">b)do not have a linear scale<br>
<input type="radio" value="c" name="question10">c)both a and b)<br>
<input type="radio" value="d" name="question10">d)none.<br>
</div>
