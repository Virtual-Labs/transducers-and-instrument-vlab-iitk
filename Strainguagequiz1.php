...
<script src="strainguagequiz1.js">
</script>
...
<input type="radio" value="c" name="question1">c) capacitive transducer<br>
<input type="radio" value="d" name="question1">d) Piezo electric crystals<br>
</div>
...
<input type="radio" value="c" name="question1">c) photovoltaic cell<br>
<input type="radio" value="d" name="question1">d) Photo emissive cell<br>
</div>
...
<input type="radio" value="c" name="question1">c) an output transducer<br>
<input type="radio" value="d" name="question1">d) (b) and (c)<br>
</div>
...
<div class="qselections">
<input type="radio" value="a" name="question5">a) Zero errors<br>
<input type="radio" value="b" name="question5">b) Sensitivity Errors<br>
<input type="radio" value="c" name="question1">c) Non-conformity errors <br>
...
<div class="qheader">
7) The lower limit of useful working range of a transducer is determined by ?</div>
<div class="qselections">
<input type="radio" value="a" name="question7">a) minimum useful input level <br>
<input type="radio" value="b" name="question7">b) by transducer error and noise <br>
<input type="radio" value="c" name="question7">c) cross sensitivity <br>
<input type="radio" value="d" name="question7">d) Dynamic response<br>
...
<div class="qheader">
8) While selecting a transducer for a particular application ?</div>
<div class="qselections">
<input type="radio" value="a" name="question8">a) only the input characteristics should be considered<br>
<input type="radio" value="b" name="question8">b) only the output characteristics should be considered <br>
<input type="radio" value="c" name="question8">c) only the transfer characteristics should be considered<br>
<input type="radio" value="d" name="question8">d) input, output and transfer characteristics should be considered<br>
...
<div class="qheader">
9) A cantilever is used as a primary sensing element for measurement of force. The measured deflection 0.5 mm for a particular set up. Suppose each of the dimentions i.e. length, width and thickness of the cantilever are doubled with the force and material of cantilever remaining the same, the deflection of the cantilever is ?</div>
<div class="qselections">
<input type="radio" value="a" name="question9">a) 1 mm <br>
<input type="radio" value="b" name="question9">b) 2 mm<br>
<input type="radio" value="c" name="question9">c) 0.25 mm<br>
<input type="radio" value="d" name="question9">d) 0.125 mm<br>
</div>

<br>

<div class="qheader">
10) A heliport is used for measurement of linear displacement of 0.1m.  It uses    a 10 turn potentiometer (3000of movement full scale) with a total of 500 turns of wire.  Its resolution is ?</div>
<div class="qselections">
<input type="radio" value="a" name="question10">a) 0.1 mm<br>
<input type="radio" value="b" name="question10">b) 0.2 mm<br>
<input type="radio" value="c" name="question10">c) 0.01 mm<br>
<input type="radio" value="d" name="question10">d) 0.02 mm<br>
