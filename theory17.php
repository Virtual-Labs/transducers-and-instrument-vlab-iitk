...
//  End -->
    ...
    <td width="128">&nbsp;</td>
    <td width="169" align="right"><font color="#000000" style="text-align:right">Share:&nbsp;&nbsp;</font><a href="" style="padding-left:04px;"><img src="images/facebook.jpg" /></a>&nbsp;&nbsp;<a href=""><img src="images/twitter.jpg" /></a></td>
  </tr>
  </table>
</div>
<!-- Script Size:  2.32 KB -->
...
<form action="Google_search_results.php" id="cse-search-box">
  <div>
   ...
   <br /></td>
    ...
    <td><option value="google.com"></b></option>
...
<?php if (isset($_SESSION['user'])) { ?>
	...
	<div id="page-bgbtm">
		...
		<div class="post-bgbtm">
				...
				<div class="entry">
				<strong><font color="#000000"><span class="style5">DAC Characteristics :</span></font></strong><br/>
			<p>1.Resolution<br/>
               2.Offseterror<br/>
               3.GainError<br/>
               4.Monotonicity<br/>
               5.Relative Accuracy</p>
				<p><strong><font color="#000000"><span class="style5">1. Resolution :</span></font></strong> This is the number of possible output levels the DAC is designed to reproduce. Resolution is the number of distinct analog outputs (voltage or current) that can be produced by a DAC.<br/>
                                                   Resolution = Vref/2n<br/>
                   <strong><font color="#000000"><span class="style5">2. Offset error :</span></font></strong>  A constant voltage difference between the ideal DAC output and the actual. The voltage axis intercept of the DAC output curve is different than the ideal.
									  <div align="center"><img src="images/Offset error.bmp" alt=""/><br/><font color="#000000">Offset error</font></div><br/>
									  
				<strong><font color="#000000"><span class="style5">3. Gain error :</span></font></strong>&nbsp;&nbsp;Difference in slope of the ideal curve and the actual DAC output<br/><br/>				
				<div align="center"><img src="images/Gain error.bmp" alt=""/><br/><font color="#000000">Gain error</font></div><br/>
			      Low Gain Error: Actual slope less than ideal<br/><br/>
                  High gain error: Actual slope greater than ideal</p><br/><br/>
<p><strong><font color="#000000"><span class="style5">4.	Monotonicity :</span></font></strong>&nbsp;&nbsp;This refers to the ability of a DAC's analog output to move only in the direction that the digital input moves (i.e., if the input increases, the output doesn't dip before asserting the correct output.) This characteristic is very important for DACs used as a low frequency signal source or as a digitally programmable trim element.</p> 
				  <div align="center"><img src="images/Monotonicinity.bmp" alt=""/><br/><font color="#000000">Monotonicinity</font></div><br/>
				<p><strong><font color="#000000"><span class="style5">5.	Dynamic range :</span></font></strong>
				This is a measurement of the difference between the large and smallest signals the DAC can reproduce expressed in decibels.<br/>
				<strong><font color="#000000"><span class="style5">6.	Accuracy :</span></font></strong>&nbsp;&nbsp;The output accuracy of the R/2R ladder is typically specified in terms of full-scale output ± some number of least significant bits. R/2R ladders are usually specified with output accuracies of ±1 LSB or ±1/2 LSB. For example, a ±1/2 LSB specification on a 10 bit ladder is exactly the same as ±0.04883% full-scale accuracy</p>
     			 <div ><strong></strong>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="theory7.php"><INPUT 
                        TYPE=IMAGE 
                         SRC="images/back copy.jpg" />
     			 </a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="theory117.php">
     			 <INPUT 
                        TYPE=IMAGE 
