...
<?php if (isset($_SESSION['user'])) { ?>
	...
	<div id="page-bgbtm">
		...
		<div class="entry">
					 <p>Likewise,  displacing the core to the right (Figure 4) causes the second secondary E2 to  be more strongly coupled to the primary than the first secondary E1. The  greater voltage of the second secondary causes an output voltage (E2-E1) to be  out of phase with the primary voltage. </p>
<div align="center">
  <p><img src="images/d14.JPG" alt="d14" /></p>
  <p align="center">Figure 4: Coe Movement at Right Side</p></div>
  <h3><strong><font color="#000000">Calculations  for L.V.D.T.</font></strong>-  </h3>
  <p>The LVDT consists of a primary coil and two  secondary coils. The two secondary coils are connected differentially for  providing the output. The secondary coils are located on the two sides of the  primary coil on the bobbin or sleeve, and these two output windings (secondary  coils) are connected in opposition to produce zero output at the middle  position of the armature. The lengths of primary and two identical halves of  the secondary coils are b and m, respectively.The coils have an  inside radius and an outside radius of the spacing between the coils is d. inside  the coils,a ferromagnetic armature of length La and radius(neglecting  the bobbin thickness) moves in an axial direction. The number of turns in the  primary coil is, and      is the number of turns in each secondary coil.  The cross-sectional view of LVDT is shown in Fig. 5.With a primary sinusoidal  excitation voltage and a current(RMS)  of frequency <em>f</em>.</p>
  </p>
<br/>  <p><div align="center">
  <p><img src="images/d15.jpg" alt="d15" /></p>
  <p align="center">Figure 5: Cross-sectional view of an L.V.D.T.</p>
  <p>&nbsp;</p>
</div></p>



					 <p>So the RMS voltage <em>v</em>1 induced in the secondary coil <em>S</em>1  is </p>
					   <div align="center"><img src="images/d16.jpg" alt="d16" /></div>
					   And that in coil S2 is
					   <div align="center"><img src="images/d17.jpg" alt="d17" /></div><br />
					   <p align="left">Where<br />
					     X1=distance penetrated by the  armature toward the secondary coil <em>S</em>1;<br />
					     X2= distance penetrated by the  armature toward the secondary coil <em>S</em>2.<br />
					     Taking the length of armature <em>La </em>= 3<em>b </em>+2<em>d</em>, d is very small so neglecting 2<em>d </em>compared with <em>b</em>,</p>
					   <p align="left"><strong> The differential output voltage <em>v </em>= <em>v</em>1 <em>− v</em>2</strong></p>
					   <p align="left">All the Parameters are specified below- <br />
					     r0=10.3mm<br />
  <em> r1=3.17mm</em><br />
  <strong><em>La</em></strong><em> =15mm</em><br />
  <em> <strong>b</strong> =32mm (m=b=10.66mm)</em><br />
  <em>np=42</em><br />
  ns=5 </p>
  					   <div align="center">
  					     <p><img src="images/d18.jpg" alt="d17" /></p>
  					     <p align="center">Figure6. Graph Displacement Vs Output Voltage</p>
				       </div>
  					   <p>Note that the  output is not linear as the core travels near the boundaries of its range. This  is because less magnetic flux is coupled to the core from the primary. However,  because LVDTs have excellent repeatability, nonlinearity near the boundaries of  the range of the device can be predicted by a table or polynomial curve-fitting  function, thus extending the range of device. <strong><u><span class="style5"></span></u></strong></p>
  					   <strong><h3><font color="#000000">Calculation for Displacement</font></h3> </strong>
  					   <p>There  is a linear relationship between displacement and voltage. As core moves the  voltages varies linearly according to displacement.<br />
  					     So the equation of straight line is -          <strong>y=mx+c</strong><br />
  					     Where:<br />
  					     y=voltage<br />
  					     x=displacement
  					     </p>
  					   So the,                 					</p>
  					   <div align="center">Displacement     <p><img src="images/d18.jpg" alt="d17" /></p>(here c=0)</div>
           <br />

					   <p align="left">&nbsp;</p>
					   <br/>
<div align="right"><br> <a href="about_exp7.php"><INPUT 
                        TYPE=IMAGE 
                         SRC="images/back copy.jpg" /></a>
	  </div>
