...
1)Lissageous patterns are used to measure ?</div>
<div class="qselections">
<input type="radio" value="a" name="question1">a)voltage and frequency<br>
<input type="radio" value="b" name="question1">b)frequency and phase shift<br>
<input type="radio" value="c" name="question1">c)frequency and amplitude<br>
<input type="radio" value="d" name="question1">d)amplitude and flux.<br>
</div>
...
<div class="qselections">
<input type="radio" value="a" name="question2">a)its input resistance is high and does not changes with range switch<br>
<input type="radio" value="b" name="question2">b)its input resistance is high<br>
<input type="radio" value="c" name="question2">c)its input resistance is low<br>
<input type="radio" value="d" name="question2">d)it is cheaper.<br>
</div>
...
<input type="radio" value="c" name="question3">c)it controls the deflecting torque effectively<br>
<input type="radio" value="d" name="question3">d)it improves torque-weight ratio.<br>
</div>

<br>

<div class="qheader">
4) On an oscilloscope, the Lissageous pattern of eight keeps on changing in shape when the ratio of frequencies is?</div>
<div class="qselections">
<input type="radio" value="a" name="question4">a)not exactly 1:1<br>
<input type="radio" value="b" name="question4">b)not exactly 2:1<br>
<input type="radio" value="c" name="question4">c)exactly 3:1<br>
<input type="radio" value="d" name="question4">d)exactly 4:1<br>
</div>

<br>

<div class="qheader">
5)A moving waveform on an oscilloscope can be made stationary by adjusting ?</div>
<div class="qselections">
<input type="radio" value="a" name="question5">a)horizontal position control<br>
<input type="radio" value="b" name="question5">b)coarse frequency control<br>
<input type="radio" value="c" name="question5">c)sync-amplitude control<br>
<input type="radio" value="d" name="question5">d)vertical positioning control.<br>
</div>

<br>

<div class="qheader">
6) Two sine waves of same amplitude and phase are applied to the vertical and horizontal inputs of an oscilloscope.  The pattern on the screen will be ?</div>
<div class="qselections">
<input type="radio" value="a" name="question6">a)Circle <br>
<input type="radio" value="b" name="question6">b)None of these<br>
<input type="radio" value="c" name="question6">c)eclipse<br>
<input type="radio" value="d" name="question6">d)horizontal line.<br>
</div>

<br>

<div class="qheader">
7)Reed frequency meter is essentially a ?</div>
<div class="qselections">
<input type="radio" value="a" name="question7">a)recording system<br>
<input type="radio" value="b" name="question7">b)oscillatory measuring system<br>
<input type="radio" value="c" name="question7">c)deflection measuring system<br>
<input type="radio" value="d" name="question7">d)vibration measuring system .<br>
...
<div class="qheader">
8)Electronic instruments are preferred because they have ?</div>
<div class="qselections">
<input type="radio" value="a" name="question8">a)very fast response<br>
<input type="radio" value="b" name="question8">b)low resistance in parallel circuit<br>
<input type="radio" value="c" name="question8">c)no indicating part<br>
<input type="radio" value="d" name="question8">d)high resistance in series circuit<br>
...
<div class="qheader">
9)Basic charge measuring instrument is ?</div>
<div class="qselections">
<input type="radio" value="a" name="question9">a)Duddel's oscillograph<br>
<input type="radio" value="b" name="question9">b)Cathode ray oscillograph<br>
<input type="radio" value="c" name="question9">c)Vibration Galvanometer<br>
<input type="radio" value="d" name="question9">d)Bailastic Galvanometer.<br>
</div>

<br>

<div class="qheader">
10) 30.	 Swamping resistance is used in moving coil instruments to reduce error due to ?</div>
<div class="qselections">
<input type="radio" value="a" name="question10">a)thermal EMF<br>
<input type="radio" value="b" name="question10">b)temperature<br>
<input type="radio" value="c" name="question10">c)galvanometer sensitivity<br>
</div>
