...
<?php if (isset($_SESSION['user'])) { ?>
	...
	<div id="page-bgbtm">
		...
		<div class="post-bgbtm">
			  ...
			  <div class="entry">
				  <!--<h3 align="right" class="style4"><font color="#0000FF">Quiz </font> </h3>-->
				  <br>
				  <p>Controlling the flow in piping systems is a significant issue in the chemical process industries.
Obviously, in order to control the flow in a pipe, the flow must be measured. This experiment
will introduce you to three devices that are used to measure flow. One, the rotameter, is a simple
mechanical device that is designed to be read by an operator. It is rugged, relatively inexpensive,
and easily installed. The second, the orifice plate, can be set up to be read locally or remotely
using pressure transducers. Both are designed for flows that do not contain significant amounts
of solid material. The third, the magnetic flow meter, is a more sophisticated device than either
the rotameter or the orifice plate. It requires that the flowing material be electrically conductive,
but can measure flows with suspended material. Brief descriptions of the three devices are on
the attached pages, along with the simplified directions and questions.<br>
Below are some basic experimental guidelines that are common to all three sub-experiment .<br>
<b>1.</b> Trace the piping in the flow loop so you understand the basic process of getting flow from
the feed tank to the receiving tank .<br>
<b>2.</b> Ensure that the water level in the receiving tank is above the pump that recycles the water in
the receiving tank to the feed tank. Use the hose and tap to fill as necessary<br>
<b>3.</b> Ensure that the feed tank is about 60% full of water. Use the recycle pump to pump from the
receiving tank to the feed tank. Before activating the recycle pump, have the lab instructor
verify that you have the valves in the correct position.<br>
<b>4.</b> Refill the receiving tank to about 50% full.<br>
<b>5.</b> Ensure that the water will only flow from the' feed pump through the desired flow measuring
device. Follow the piping and open and close the necessary valves to allow the water to
flow from the feed pump, through the measuring device, and back to the receiving tank.<br>
<b>6.</b> Close the final (discharge) valve just prior to the discharge into the receiving tank.<br>
<b>7.</b> Have the lab instructor verify that your valving is correct for the measuring device you want
to use.<br>
<b>8.</b> Turn on the feed pump<br>
<b>9.</b> Slowly open the discharge valve until you obtain a desired reading. Slowly change the
discharge valve opening to obtain different flow rates.<br>
<b>10.</b> When the receiving tank is about 50 - 60% full, activate the recycle pump.<br>
<b>11.</b> Monitor the level in the receiving tank and tum off the recycle pump if the receiving tank
level approaches the level of the top of the recycle pump.<br>
<b>12.</b> When you are ready to leave the lab, have the lab instructor verify that you have left the flow
loop in the proper condition.</p><div  align="right"><strong></strong>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="about experiment5.php"><INPUT 
                        TYPE=IMAGE 
