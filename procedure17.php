...
<?php if (isset($_SESSION['user'])) { ?>
    ...
    <a href="logout.php" style="padding-right:10px;">Logout</a><a href="user.php">Update User Profile</a> 
    </div>
    <?php } ?>  
	...
	<div id="page-bgbtm">
		...
		<div class="post-bgbtm">
			  ...
			  <div class="entry"><h3 class="style4"><font color="#000000">Procedure   </font></h3><br><p><b>1.</b> To perform the experiment first install the LabVIEW Runtime Engine setup present in the website Setup link.<br />
                    <b>2.</b> Now select the experiment you want to perform (online/offline) from the Experiments link.<br />
                    <b>3.</b>  Follow the step by step procedure to perform the Experiments<br>
					<b>4.</b> On Front panel of the VI, select the type of waveform we want to take through the tab that is either the computer generated waveform or the waveform simulated through DAQ.<br />
                    <span class="style9">a)</span>&nbsp;&nbsp;if we are using DAQ for signal generation then input the sampling rate and no. of samples required per channel, here the temperature is varied from outside to get the waveform.<br>
                     <span class="style9">b)</span>&nbsp;&nbsp;In case of computer generated signal temperature can be varied using the knob from inside the set up, from which we can select the desired temperature and get the waveform<br>
<b>5.</b> Select the desired digital input and reference voltage using the knobs which are provided on the front panel.<br /> 
<b>6.</b> The analog output voltage for corresponding digital input is generated and displayed on the front panel.<br />
<b>7.</b> To continue simulating the same experiment with different digital inputs follow above 4, 5, 6 steps.<br />
<b>8.</b> To stop the simulation click on the stop button.
<h3 class="style4"><font color="#000000">Results : </font></h3>
<p>Depending on the digital input and reference voltage we will get the output voltage.<br />
This table shows the analog output voltages for 4bit digital input if Vref=5V. </p>
<div align="center"><img src="images/r2rtable.bmp" /></div>
<p>&nbsp;</p><div align="right"><a href="about experiment7.php"><INPUT 
                        TYPE=IMAGE 
