...
<?php if (isset($_SESSION['user'])) { ?>
    ...
    <a href="/virtuallab/logout.php" style="padding-right:10px;">Logout</a><a href="user.php"></a> 
   <a href="user.php">Update Profile</a>
    ...
    <div id="page-bgbtm">
        ...
        <div class="post-bgbtm">
              ...
              <div class="entry"><h4 class="style4"><font color="#000000">b)	For magnetic pickup   </font></h4><br>
                <ul>
                  <li>Select the speed measurement using  Magnetic Pickup experiment.</li>
                  <li>The model contains a Motor whose speed  to be measured and the Magnetic pickup is mounted near to the motor shaft.</li>
                  <li>Change the input voltage of motor  through the knob. The motor speed will increase by increasing the motor  voltage.</li>
                  <li>The motor speed is detected by magnetic  pickup. </li>
                </ul>
               
              <div align="center"><img src="images/p_s6.jpg" /></div><p>The graph plot a motor speed against time-</p><div align="center"><img src="images/p_s7.jpg" /></div>
              <p>The full front panel is given below-</p>
<div align="center"><img src="images/p_s8.jpg" /></div>
<p>Now when your experiment gets over, turn it off through OFF button.</p>
<div align="center"><img src="images/p_s9.jpg" /></div>


<div>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;                    
<a href="p_s1.php"><INPUT 
                        TYPE=IMAGE 
