...
1) The data acquisition palette containing all the VIS necessary to perform analog i/o,digital i/o and counter timer operation ?</div>
<div class="qselections">
<input type="radio" value="a" name="question1">a) Vision assistant<br>
<input type="radio" value="b" name="question1">b) The DAQmx<br>
...
<div class="qheader">
2) Which hardware is used in the process of data acquisition ?</div>

<div class="qselections">
<input type="radio" value="a" name="question2">a) Transducers<br>
<input type="radio" value="b" name="question2">b) DAQ<br>
<!--<input type="radio" value="c" name="question1">c) A jungle refers to the thickest area of a rain forest<br>
<input type="radio" value="d" name="question1">d) A jungle and a rain forest each contain their own group of distinct plants and animals.<br>-->
</div>
...
<div class="qheader">
3) A transducer converts ?</div>
<div class="qselections">

<input type="radio" value="a" name="question3">a) One form of energy to other<br>
<input type="radio" value="b" name="question3">b) One form to another<br>
<!--<input type="radio" value="c" name="question1">c) A jungle refers to the thickest area of a rain forest<br>
<input type="radio" value="d" name="question1">d) A jungle and a rain forest each contain their own group of distinct plants and animals.<br>-->
</div>
...
<div class="qheader">
4) Graphical interface in labview is called ?</div>
<div class="qselections">
<input type="radio" value="a" name="question4">a) Virtual design<br>

<input type="radio" value="b" name="question4">b) Virtual instrument<br>
<!--<input type="radio" value="c" name="question1">c) A jungle refers to the thickest area of a rain forest<br>
<input type="radio" value="d" name="question1">d) A jungle and a rain forest each contain their own group of distinct plants and animals.<br>-->
</div>
...
<div class="qheader">
6) Active sensors require ?</div>
<div class="qselections">
<input type="radio" value="a" name="question6">a) An internal source of excitation<br>
<input type="radio" value="b" name="question6">b) An external source of excitation<br>
<!--<input type="radio" value="c" name="question1">c) A jungle refers to the thickest area of a rain forest<br>
<input type="radio" value="d" name="question1">d) A jungle and a rain forest each contain their own group of distinct plants and animals.<br>-->
</div>
...
<div class="qheader">
7) which of those are passive sensors ?</div>
<div class="qselections">
<input type="radio" value="a" name="question7">a) RTD<br>
<input type="radio" value="b" name="question7">b) Thermocouple<br>
<!--<input type="radio" value="c" name="question1">c) A jungle refers to the thickest area of a rain forest<br>
<input type="radio" value="d" name="question1">d) A jungle and a rain forest each contain their own group of distinct plants and animals.<br>-->
...
<div class="qheader">
8) Sensors are also called as ?</div>
<div class="qselections">
<input type="radio" value="a" name="question8">a) Output transducer<br>

<input type="radio" value="b" name="question8">b) Input transducer<br>
<!--<input type="radio" value="c" name="question1">c) A jungle refers to the thickest area of a rain forest<br>
<input type="radio" value="d" name="question1">d) A jungle and a rain forest each contain their own group of distinct plants and animals.<br>-->
...
<div class="qheader">
9) A sensor with two dissimilar metal join together ?</div>
<div class="qselections">
<input type="radio" value="a" name="question9">a) Thermistor<br>
<input type="radio" value="b" name="question9">b) Thermocouple<br>
<!--<input type="radio" value="c" name="question1">c) A jungle refers to the thickest area of a rain forest<br>
<input type="radio" value="d" name="question1">d) A jungle and a rain forest each contain their own group of distinct plants and animals.<br>-->
</div>
...
<div class="qheader">
10) The computer receive raw data through ?</div>
<div class="qselections">
<input type="radio" value="a" name="question10">a) Sensor<br>
<input type="radio" value="b" name="question10">b) DAQ device<br>
...
<p>&nbsp;</p>
			...
			</div><div style="clear: both;"><p><font color="#0000CC"><strong><a href="setup.php"><font color="#800000"></font></a></strong></font></p></div>
