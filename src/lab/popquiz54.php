...
1)Influence of…………………point on the tube support leading edge causes the static pressure to be high?</div>
<div class="qselections">
<input type="radio" value="a" name="question1">a)stagnation point<br>
<input type="radio" value="b" name="question1">b)variable point<br>
...
<div class="qheader">
2)The meter measuring total flow in a liquid employs
 ?</div>

<div class="qselections">
<input type="radio" value="a" name="question2">a)square root extraction<br>
<input type="radio" value="b" name="question2">b)differentiation<br>
<input type="radio" value="c" name="question2">c)planimeter<br>
<input type="radio" value="d" name="question2">d)variable area meter.<br>
</div>

<br>

<div class="qheader">
3)If a large number of restrictions are installed along a pipe, the pressure at the pipe output will become?</div>
<div class="qselections">

<input type="radio" value="a" name="question3">a)Less<br>
<input type="radio" value="b" name="question3">b)varies randomly<br>
<input type="radio" value="c" name="question3">c)remains constant<br>
<input type="radio" value="d" name="question3">d)more.<br>
</div>

<br>

<div class="qheader">
4)A Reynold’s number of 1000 indicates ?</div>
<div class="qselections">
<input type="radio" value="a" name="question4">a)laminar flow<br>
<input type="radio" value="b" name="question4">b)turbulent flow                                                            <br>
<input type="radio" value="c" name="question4">c)a flow which can either be turbulence or laminar<br>
...
<div class="qheader">
5)Pitot tubes are useful ?</div>
<div class="qselections">
<input type="radio" value="a" name="question5">a)For industrial applications<br>
<input type="radio" value="b" name="question5">b)for laboratory experimental  <br>
<!--<input type="radio" value="c" name="question1">c) A jungle refers to the thickest area of a rain forest<br>
<input type="radio" value="d" name="question1">d) A jungle and a rain forest each contain their own group of distinct plants and animals.<br>-->
</div>
...
<div class="qheader">
6)Water is flowing with a depth of 0.9 m over a rectangular notch 1.2 m wide.  Find the depth of flow over a right angled notch if the same were to pass over it.  Assume that both the notches have the same coefficient of discharge?</div>
<div class="qselections">
<input type="radio" value="a" name="question6">a) 1.1 m <br>
<input type="radio" value="b" name="question6">b) 0.9m<br>
<!--<input type="radio" value="c" name="question1">c) A jungle refers to the thickest area of a rain forest<br>
<input type="radio" value="d" name="question1">d) A jungle and a rain forest each contain their own group of distinct plants and animals.<br>-->
</div>
...
<div class="qheader">
7)A resistance potentiometer is a?</div>
<div class="qselections">
<input type="radio" value="a" name="question7">a)first order instrument<br>
<input type="radio" value="b" name="question7">b)Second order instrument<br>
<input type="radio" value="c" name="question7">c)Zero order instruments<br>
...
<div class="qheader">
8)…………….. next to tube must be longer than those in undisturbed flow, which increase an?</div>
<div class="qselections">
<input type="radio" value="a" name="question8">a)increase in velocity<br>
<input type="radio" value="b" name="question8">b)decrease in velocity<br>
<!--<input type="radio" value="c" name="question1">c) A jungle refers to the thickest area of a rain forest<br>
<input type="radio" value="d" name="question1">d) A jungle and a rain forest each contain their own group of distinct plants and animals.<br>-->
...
<div class="qheader">
9)An important application of the ………….tube is found in aircraft and missiles ?</div>
<div class="qselections">
<input type="radio" value="a" name="question9">a)pitot non static<br>
<input type="radio" value="b" name="question9">b)pitot static<br>
<!--<input type="radio" value="c" name="question1">c) A jungle refers to the thickest area of a rain forest<br>
<input type="radio" value="d" name="question1">d) A jungle and a rain forest each contain their own group of distinct plants and animals.<br>-->
</div>
...
<div class="qheader">
10)misalignment prevents formation of a true stagnation point at the measuring hole since the velocity is ?</div>
<div class="qselections">
<input type="radio" value="a" name="question10">a)not zero<br>
<input type="radio" value="b" name="question10">b)zero<br>
