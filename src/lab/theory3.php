...
•	Solar cells for light. 
 </p><p>Other kinds of sensors might include:</p> <p>•	Sensors which produce some other sort of electrical change. Some examples might include the following :</p><p>*	A tachometer that produces a frequency proportional to rpm.<br> 
*	Sensors which produce a set of signals in binary code proportional to pressure.<br> 
*	Sensors which produce a voltage signal with a frequency proportional to flow rate.</p><p>•	At some nominal value of the temperature (if we have a temperature sensor) the voltage divider will have a nominal output voltage. <br>
•	As the temperature changes the voltage output of the voltage divider changes.<br> 
...
<p>There are some problems with using a voltage divider.  Consider the following. </p><p>•	You might want an output signal that is zero at the nominal conditions. <br>
...
<br>
•	If the outut is something other than temperature that becomes even more clear.<br> 
*	If the sensor is a strain gage, the strain could be positive or negative, and you would want the output voltage to be similarly positive or negative, and ideally it would be proportional to strain.<br> 
*	If the sensor is a pressure sensor, you could want a positive signal for a presssure above atmospheric (or any other reference) and negative for a pressure below.</p> 
 <p>The point here is that it is common to want a zero output signal under certain, known conditions.  There are several ways you could subtract out that pesky DC voltage.  For example, you could use an operational amplifier circuit to subtract out the DC voltage.  That's more complex than another solution - using a bridge circuit. Usually a bridge circuit is what is used in this situation, and in this lesson you're going to learn about bridge circuits.  Bridge circuits are simple circuits that permit us to solve the problems noted above, and you need to learn about them. </p>
<p>Bridge Circuits:  The bridge circuit has two arms (Ra and Rb constitute one arm here, and Rc and Rs constitute the other arm).  Each arm is composed of two resistors in series, and you may want to think of each arm as a voltage divider.  The output is the difference between the outputs of the two voltage dividers.  In the bridge circuit above we have also included some source resistance for the source which drives the bridge circuit.   </p>
...
Note that the balancing of a Schering Bridge is independent of frequency.</p><br>-->
				...
				<p>&nbsp;</p><p>
					 -->
<div align="right">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;                       
<a href="about experiment3.php"><INPUT 
                        TYPE=IMAGE 
