...
<a href="/virtuallab/user.php"<?php echo $fet['User_Email_Id'];?> <style="padding-right:0px; text-decoration:none;">Update Profile</a></div><?php } ?>  
	...
	<div id="page-bgbtm">
		...
		<div class="post-bgbtm">
				...
				<div class="entry">
				 <ul>
				   <li><h3><font color="#0066FF">To Perform simulated Experiment Online</font>&nbsp;&nbsp;&nbsp;<a href="http://202.141.40.214:50001/Bridges_.html"><font color="#000000">(Click Here)</font></a></h3>&nbsp;&nbsp;&nbsp;&nbsp;
<!--						<li><h3><a href="">Realtime</a></h3>&nbsp;&nbsp;&nbsp;&nbsp;
 -->						<li><h3><font color="#0066FF">To Perform simulated Experiment Offline</font>&nbsp;&nbsp;&nbsp;<a href="AC & DC Bridges.exe"><font color="#000000">(Download executable file)</font></a></h3>
