...
<a href="/virtuallab/user.php"<?php echo $fet['User_Email_Id'];?> <style="padding-right:0px; text-decoration:none;">Update Profile</a></div><?php } ?>  
	...
	<div id="page-bgbtm">
		...
		<div class="post-bgbtm">
				<h3 class="title">Reference Junction Compensation </h3>
				
				
				<div class="entry">
				
					 <p> A factor which is important in the use of thermocouple is the requirement of a known reference temperature of the reference junction. This is because when the reference junction is not held at 0<sup>0</sup>C , the observed value must be corrected by adding to it a voltage that has resulted from a temperature difference equal to the amount by which the reference junction is above 0<sup>0</sup>C. (This is because the thermocouples are calibrated with temperature of reference junction as 0<sup>0</sup>C). <br>
	Now E<sub>T</sub> = E<sub>t</sub> + E<sub>0</sub> where E<sub>T</sub> is the total emf at temperature T, E<sub>t</sub> is the emf on account of temperature difference between detecting (hot) and the reference junction and E<sub>0</sub> is the emf due to temperature of the reference junction being above 0<sup>0</sup>C. Since, there exists a non-linear relationship between the emf and the temperature, it is important that temperatures are determined by the above process rather than converting an emf to temperature and then adding it to ambient temperature.
 <br>
					 <h3 class="style4"><font color="#000000">Lead Compensation </font></h3><p><br>
In many applications it is desirable to place the reference junction at a point far removed from the measurement junction. The connecting wires from the thermocouple head to the meter are, therefore, very long and are usually not at the same temperature throughout their length. This causes errors, which can be avoided by using connecting wires made of the same material as the thermocouple wires. The implementation of this arrangement may not be possible in many cases due to cost and other consideration. Under these circumstances, materials are chosen such that the relationship between emf and temperature is the same or almost the same as that for thermocouple wires. These wires then called compensating leads. <br> 
 <h3 class="style4"><font color="#000000">Advantages and Disadvantages of Thermocouples  </font></h3><p><br>
 <h3 class="style4"><font color="#000000">Advantages </font></h3><p><br><b>1.</b> Thermocouples are cheaper than the resistance thermometers.<br>
	<b>2.</b> Thermocouples follow the temperature changes with a small time lag and as such are suitable for recording comparatively rapid changes in temperature.
	Thermocouples are very convenient for measuring the temperature at one particular point in a piece of apparatus.<br>
	<h3 class="style4"><font color="#000000">Disadvantages </font></h3><p><br><b>1.</b> They have a lower accuracy and hence they cannot be used for precision work.<br> 
<b>2.</b> To ensure long life of thermocouples in their operating environments, they should be protected in an open or closed-end metal protecting tube or well. To prevent contamination of the thermo-couple, when precious metals like platimum or its alloys are being used, the protecting tube has to be made chemically inert and vcuum tight.<br> 
<b>3.</b> The thermocouple is placed remote from measuring devices. Connections are thus made by means of wires called extension wires. Maximum accuracy of measurement is assured only when compensating wires are of the same material as the thermocouple wires. The circuitry is, thus, very complex. 
			...
			<div align="right"><br> 
	    <a href="about_exp.php"><strong><INPUT 
                        TYPE=IMAGE 
