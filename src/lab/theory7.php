...
<?php if (isset($_SESSION['user'])) { ?>
	...
	<div id="page-bgbtm">
		...
		<div class="post-bgbtm">
				<h1 align="left" class="title">Theory </h1>          
				</h1>
				
				
				<div class="entry"><p>A Digital to analog converter converts an abstract finite-precision number (usually a fixed-point binary number) into a concrete physical quantity (e.g., a voltage or a pressure). </p>
				<strong><font color="#000000"><span class="style5">Types of DAC:</span></font></strong>&nbsp;&nbsp;There are two techniques used for digital to analog conversion <br/>
			      <ul><li>Binary weighted resistor D/A Converter</li>
                      <li>R/2R ladder D/A Converter</li></ul>
<p>In these techniques, the shunt resistors are used to generate n bit binary weighted current which is added according to switch positions by digital input and then converted into voltage to give analog voltage equivalent to digital input. </p>
				<strong><font color="#000000"><span class="style5">Binary Weighted Resistor DACs:</span></font></strong><br/><br/>
				<p>The binary-weighted resistor DAC is usually the simplest example of a DAC. However, this DAC is not inherently monotonic and is actually quite hard to manufacture successfully at high resolutions. In addition, the output impedance of the voltage-mode binary DAC changes with the input code.</p>
				<div align="center"><img src="images/N Bit Binary Weighted Resistor.bmp" alt=""/><br/><font color="#000000">N Bit Binary Weighted Resistor</font></div><br/>
				<p>Binary weighted resistor DAC uses number of different resistors (2R, 4R,8R,16R)  whereas R/2R ladder DAC uses only two resistor values (R,2R) this avoids resistance spread drawback of binary weighted resistor DAC.</p>
				<strong><font color="#000000"><span class="style5">R-2R DACs :</span></font></strong>&nbsp;&nbsp;R-2R resistor ladder network is a binary linear circuit which has following remarkable features:<br/>
			 <p>1.	Only two resistance values are used anywhere in the entire circuit. This means that only two values of precision resistance are needed, in a ratio of 2:1. This requirement is easy to meet, and not especially expensive.<br/> 
                2.	The input resistance seen by each digital input is the same as for every other input. The actual impedance seen by each digital source gate is 3R.<br/>
                3.	The circuit is indefinitely extensible for binary numbers. Thus, if we use binary inputs we can simply double the length of the ladder network for an 8-bit number (0 to 255) or double it again for a 16-bit number    (0 to 65535). We only need to add two resistors for each additional binary.<br/></p>
               <div align="center"><img src="images/N-bit R-2R resistor ladder1.bmp" alt=""/><br/><font color="#000000">N-bit R-2R resistor ladder</font></div><br/>
			    <div ><strong></strong>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="about experiment7.php"><INPUT 
                        TYPE=IMAGE 
                         SRC="images/back copy.jpg" />
			    </a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="theory17.php">
			    <INPUT 
                        TYPE=IMAGE 
