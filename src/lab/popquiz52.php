...
1)An important visualization technique that also produces quantitative results is ?</div>
<div class="qselections">
<input type="radio" value="a" name="question1">a)Partial image velocimetery<br>
<input type="radio" value="b" name="question1">b)Velocimeter<br>
...
<div class="qheader">
2)Why are organic molecules usually not very polar ?</div>

<div class="qselections">
<input type="radio" value="a" name="question2">a)They contain carbon, which is nonpolar<br>
<input type="radio" value="b" name="question2">b)They have a high degree of symmetry<br>
<input type="radio" value="c" name="question2">c)The electronegativities of carbon and hydrogen are similar<br>
<input type="radio" value="d" name="question2">d)More than one of the above.<br>
</div>
<br>

<div class="qheader">
3)Which of the compounds from problem 72 above would be most likely to dissolve in 
water
 ?</div>
<div class="qselections">

<input type="radio" value="a" name="question3">a)aluminum trifluoride<br>
<input type="radio" value="b" name="question3">b)nitrogen trichloride<br>
<input type="radio" value="c" name="question3">c)fluorine<br>
<input type="radio" value="d" name="question3">d)hydrogen sulfide.<br>
</div>

<br>

<div class="qheader">
4)Once localized regions of particular interest have been pinpointed, it may be necessary to insert ……………… to obtain accurate point measurements ?</div>
<div class="qselections">
<input type="radio" value="a" name="question4">a)velocity probes<br>
<input type="radio" value="b" name="question4">b)displacement probes<br>
<!--<input type="radio" value="c" name="question1">c) A jungle refers to the thickest area of a rain forest<br>
<input type="radio" value="d" name="question1">d) A jungle and a rain forest each contain their own group of distinct plants and animals.<br>-->
</div>
...
<div class="qheader">
5)A calorimeter is used to ?</div>
<div class="qselections">
<input type="radio" value="a" name="question5">a)	Determine the heat of a reaction<br>
<input type="radio" value="b" name="question5">b)	Determine the heat given off/absorbed during some process<br>
<input type="radio" value="c" name="question5">c)	Store the heat from a chemical reaction.<br>
<input type="radio" value="d" name="question5">d)	none of these<br>
</div>

<br>

<div class="qheader">
6)In flow visualization sensing volumes can be made sufficiently small to provide data of ?</div>
<div class="qselections">
<input type="radio" value="a" name="question6">a)practical utility <br>
<input type="radio" value="b" name="question6">b)theoretical utility<br>
<!--<input type="radio" value="c" name="question1">c) 7.	Which of the following compounds is NOT polar<br>
<input type="radio" value="d" name="question1">d) A jungle and a rain forest each contain their own group of distinct plants and animals.<br>-->
</div>
...
<div class="qheader">
7) Which of the following compounds is NOT polar?</div>
<div class="qselections">
<input type="radio" value="a" name="question7">a)ammonia<br>
<input type="radio" value="b" name="question7">b)nitric acid<br>
<input type="radio" value="c" name="question7">c)methane<br>
...
<div class="qheader">
8)various methods of……………….. allow us to gain an overall view of flow patterns. ?</div>
<div class="qselections">
<input type="radio" value="a" name="question8">a)flow visualization<br>
<input type="radio" value="b" name="question8">b)velocity visualization<br>
<!--<input type="radio" value="c" name="question1">c) A jungle refers to the thickest area of a rain forest<br>
<input type="radio" value="d" name="question1">d) A jungle and a rain forest each contain their own group of distinct plants and animals.<br>-->
...
<div class="qheader">
9)In case of flow visualization application range from low velocity natural convection flows up through ?</div>
<div class="qselections">
<input type="radio" value="a" name="question9">a)ultrasonic flows<br>
<input type="radio" value="b" name="question9">b)supersonic flows<br>
<!--<input type="radio" value="c" name="question1">c) A jungle refers to the thickest area of a rain forest<br>
<input type="radio" value="d" name="question1">d) A jungle and a rain forest each contain their own group of distinct plants and animals.<br>-->
</div>
...
<div class="qheader">
10)What compound will most likely have the lowest melting and boiling point ?</div>
<div class="qselections">
<input type="radio" value="a" name="question10">a)aluminum trifluoride<br>
<input type="radio" value="b" name="question10">b)nitrogen trichloride<br>
<input type="radio" value="c" name="question10">c)fluorine<br>-->
<input type="radio" value="d" name="question10">d)hydrogen sulfide<br>
</div>
