...
<?php if (isset($_SESSION['user'])) { ?>
    ...
    <a href="/virtuallab/logout.php" style="padding-right:10px;">Logout</a><a href="user.php"></a> <a href="user.php">Update Profile</a> 
    </div>
    <?php } ?>  
    ...
    <div id="page-bgbtm">
        ...
        <div class="post-bgbtm">
                <h1 class="title"><div align="left">
                  <p><strong>Pressure</strong><strong>:-</strong></p>
              </div></h1>
                
              <div class="entry">
                     <p>Pressure is defined as force per unit area. For example, pressure, P, is a function of force, F, and area, A.Pressure can be expressed as a relative pressure or an absolute pressure. The units of pressure are atmospheres (atm), bars, inches of mercury (in Hg), and millimetres of mercury (mm Hg).
Pressure is one of the most important process variables which are required to be measured and controlled in a process industry.<br>                     
                </p>
                     <h3><strong><font color="#000000">Pressure Transducer:-</font></strong></h3><p>      A pressure transducer converts a measured pressure into a mechanical or electrical signal. The transducer actually is a hybrid sensor-transducer. Several common elastic elements used as primary sensing elements include the bourdon tube, bellows, capsule and diaphragm. In many pressure measurements, Bourdon tubes are extremely popular as elastic elements in pressure gauges. </p><h3><strong><font color="#000000">Bourdon Tube Working:-</font></strong></h3><p>The Bourdon tube is a metal tube of elliptic cross section having a bent shape. One end of the tube is sealed and the other is connected to a capillary tube through which pressure is applied. Any pressure within the tube in excess of the external or atmospheric pressure causes the flattened element to elastically change its shape to a more circular cross-section. The resulting change in the cross-section causes the coiled tube to straighten. With one end of the tube fixed, the straightening effect causes the free end to move a small distance, which is mechanically amplified through a linkage arm and a gear and pinion assembly to which a pointer is attached. Hence the pointer attached to the closed end of the tube rotates around a graduated scale. The gauge is calibrated against known pressures to ensure accurate readings. Bourdon gages are available for measuring pressures higher/lower than the atmospheric pressure. The pressure indicated is referred to as the gage pressure if it is with respect to the atmospheric pressure outside the Bourdon tube.</p>
<h3><strong><font color="#000000">Pressure Range:-</font></strong></h3>
<p>Bourdon gages are available to cover a large range of pressures. Bourdon tubes are available to measure pressures from 0-15 psi and 0-10000 psi. </p>
<h3><strong><font color="#000000">Experiment:-</font></strong></h3><p>This experiment shows the working of the Bourdon Tube i.e. as per the force applied, the Pressure is calculated.</p>

                <div align="right"><br> 
        <a href="about experiment9.php"><strong><INPUT 
                        TYPE=IMAGE 
                         SRC="images/back copy.jpg" /></strong></a>      </div>
