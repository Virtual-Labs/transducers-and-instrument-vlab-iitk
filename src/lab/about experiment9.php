...
<a href="/virtuallab/user.php"<?php echo $fet['User_Email_Id'];?> <style="padding-right:0px; text-decoration:none;">Update Profile</a></div><?php } ?>  
	...
	<div id="page-bgbtm">
		...
		<div class="post-bgbtm">
				&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
				<h1 class="title">Pressure measurement </h1>
				
				<div class="entry">
				 <ul>
				   <li><h3><a href="aim_of_exp8.php">Aim of Experiment</a></h3>&nbsp;&nbsp;&nbsp;&nbsp;
				   <li><h3><a href="about_b1.php">
						About Experiment</a></h3>&nbsp;&nbsp;&nbsp;&nbsp;
				   <li><h3><a href="theory9.php">Theory</a></h3>&nbsp;&nbsp;&nbsp;&nbsp;
				   <li><h3><a href="procedure0.php">Procedure</a></h3>&nbsp;&nbsp;&nbsp;&nbsp;
				
				<!--   <li><h3><a href="">Simulation</a></h3>&nbsp;&nbsp;&nbsp;&nbsp;
						<li><h3><a href="">Realtime</a></h3>&nbsp;&nbsp;&nbsp;&nbsp;
 
						<li><h3><a href="">Download</a></h3>&nbsp;&nbsp;&nbsp;&nbsp;-->
				  <li><h3><a href="ex9.php">Quiz</a></h3>&nbsp;&nbsp;&nbsp;&nbsp;	<li><h3><a href="p_experiment9.php">Perform Experiment</a></h3>&nbsp;&nbsp;&nbsp;&nbsp; <li><h3><a href="Manual Bourdon tube.pdf">Experiment Manual</a></h3>&nbsp;&nbsp;&nbsp;&nbsp;
