...
<input type="radio" value="b" name="question1">b) electrical energy to mechanical form<br>
...
<div class="qselections">
<input type="radio" value="a" name="question2">a) L.V.D.T.<br>
<input type="radio" value="b" name="question2">b) piezo electric crystals<br>
<!--<input type="radio" value="c" name="question1">c) A jungle refers to the thickest area of a rain forest<br>
<input type="radio" value="d" name="question1">d) A jungle and a rain forest each contain their own group of distinct plants and animals.<br>-->
</div>
...
<input type="radio" value="a" name="question3">a) photovoltaic cell<br>
<input type="radio" value="b" name="question3">b) strain gauge<br>
<!--<input type="radio" value="c" name="question1">c) A jungle refers to the thickest area of a rain forest<br>
<input type="radio" value="d" name="question1">d) A jungle and a rain forest each contain their own group of distinct plants and animals.<br>-->
</div>
...
<div class="qselections">
<input type="radio" value="a" name="question4">a) an inverse transducer<br>

<input type="radio" value="b" name="question4">b) an output transducer<br>
<input type="radio" value="c" name="question4">c) (a) and (b) both<br>
...
<div class="qheader">
5) In a transducer, the experimentally abtained transfer function is different from the theoretical transfer, function, the errors result from this difference are called ?</div>
<div class="qselections">
<input type="radio" value="a" name="question5">a) Non-conformity errors<br>
...
<div class="qheader">
6) In a transducer, the observed output deviates from the correct value by a constant factor the resulting error is called ?</div>
<div class="qselections">
<input type="radio" value="a" name="question6">a) Zero Error<br>
<input type="radio" value="b" name="question6">b) Sensitivity Error<br>
<!--<input type="radio" value="c" name="question1">c) A jungle refers to the thickest area of a rain forest<br>
<input type="radio" value="d" name="question1">d) A jungle and a rain forest each contain their own group of distinct plants and animals.<br>-->
</div>
...
<div class="qheader">
7)  A transducer has an output umpedance of   and the load resistance is  , the transducer behaves as  ?</div>
<div class="qselections">
...
<div class="qheader">
8) If a transducer has an output Impedance of  and a load resistance of  , it behaves as  ?</div>
<div class="qselections">
<input type="radio" value="a" name="question8">a) a constant current source<br>

<input type="radio" value="b" name="question8">b) a constant impedance source<br>
<!--<input type="radio" value="c" name="question1">c) A jungle refers to the thickest area of a rain forest<br>
<input type="radio" value="d" name="question1">d) A jungle and a rain forest each contain their own group of distinct plants and animals.<br>-->
...
<div class="qheader">
9) The lower limit of useful working range of a transducer is determined by  ?</div>
<div class="qselections">
<input type="radio" value="a" name="question9">a) cross sensitivity<br>
<input type="radio" value="b" name="question9">b) by transducer error and noise<br>
<!--<input type="radio" value="c" name="question1">c) A jungle refers to the thickest area of a rain forest<br>
<input type="radio" value="d" name="question1">d) A jungle and a rain forest each contain their own group of distinct plants and animals.<br>-->
</div>
...
<div class="qheader">
10) While selecting a transducer for a particular application  ?</div>
<div class="qselections">
<input type="radio" value="a" name="question10">a) input, output and transfer characteristics should be considered<br>
<input type="radio" value="b" name="question10">b) only the output characteristics should be considered<br>
