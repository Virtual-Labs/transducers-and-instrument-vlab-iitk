...
<div id="wrapper">
    ...
    <div id="menu">
        <ul>
              ...
              <li><a href="experiment.php" style="background-image:url(images/images1.jpg)">&nbsp;&nbsp;<span class="style7">&nbsp;Experiments</span></a></li>
...
<?php if (isset($_SESSION['user'])) { ?>
    ...
    <a href="/Final_Files/logout.php" style="padding-right:10px;">Logout</a><a href="user.php"></a> 
    </div>
    <?php } ?>  
    ...
    <div id="page-bgbtm">
        ...
        <div id="content" align="center"><div align="center"><p></p><img src="images/Thank You.jpg"/></div></div>
