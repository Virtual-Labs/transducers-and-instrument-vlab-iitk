...
1) Which device has a natural sensing of acceleration,according to acceleration directly proportional to force ?</div>
<div class="qselections">
<input type="radio" value="a" name="question1">a) Piezoelectric transducer<br>
<input type="radio" value="b" name="question1">b) piezoresistive transducer<br>
...
<div class="qheader">
2) In wire wound stain gauges, the change in resistant on application of strain is mainly due to ?</div>

<div class="qselections">
<input type="radio" value="a" name="question2">a)change in both length and diameter of wire<br>
<input type="radio" value="b" name="question2">b) change in resistivity<br>
...
<div class="qheader">
3) Unbonded strain gauges are ?</div>
<div class="qselections">

<input type="radio" value="a" name="question3">a) exclusively used for transducer application<br>
<input type="radio" value="b" name="question3">b) Exclusively used for stress analysis<br>
<input type="radio" value="c" name="question3">c) none<br>
<!--<input type="radio" value="c" name="question1">c) A jungle refers to the thickest area of a rain forest<br>
<input type="radio" value="d" name="question1">d) A jungle and a rain forest each contain their own group of distinct plants and animals.<br>-->
</div>
...
<div class="qheader">
4) Metal foil type od strain gauges are superior to wire wound metal stain gauges because ?</div>
<div class="qselections">
<input type="radio" value="a" name="question4">a) they have a higher heat dissipation capacity<br>

<input type="radio" value="b" name="question4">b) they have a larger surface area which makes the bonding easier<br>
<input type="radio" value="c" name="question4">c) they can be fabricated economically using techniques which are similar to those used for fabrication of macron-electronic circuitry<br>
<input type="radio" value="d" name="question4">d) all of the above<br>
...
<div class="qheader">
5)Metal foil gauges use fat end turns in order to ?</div>
<div class="qselections">
<input type="radio" value="a" name="question5">a) reduce transverse sensitivity<br>
<input type="radio" value="b" name="question5">b) reduce longitudinal sensitivity<br>
...
<div class="qheader">
6) In semi-conductor strain gauges, the change in resistance on application of strain ?</div>
<div class="qselections">
<input type="radio" value="a" name="question6">a) Is much higher than that in the case of metal stain gauges and this is mainly due to change in dimensions <br>
<input type="radio" value="b" name="question6">b) Is much higher than that in the case of metal strain gauges and this is mainly due to change in resistivity<br>
<!--<input type="radio" value="c" name="question1">c) A jungle refers to the thickest area of a rain forest<br>
<input type="radio" value="d" name="question1">d) A jungle and a rain forest each contain their own group of distinct plants and animals.<br>-->
</div>
...
<div class="qheader">
7) In semi- conductor strain gauges, when a tensile stain is applied ?</div>
<div class="qselections">
<input type="radio" value="a" name="question7">a) resistance increases in N-type of materials<br>
<input type="radio" value="b" name="question7">b) resistance increases in P-type of materials<br>
<!--<input type="radio" value="c" name="question1">c) A jungle refers to the thickest area of a rain forest<br>
<input type="radio" value="d" name="question1">d) A jungle and a rain forest each contain their own group of distinct plants and animals.<br>-->
...
<div class="qheader">
8)   To control amplitude we need ?</div>
<div class="qselections">
<input type="radio" value="a" name="question8">a) Amplipier<br>

<input type="radio" value="b" name="question8">b) Frequency parameter control<br>
<!--<input type="radio" value="c" name="question1">c) A jungle refers to the thickest area of a rain forest<br>
<input type="radio" value="d" name="question1">d) A jungle and a rain forest each contain their own group of distinct plants and animals.<br>-->
...
<div class="qheader">
9) The cartridge from condensor microphone uses ?</div>
<div class="qselections">
<input type="radio" value="a" name="question9">a) Basic transduction priciples<br>
<input type="radio" value="b" name="question9">b) Basic resistance priciples<br>
<!--<input type="radio" value="c" name="question1">c) A jungle refers to the thickest area of a rain forest<br>
<input type="radio" value="d" name="question1">d) A jungle and a rain forest each contain their own group of distinct plants and animals.<br>-->
</div>
...
<div class="qheader">
10) A heliport is used for measurement of linear displacement of 0.1m.  It uses    a 10 turn potentiometer (3000 of movement full scale) with a total of 500 turns of wire.  Its resolution is ?</div>
<div class="qselections">
<input type="radio" value="a" name="question10">a) 0.1 mm<br>
<input type="radio" value="b" name="question10">b) 0.02 mm<br>
