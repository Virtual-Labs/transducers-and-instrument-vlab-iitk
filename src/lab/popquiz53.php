...
1)	…………..of tube axis and velocity vector exposes the static taps to some component of velocity ?</div>
<div class="qselections">
<input type="radio" value="a" name="question1">a)Misalignment<br>
<input type="radio" value="b" name="question1">b)alignment<br>
...
<div class="qheader">
2) If you were a piece of chromatography paper and your chin was a solute after an experiment, the Rf value of your chin would be approximately ?</div>

<div class="qselections">
<input type="radio" value="a" name="question2">a)0.15<br>
<input type="radio" value="b" name="question2">b)0.50<br>
...
<div class="qheader">
3)Chromatography is used to ?</div>
<div class="qselections">

<input type="radio" value="a" name="question3">a)Separate two or more compounds ed on their polarities.<br>
<input type="radio" value="b" name="question3">b)Separate two or more compounds based on their masses<br>
<input type="radio" value="c" name="question3">c)Separate two or more compounds based on how strongly they interact with other compounds<br>
<input type="radio" value="d" name="question3">d)More than one of the above.<br>
</div>

<br>

<div class="qheader">
4)The vapor pressure of a liquid increases when?</div>
<div class="qselections">
<input type="radio" value="a" name="question4">a)The temperature is raised<br>
<input type="radio" value="b" name="question4">b)The temperature is lowered<br>
<input type="radio" value="c" name="question4">c)The pressure is lowered<br>
<input type="radio" value="d" name="question4">d)none of these.<br>
</div>

<br>

<div class="qheader">
5) The difference between dipole-dipole forces and hydrogen bonds are that ?</div>
<div class="qselections">
<input type="radio" value="a" name="question5">a)dipole-dipole forces only exist between nonpolar molecules<br>
<input type="radio" value="b" name="question5">b)None of the above are able to distinguish between dipole-dipole forces and hydrogen bonds<br>
<input type="radio" value="c" name="question5">c)dipole-dipole forces occur between polar molecules<br>
<input type="radio" value="d" name="question5">d)dipole-dipole forces are caused by the interaction of partial charges on both molecules<br>
</div>

<br>

<div class="qheader">
6)What’s the velocity of hydrogen at 298 K ?</div>
<div class="qselections">
<input type="radio" value="a" name="question6">a)61.0m/sec <br>
<input type="radio" value="b" name="question6">b)2730 m/sec<br>
<input type="radio" value="c" name="question6">c)1930 m/sec<br>
...
<div class="qheader">
7)Why don’t hydrogen molecules really move as fast as the calculation in problem 104 would suggest ?</div>
<div class="qselections">
<input type="radio" value="a" name="question7">a)hydrogen molecules bump into other hydrogen molecules, slowing them down<br>
<input type="radio" value="b" name="question7">b)hydrogen molecule experience intermolecular forces<br>
<input type="radio" value="c" name="question7">c)hydrogen molecules are a liquid at 298 K<br>
...
<div class="qheader">
8)In a venture meter the flow is 0.15 m3/s when the differential pressure is 30kN/m¬¬¬2.  What is the value of flow when the differential pressure is 60 kN/m¬¬¬2?</div>
<div class="qselections">
<input type="radio" value="a" name="question8">a) )  0.212 m3/s <br>
<input type="radio" value="b" name="question8">b) 0.106 m3/s<br>
<input type="radio" value="c" name="question8">c)0.3 m3/s <br>
<input type="radio" value="d" name="question8">d)0.075 m3/s.<br>
...
<div class="qheader">
9)For which process would the heat be negative ?</div>
<div class="qselections">
<input type="radio" value="a" name="question9">a)Changing the temperature of ice water to 50 to 0 degree centigrade<br>
<input type="radio" value="b" name="question9">b)Condensing steam<br>
<input type="radio" value="c" name="question9">c)Boiling water<br>
<input type="radio" value="d" name="question9">d)more than one of the above.<br>
</div>
