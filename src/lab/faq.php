...
</div><form action="Google_search_results.php" id="cse-search-box" >
  <div>
...
<a href="/virtuallab/user.php"<?php echo $fet['User_Email_Id'];?> <style="padding-right:0px; text-decoration:none;">Update Profile</a></div><?php } ?>  
	...
	<div id="page-bgbtm">
		...
		<div class="post-bgbtm">
				<!--<h1 class="title"><font color="#000000">Introduction</font>  </h1>-->
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td><p><h1> &nbsp;&nbsp;&nbsp;Frequently Asked Questions</h1></p>
<p>&nbsp;</p
><p>&nbsp;&nbsp;&nbsp;<a name="">Qns 1.</a> What is a Laboratory? </p>
<p>&nbsp;&nbsp;&nbsp;<a name="Question1"><b>Ans 1.</b></a><font color="#000000"><br/>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;A laboratory is a facility that provides controlled conditions in which scientific research, experiments and &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;measurement can be performed.  </font></p>

    <br>
<p>&nbsp; &nbsp;<a name="">Qns 2. </a>What limits the lab experience? </p>
<p>&nbsp;&nbsp;&nbsp;<a name="Question2"><b>Ans 2.</b></a><font color="#000000"><br/>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Time, money, equipment availability, instructor time/ resources / knowledge, safety concerns, student ability.</font></p>

    <br>
 
<p>&nbsp;&nbsp;&nbsp;<a name="#Question3">Qns 3.</a> What are the problems related with instruments?</p>
<p>&nbsp;&nbsp;&nbsp;<a name="Question3"><b>Ans 3.</b></a><br>
<font color="#000000"> &nbsp;&nbsp;&nbsp;(a). Need for special purpose instruments may increase budget.<br>
     &nbsp;&nbsp;&nbsp;(b). Lack of instruments at distant located Universities.<br>
     &nbsp;&nbsp;&nbsp;(c). Time restraint: Lab is not available after scheduled time.</font></p>

    <br />
<p>&nbsp;&nbsp;&nbsp;<a name="#Question4">Qns 4.</a> What is the solution to above problem?</p>
<p>&nbsp;&nbsp;&nbsp;<a name="Question4"><b>Ans 4.</b></a><font color="#000000"><br/>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;With the help of Virtual Laboratory general purpose instrument can be programmed with a special purpose &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;instruments that you do not have.</font></p>

    <br />
  
<p>&nbsp;&nbsp;&nbsp;<a name="#Question5">Qns 5.</a> What is Virtual Laboratory?</p>
<p>&nbsp;&nbsp;&nbsp;<a name="Question5"><b>Ans 5.</b></a><font color="#000000"><br/>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;A virtual laboratory is a combination of both software and hardware setup through which user can access lab &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;equipments virtually without any limitation.</font></p>

    <br />
  
<p>&nbsp;&nbsp;&nbsp;<a name="#Question6">Qns 6.</a> Why Virtual Laboratory?</p>
<p>&nbsp;&nbsp;&nbsp;<a name="Question6"><b>Ans 6.<br></b></a><font color="#000000">&nbsp;&nbsp;&nbsp;  We use virtual laboratory because of the following reasons:<br>
      &nbsp;&nbsp;&nbsp;(a). Heavy industrial process cannot be moved.<br>
      &nbsp;&nbsp;&nbsp;(b). Costly industrial equipments cannot be duplicated.<br>
      &nbsp;&nbsp;&nbsp;(c). Learner has to be confronted with their use in a real situation.
</font></p>

    <br />
<p>&nbsp;&nbsp;&nbsp;<a name="#Question7">Qns 7.</a> How Virtual Laboratory works?</p>
<p>&nbsp;&nbsp;&nbsp;<a name="Question7"><b>Ans 7.</b></a><font color="#000000"><br />
&nbsp;&nbsp;&nbsp;&nbsp;Differently configurable experiments are designed and implemented by using Data Acquisition Hardware (DAQ) and &nbsp;&nbsp;&nbsp;&nbsp;Virtual Instruments (VI) through web-based application. Client can select the desired experiment&nbsp;available on the &nbsp;&nbsp;&nbsp;&nbsp;website and can virtually access them.</font></p>

    <br />
 
<p>&nbsp;&nbsp;&nbsp;<a name="#Question8">Qns 8.</a> Why do we need Virtual Laboratory?</p>

<p>&nbsp;&nbsp;&nbsp;<a name="Question8"><b>Ans 8.<br></b></a>
<font color="#000000">&nbsp;&nbsp;  (a). Students can access laboratory instruments when the lab is not open.<br>
&nbsp;&nbsp;&nbsp;(b). Instruments can be shared among multiple universities.<br>
&nbsp;&nbsp;&nbsp;(c). Adjustments to equipment on a manufacturing line from a central (perhaps remote) location.<br>
 &nbsp;&nbsp;&nbsp;(d). Support Engineer can make adjustments to clients system virtually.<br>
 &nbsp;&nbsp;&nbsp;(e). Engineers/Scientists have virtual access to a large, expensive piece of equipment.<br>
 &nbsp;&nbsp;&nbsp;(f). Gives wider access to equipment.<br>
&nbsp;&nbsp;&nbsp;(g). Saves travel time and expense.</font>
</a></p>
...
<p><strong><font color="#0033FF">&nbsp;</font></strong></p></td>
  </tr>
</table>
<!--<h4 class="style4">&nbsp;</h4>-->
