...
<a href="/virtuallab/user.php"<?php echo $fet['User_Email_Id'];?> <style="padding-right:0px; text-decoration:none;">Update Profile</a></div><?php } ?>  
	...
	<div id="page-bgbtm">
		...
		<div class="post-bgbtm">
				&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
				<h1 class="title">Rotameter</h1>
				
				<div class="entry">
				 <ul>
				   <li><h3><a href="aim_of_exp4.php">Aim of Experiment</a></h3>&nbsp;&nbsp;&nbsp;&nbsp;
				   <li><h3><a href="about_exp4.php">
						About Experiment</a></h3>&nbsp;&nbsp;&nbsp;&nbsp;
				   <li><h3><a href="theory5.php">Theory</a></h3>&nbsp;&nbsp;&nbsp;&nbsp;
				   <li><h3><a href="procedure15.php">Procedure</a></h3>&nbsp;&nbsp;&nbsp;&nbsp;
				 <!--  <li><h3><a href="http://202.141.40.214:50001/Rotameter_.html">Simulation</a></h3>&nbsp;&nbsp;&nbsp;&nbsp;
						<li><h3><a href="">Realtime</a></h3>&nbsp;&nbsp;&nbsp;&nbsp;
 				

		<li><h3><a href="Rotameter.exe">Download</a></h3>&nbsp;&nbsp;&nbsp;&nbsp;-->
				   <li><h3><a href="ex5.php">Quiz</a></h3>&nbsp;&nbsp;&nbsp;&nbsp;<li><h3><a href="p_experiment5.php">Perform Experiment</a></h3>&nbsp;&nbsp;&nbsp;&nbsp;	<li><h3><a href="rotameter_mannual.pdf">Experiment Manual</a></h3>&nbsp;&nbsp;&nbsp;&nbsp;
