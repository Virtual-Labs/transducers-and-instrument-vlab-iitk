...
<?php if (isset($_SESSION['user'])) { ?>
	...
	<div id="page-bgbtm">
		...
		<div class="post-bgbtm">
				...
				<h3><p class="title">
			<a href="Strainguagequiz1.php"> Exercise (a)</a><br><br>
			<a href="Strainguagequiz2.php"> Exercise (b)</a><br><br>
			<a href="Strainguagequiz3.php"> Exercise (c)</a><br><br>
			<a href="Strainguagequiz4.php"> Exercise (d)</a><br><br>
			<a href="Strainguagequiz5.php"> Exercise (e)</a></p></h3>
				<p class="title">&nbsp;</p><div align="right"><a href="about experiment6.php"><iNPUT 
                        TYPE=IMAGE 
