...
1) A torsion bar of 30 mm diameter produces a twist of 1 minute when of torque of 200 Nm is applied.  Supposing the diameter of the torsion bar is reduced to 15 mm, what would be the angle of twist for the same torque. ?</div>
<div class="qselections">
<input type="radio" value="a" name="question1">a) 2 minute<br>
<input type="radio" value="b" name="question1">b) 8 minute<br>
...
<div class="qheader">
2) A Reynold’s number of 1000 indicates ?</div>

<div class="qselections">
<input type="radio" value="a" name="question2">a)turbulent flow<br>
<input type="radio" value="b" name="question2">b) laminar flow<br>
...
<div class="qheader">
3) Pitot tubes are useful ?</div>
<div class="qselections">

<input type="radio" value="a" name="question3">a) for laboratory experimental purpose<br>
<input type="radio" value="b" name="question3">b) for industrial applications<br>
<!--<input type="radio" value="c" name="question1">c) A jungle refers to the thickest area of a rain forest<br>
<input type="radio" value="d" name="question1">d) A jungle and a rain forest each contain their own group of distinct plants and animals.<br>-->
</div>
...
<div class="qheader">
4) Water is flowing with a depth of 0.9 m over a rectangular notch 1.2 m wide.  Find the depth of flow over a right angled notch if the same were to pass over it.  Assume that both the notches have the same coefficient of discharge ?</div>
<div class="qselections">
<input type="radio" value="a" name="question4">a) 0.9 m<br>

<input type="radio" value="b" name="question4">b) 1.1 m<br>
<!--<input type="radio" value="c" name="question1">c) A jungle refers to the thickest area of a rain forest<br>
<input type="radio" value="d" name="question1">d) A jungle and a rain forest each contain their own group of distinct plants and animals.<br>-->
</div>
...
<div class="qheader">
5) A resistance potentiometer is a ?</div>
<div class="qselections">
<input type="radio" value="a" name="question5">a) first order instrument<br>
<input type="radio" value="b" name="question5">b) zero order instrument<br>
...
<div class="qheader">
6) To display generated waveform in preview we use ?</div>
<div class="qselections">
<input type="radio" value="a" name="question6">a) Generator mode <br>
<input type="radio" value="b" name="question6">b) Waveform Preview<br>
<!--<input type="radio" value="c" name="question1">c) A jungle refers to the thickest area of a rain forest<br>
<input type="radio" value="d" name="question1">d) A jungle and a rain forest each contain their own group of distinct plants and animals.<br>-->
</div>
...
<div class="qheader">
7) To control frequency we need ?</div>
<div class="qselections">
<input type="radio" value="a" name="question7">a) Amplitude parameter control<br>
<input type="radio" value="b" name="question7">b) Frequency parameter control<br>
<!--<input type="radio" value="c" name="question1">c) A jungle refers to the thickest area of a rain forest<br>
<input type="radio" value="d" name="question1">d) A jungle and a rain forest each contain their own group of distinct plants and animals.<br>-->
...
<div class="qheader">
10) Which device has a natural sensing of acceleration,according to acceleration directly proportional to force ?</div>
<div class="qselections">
<input type="radio" value="a" name="question10">a) Piezoelectric transducer<br>
<input type="radio" value="b" name="question10">b) piezoresistive transducer<br>
