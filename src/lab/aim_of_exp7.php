...
<?php if (isset($_SESSION['user'])) { ?>
	...
	<div id="page-bgbtm">
		...
		<div class="post-bgbtm">
				...
				<div class="entry">
					 <p>Study of Displacement Transducers.</p><p>                     
