...
<?php if (isset($_SESSION['user'])) { ?>
	...
	<div id="page-bgbtm">
		...
		<div class="post-bgbtm">
			  ...
			  <div class="entry">
			    <p align="left"><strong> </strong><strong>C)  Now if you opted for Inductive Displacement Transducer, </strong></p>
			    <p align="left"><strong> </strong><strong> a)</strong>  Click to ON  the Switch.<strong> </strong></p>
			    <h3 class="style4"><p align="center"><img width="108" height="57" src="images/procedure21_clip_image002.jpg" /></p>
			    </h3>
			    <p><strong>b)</strong> Slowly Change the Position of Piston through the Displacement slider.  </p>
			    <p align="center"><img width="251" height="183" src="images/procedure21_clip_image002_0000.jpg" /></p>
			    <p><strong>c)</strong> According to change in Piston Position the Analog Scale and the Digital Meter shows  the Actual Displacement and Measured Displacement of Core in LVDT.</p>
			    <p align="center">
			    <img width="405" height="246" src="images/procedure21_clip_image002_0001.jpg" /></p>
			    <p><strong>d)</strong> According to the Displacement the graph will generate between voltage and  Displacement.</p>
			    <p align="center"><img width="356" height="203" src="images/procedure21_clip_image002_0002.jpg" /></p>
			    <p><strong>e)</strong> The another graph shows the Actual versus Measured Displacement in LVDT Core.</p>
			    <p align="center"><img width="347" height="221" src="images/procedure21_clip_image002_0003.jpg" /></p>
			    <p><strong>f)</strong> Switch OFF the supply to STOP the Experiment.</p>
			   <p align="center"> <img width="108" height="57" src="images/procedure21_clip_image002_0004.jpg" />
			    
			    
                  
                 
			  </div><div ><strong></strong>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="procedure18.php"><strong>
			     <INPUT 
                        TYPE=IMAGE 
