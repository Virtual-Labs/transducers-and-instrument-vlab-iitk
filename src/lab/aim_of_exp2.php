...
<?php if (isset($_SESSION['user'])) { ?>
	...
	<div id="page-bgbtm">
		...
		<div class="post-bgbtm">
				...
				<div class="entry">
					 <p> Study of AC  and DC Bridges (a) Wheatstone Bridge (b) Wien Bridge (c) Maxwell Bridge  </p><p>                     
	...
	<!-- end #page -->
	<div id="footer">
		<p>Transducer &amp; Instrumentation  <a href="#">Virtual Lab - IIT Kanpur </a></p>
	</div>
	<!-- end #footer -->
</div>
