...
<?php if (isset($_SESSION['user'])) { ?>
	...
	<div id="page-bgbtm">
		...
		<div class="post-bgbtm">
				<h1 class="title"><div align="left"><strong>Displacement Transducer</strong></div>
				</h1>
				
			  <div class="entry">
					 <p>Displacement Transducers is position sensor that provides contactless linear displacement measurement of absolute piston position in hydraulic and pneumatic cylinders. A position or linear   displacement transducer is a device whose output signal represents the distance an object has travelled from a reference point. L.V.D.T. is the most commonly used transducer to measure the linear displacement.  
			   
					   <font color="#000000"><strong><h4>Linear Displacement Measurement</h4></strong></font> :
					 <p>Linear displacement is movement in one direction along a single axis. A displacement measurement also indicates the direction of motion 
			    <div align="center"><img src="images/Linear Displacement Measurement.bmp" alt="" /><br/><font color="#000000">Linear Displacement Measurement</font></div><br/>
A linear displacement typically has units of millimeters (mm) or inches (in.) and a negative or positive direction associated with it.<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<strong><u><span class="style5">
</span></u></strong>
<h3><font color="#000000">Resistive Displacement Transducer</font></h3>
<strong><u><span class="style5"></span></u></strong>
<p><strong> -</strong>The principle of the resistive position  transducer is that the measured quantity causes a resistance change in the  sensing element.A common type of resistive displacement  transducers uses a resistive element with a sliding contact linked to the  object being monitored (a contact type transducer).  For this purpose, a variant of the voltage  divider called a potentiometer (or simply a pot) can be used.<strong><u><span class="style5"></span></u></strong></p>
<h3><font color="#000000">Linear Displacement:</font></h3>
<p><strong><u><span class="style5">  </span> </u></strong>-A voltage divider can be equipped with a  sliding contact which is linked to the object. The resistance of the  potentiometer now varies linearly with displacement, as shown below:<strong></strong>
  </p>
    </p>
</p>
<div align="center"><img src="images/d1.jpg" alt="" /></div>
<p>Let the fractional displacement be  defined as r = x/x’. Then, the corresponding resistance across which the  output voltage is taken is R*r. Where  R is the total resistance of the potentiometer,using the voltage  divider equation, we find the output- </p>
<div align="center"><img src="images/d2.jpg" alt="" /></div>
<p>The resistive track element may be a  wire-wound track or a film of conductive plastic.  <strong><span class="style5">
<h4 class="style5">Example:</h4>
</span></strong>
</span></u></strong> -A linear resistive displacement  transducer has a shaft stroke of 5 cm, total resistance of 3kΩ,  and source voltage of 6V. When the slider contact is 2 cm from the zero output  position, what will be the output voltage?<strong><span class="style5">
<h4>Solution:</h4>
</span></strong>
<p><strong><u><span class="style5">
  </span></u></strong> -Given that x’ = 5 cm, x = 2  cm, E = 6 V, the output voltage will be</p>
<div align="center"><strong>
  Eout 
  = (2/5)*6 =2.4 V</strong></div>
  <p>Rotary Displacement: -
    If the resistive element and a contact are arranged in a rotary manner, the resistance change can be related to an angular position of the contact.<strong><u><span class="style5"></span></u></strong></p>
  <strong><u><span class="style5"></span></u></strong>
  <h2><font color="#000000">Capacitive Displacement Transducer:</font></h2>
  <p>A typical  capacitor is comprised of two parallel plates of conducting material separated  by an electrical insulating material called a dielectric. The plates and the  dielectric may be either flattened or rolled. The purpose of the dielectric is  to help the two parallel plates maintain their stored electrical charges. The  relationship between the capacitance and the size of capacitor plate, amount of  plate separation, and the dielectric is given by- </p>
  </p>
  <div align="center">
    <p><img src="images/d4.jpg" alt="" /></p>
    </div>
  <div ><strong></strong>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="about experiment8.php"><INPUT 
                        TYPE=IMAGE 
                         SRC="images/back copy.jpg" />
</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="about_exp17.php">
<INPUT 
                        TYPE=IMAGE 
                         SRC="images/nect copy.jpg" /></a></div>
	
	<!--<b>Cost</b><br> 
	<b>Environmental</b> - Sensors typically have temperature and/or humidity limits.<br> 
	<b>Range</b> - Limits of measurement or the sensor.<br> 
	<b>Repeatability </b>- The variance in a sensor's reading when a single condition is repeatedly measured.<br> 
	<b>Resolution </b>- The smallest increment the sensor can detect.<br> 
</p>
<h3 class="style4"><font color="#000000">Types of Sensors   </font></h3></p>
Sensors are used to measure basic physical phenomena including:<br>
<p>	Acceleration, Angular/Linear position, Chemical/Gas concentration, Humidity, Flow rate, Force, Magnetic field, Pressure, Proximity-spatial presence, Sound, Temperature, Velocity.                                              
</p>
<h3 class="style4"><font color="#000000">Sensors:Acceleration </font></h3></p>
<p>An accelerometer is an electromechanical transducer which produces at its output terminals, a voltage or charge that is proportional to the acceleration to which it is subjected. The piezoelectric elements (similar to small crystals) within the accelerometer have the property of producing an electrical charge which is directly proportional to the strain and thus the applied force when loaded either in tension, compression or shear. 
Applications include measurement of Acceleration, Angular Acceleration, Velocity, Position, RPM or Angular Rate, Frequency, Impulse and Impulse Energy, Force, Tilt and Orientation, and Motion.One of the most common inertial sensors is the accelerometer, a dynamic sensor capable of a vast range of sensing. Accelerometers are available that can measure acceleration in one, two, or three orthogonal axes. They are typically used in one of three modes: 
</p><p>1.As an intertial measurement of velocity and position;<br>
	2.As a sensor of inclination, tilt, or orientation in 2 or 3 dimensions, as referenced from the acceleration of gravity (1 g = 9.8m/s2);<br>
	3.As a vibration or impact (shock) sensor.</p><br>
