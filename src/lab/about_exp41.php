...
<?php if (isset($_SESSION['user'])) { ?>
	...
	<div id="page-bgbtm">
		...
		<div class="post-bgbtm">
			  ...
			  <div class="entry">
					 <strong><font color="#000000"><span class="style5">Principle of Rotameter :</span></font></strong><br/><br/>
					 <p>The rotameter is based on the variable  area principle: fluid flow raises a float in a tapered tube, increasing the  area for passage of the fluid. The greater the flow, the higher the float is  raised. The height of the float is directly proportional to the flow rate. With  liquids, the float is raised by a combination of the buoyancy of the liquid and  the velocity head of the fluid. With gases, buoyancy is negligible, and the  float responds to the velocity head alone.</p>
					 <p>The float moves up or down in the tube  in proportion to the fluid flow rate and the annular area between the float and  the tube wall. The float reaches a stable position in the tube when the upward  force exerted by the flowing fluid equals the downward gravitational force  exerted by the weight of the float. A change in flow rate upsets this balance  of forces. The float then moves up or down, changing the annular area until it  again reaches a position where the forces are in equilibrium. To satisfy the  force equation, the rotameter float assumes a distinct position for every  constant flow rate. However, it is important to note that because the float  position is gravity dependent, rotameter must be vertically oriented and  mounted.<br/>
					 Measuring Principles of Variable Area Flow meters.<br/> 
					
					•	Flow Rate Analysis.<br/>
                    •	The forces acting on the bob lead to equilibrium between:<br/>
                    •	the weight of the bob(Fw)  bgVb acting downwards<br/>
                    •	the buoyancy force  (Fb)  gVb and<br/>
                    •	 the drag force Fd acting upwards.<br/><br/>
					<div align="center"><span class="style5">Fw=Fb+Fd</span></div><br/>
					 <div align="center"><img src="images/clip_image002.bmp" alt="" width="223" height="45" /></div>
					 <br/>
					 <p>Therefore,</p>                       
					 <div align="center"><img src="images/clip_image0021.bmp" alt="" width="234" height="73" /></div><br/>
					<p> where,<br/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
 	                     Vb is the volume,<br/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
	                     Af is cross section area,<br/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
	                     CT is drag coefficient,<br/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
	                     Db is the density of the bob,<br/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
                         Df is the density of the fluid,<br/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
	                     g is the gravitational acceleration,<br/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
	                     Db Maximum Bob diameter,<br/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
	                     U= flow Velocity.</p><br/>
<div align="center"><img src="images/clip_image0022.jpg" alt="" width="470" height="211" /></div><br/>

			<div ><strong></strong>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="about_exp4.php"><INPUT 
                        TYPE=IMAGE 
                         SRC="images/back copy.jpg" />
			</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="about_exp14.php">
			<INPUT 
                        TYPE=IMAGE 
                         SRC="images/nect copy.jpg" /></a>
		...
		<!-- end #content -->
			...
			<ul>
				...
				<li>
					<div align="center"><h2>Live Help</h2>
					<ul>
