...
<!-- end #menu -->
	...
	<div id="page-bgbtm">
		...
		<div class="post-bgbtm">
			  ...
			  <div class="entry">
			    <p>If a metal conductor is stretched or compressed, its resistance changes on account of the the fact that both length and diameter of conductor change.  Also there is a change in the value of resistivity of the conductor when it is strained and this property is called piezoresistive effect.  Therefore, resistance strain gauges are also known as piezoresistive gauges.  The strain gauges are used for measurement of strain and associated stress in experimental stress analysis.  Secondly, many other detectors and transducers, notably the load cells, torque meters, diaphragm type pressure gauges, temperature sensors, accelerometer and flow meters, employ strain gauges as secondary transducers.<br>


			    </p>
					 <p><div align="center"><img src="images/fo3.JPG" alt="" width="454" height="374" /></div><br>
					 <div align="center"><font color="#000000">Figure. 1</font></div>
					 <h3 class="title"><font color="#000000"> Theory of Strain Gauges </font></h3><br> 
					 <br>
					
					 <p>
					The change in the value of resistance by straining the gauge may be partly explained by the normal dimensional behavior of elastic material.  If a strip or a elastic material is subjected to tension, or in other words positively strain, its longitudinal dimension will increase while there will be a reduction in the lateral dimension.  So when a gauges is subjected to a positive strain, its length increases while its area of cross-section decreases as shown in Figure 2.  Since the resistance of a conductor is proportional to its length and inversely proportional to its area of cross section, the resistance of the gauge increases with positive strain.  The change in the value resistance strained conductor is more than what can be accounted for an increase in resistance due to dimensional changes.  The extra change in the value of resistance is attributed to a change in the value of resistivity of a conductor when strained.  This property, as described earlier, is known as piezoresistive effect.<br>
	Let us consider a strain gauge made of circular wire.  The wire has the dimensions: length = L, area = A, diameter = D before being strained.  The material of the wire has a resistivity <i>P</i><br>   
	 Resistance of unstrained gauge R = <i>p</i>L / A<br> 
  	Let a tensile stress  be applied to the wire.  This produces a positive strain causing the length to increase and area to decrease. Thus when the wire is strained there are changes in its dimensions.  Let &Delta; L = change in length, delta A =change in area, &Delta; D = change in diameter and delta R = change in resistance.</p>
					 <p><div align="center"><img src="images/f04.JPG" alt="" width="252" height="116" /></div></p><br>
					 <div align="center"><font color="#000000">Figure. 2</font></div>
					 <p>
			    </p>
			    </p>
					 <h3 class="style4">&nbsp;</h3>
					 <h3 class="style4">&nbsp;</h3>
			<div ><strong></strong>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="about experiment6.php"><iNPUT 
                        TYPE=IMAGE 
                         SRC="images/back copy.jpg" />
			</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="about_exp51.php">
			<iNPUT 
                        TYPE=IMAGE 
