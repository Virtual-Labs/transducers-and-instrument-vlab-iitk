...
1)AC phenomenonons such as vibration or shocks are best used to measure with a ?</div>
<div class="qselections">
<input type="radio" value="a" name="question1">a) Peizofilm based accelerometer<br>
<input type="radio" value="b" name="question1">b) Microphones<br>
...
<div class="qheader">
2) Name one must common inertial sensor ?</div>

<div class="qselections">
<input type="radio" value="a" name="question2">a) Accelerometer<br>
<input type="radio" value="b" name="question2">b) Tachometer<br>
...
<div class="qheader">
3) Which type of sensors require like conditioning ?</div>
<div class="qselections">

<input type="radio" value="a" name="question3">a) Analog accelerometer<br>
<input type="radio" value="b" name="question3">b) Industrial accelerometer<br>
<!--<input type="radio" value="c" name="question1">c) A jungle refers to the thickest area of a rain forest<br>
<input type="radio" value="d" name="question1">d) A jungle and a rain forest each contain their own group of distinct plants and animals.<br>-->
</div>
...
<div class="qheader">
4) To control frequency we need ?</div>
<div class="qselections">
<input type="radio" value="a" name="question4">a) Amplitude parameter control<br>

<input type="radio" value="b" name="question4">b) Frequency parameter control<br>
<!--<input type="radio" value="c" name="question1">c) A jungle refers to the thickest area of a rain forest<br>
<input type="radio" value="d" name="question1">d) A jungle and a rain forest each contain their own group of distinct plants and animals.<br>-->
</div>
...
<div class="qheader">
5) In a pulse width modulated signal the value of acceleration is proportional to ?</div>
<div class="qselections">
<input type="radio" value="a" name="question5">a) Channel width<br>
<input type="radio" value="b" name="question5">b) Pulse width<br>
...
<div class="qheader">
6) Optical analyzer can be used to measure the output of ?</div>
<div class="qselections">
<input type="radio" value="a" name="question6">a) Resistance <br>
<input type="radio" value="b" name="question6">b) Light-emitting devices<br>
<!--<input type="radio" value="c" name="question1">c) A jungle refers to the thickest area of a rain forest<br>
<input type="radio" value="d" name="question1">d) A jungle and a rain forest each contain their own group of distinct plants and animals.<br>-->
</div>
...
<div class="qheader">
9) FFT stands for ?</div>
<div class="qselections">
<input type="radio" value="a" name="question9">a) Fast Fourier Transform <br>
<input type="radio" value="b" name="question9">b) Fourier Fourier Transform<br>
<!--<input type="radio" value="c" name="question1">c) A jungle refers to the thickest area of a rain forest<br>
<input type="radio" value="d" name="question1">d) A jungle and a rain forest each contain their own group of distinct plants and animals.<br>-->
</div>
