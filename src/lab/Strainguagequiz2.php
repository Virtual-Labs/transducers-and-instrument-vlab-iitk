...
<div id="wrapper">
	...
	<div id="menu">
		<ul>
		      ...
		      <li><a href="experiment.php" style="background-image:url(images/images1.jpg)">&nbsp;&nbsp;<span class="style7">&nbsp;Experiment</span></a></li>
...
<script src="strainguagequiz2.js">
</script>
...
1) In wire wound stain gauges, the change in resistant on application of strain is mainly due to ?</div>
<div class="qselections">
<input type="radio" value="a" name="question1">a) change in length of wire <br>
<input type="radio" value="b" name="question1">b) change in diameter of wire<br>
<input type="radio" value="c" name="question1">c) change in both length and diameter of wire<br>
<input type="radio" value="d" name="question1">d) change in resistivity<br>
</div>

<br>

<div class="qheader">
2) Unbounded strain gauges are ?</div>
<div class="qselections">
<input type="radio" value="a" name="question2">a) exclusively used for transducer application<br>
<input type="radio" value="b" name="question2">b) Exclusively used for stress analysis<br>
<input type="radio" value="c" name="question1">c) Commonly used for both transducer applications as well as for stress analysis<br>
...
<div class="qheader">
3) Metal foil type of strain gauges are superior to wire wound metal stain gauges because ?</div>
<div class="qselections">

<input type="radio" value="a" name="question3">a) They have a higher heat dissipation capacity<br>
<input type="radio" value="b" name="question3">b) They have a larger surface area which makes the bonding easier<br>
<input type="radio" value="c" name="question1">c) They can be fabricated economically using techniques which are similar to those used for fabrication of macron-electronic circuitry<br>
<input type="radio" value="d" name="question1">d) All of the above<br>
</div>

<br>

<div class="qheader">
4) Metal foil gauges use fat end turns in order to ?</div>
<div class="qselections">
<input type="radio" value="a" name="question4">a) reduce transverse sensitivity<br>
<input type="radio" value="b" name="question4">b) reduce longitudinal sensitivity<br>
<input type="radio" value="c" name="question1">c) reduce cross sensitivity<br>
<input type="radio" value="d" name="question1">d) all of the above<br>
</div>
...
<div class="qheader">
5) In semi-conductor strain gauges, the change in resistance on application of strain ?</div>
<div class="qselections">
<input type="radio" value="a" name="question5">a) Is much higher than that in the case of metal stain gauges and this is mainly due to change in dimensions<br>
<input type="radio" value="b" name="question5">b) Is much higher than that in the case of metal strain gauges and this is mainly due to change in resistivity<br>
<input type="radio" value="c" name="question1">c) is lower than that in the case of metal stain gauges<br>
<input type="radio" value="d" name="question1">d) none of the above<br>
<!--<input type="radio" value="e" name="question1">e) 5<br>-->
</div>

<br>

<div class="qheader">
6) In semi- conductor strain gauges, when a tensile stain is applied ?</div>
<div class="qselections">
<input type="radio" value="a" name="question6">a) resistance increases in N-type of materials<br>
<input type="radio" value="b" name="question6">b) resistance increases in P-type of materials<br>
<input type="radio" value="c" name="question6">c) resistance increases in both P and N type materials<br>
<input type="radio" value="d" name="question6">d) resistance decreases in both P and N type materials<br>
<!--<input type="radio" value="e" name="question6">e) 67.3%  <br>-->
</div>

<br>

<div class="qheader">
7) Strain gauges, when used for measurement of torque transmitted by a motor to its load, are located in pair on the shaft connecting them.  So as to result in ?</div>
<div class="qselections">
<input type="radio" value="a" name="question7">a) reduction of power drain from the source of excitation<br>
<input type="radio" value="b" name="question7">b) compensation for temperature variations on the shaft<br>
<input type="radio" value="c" name="question7">c) increase in sensitivity of measurement<br>
<input type="radio" value="d" name="question7">d) minimization of effects of interference from external magnetic field<br>
...
<div class="qheader">
8) The principle of Pirani gauge is based on ?</div>
<div class="qselections">
<input type="radio" value="a" name="question8">a) humidity of the medium<br>
<input type="radio" value="b" name="question8">b) thermal conductively of the medium<br>
<input type="radio" value="c" name="question8">c) combustibility of the medium<br>
<input type="radio" value="d" name="question8">d) None of these<br>
...
<div class="qheader">
9) strain will create an ?</div>
<div class="qselections">
<input type="radio" value="a" name="question9">a) electrical inductance change that is relative to the pressure<br>
<input type="radio" value="b" name="question9">b) electrical resistance change that is relative to the pressure<br>
<input type="radio" value="c" name="question9">c) electrical capacitance change that is relative to the pressure<br>
<input type="radio" value="d" name="question9">d) none of these<br>
</div>

<br>

<div class="qheader">
10) Aircraft component testing is one area of application of strain-gauge ?</div>
<div class="qselections">
<input type="radio" value="a" name="question10">a) True<br>
<input type="radio" value="b" name="question10">b) false<br>
<!--<input type="radio" value="c" name="question10">c) <br>
<input type="radio" value="d" name="question10">d) <br>
<input type="radio" value="e" name="question10">e)The maximum line of magnetic force a material can hold<br>-->
</div>
