...
<?php if (isset($_SESSION['user'])) { ?>
	...
	<div id="page-bgbtm">
		...
		<div class="post-bgbtm">
				<h1 class="title"><div align="left"></div> 
				</h1><br>
				<div align="center"></div>
				
			  <div class="entry"><P>Foil type of gauges are employed for both stress analysis and as well as for construction of transducers.  Foil type of gauges are mounted on a flexible insulating carrier film about 0.025 mm thick which is made of polymide, glass phenolic etc. Typical gauges resistances are 120.350 and 1000 ohm with the allowable gauges current of 5 to 40 mA which is determined by the heat dissipation capabilities of the gauges.  The gauges factors typically range from 2 to 4.<br>
Minimum practical gauges size is constrained by the manufacturing limitations and handing attachment problems.  The smallest gauges sizes are about 0.38 mm long.  Foil type of gauges can be applied to curved surface; the minimum safe bend radius can be as small as 1.5 mm in some strain gauges.<br>
The maximum measurable strain varies from 0.5 to 4 percent.  However, special postyield gauges devices allow measurement upto 0.1.  Fatigue life of gauges varies with conditions.  However, 10 million cycles at ±1500 microstrain can be   applied to foil gauges without causing failure.<br>
Many different adhesives have been developed for fastening strain gauges to specimens.  Gauges and fastening methods are available to cover temperature ranges from -269°C to816°C.<br>
It is interesting to carry out simple calculations to find out what effect an applied stress has on a metal strain gauges.  Hooke’s law gives a relationship between stress and strain for linear stress-strain curve (i.e) for elastic limits) in terms of modulus of elasticity of the material under stress.  Hooke’s law may be written as:<br>
strain<br>
<div align="center"><img src="images/f00010.JPG" alt="" width="65" height="21" /></div><br> 
<p>Where G,s and E are respectively the strain, stress and modulus of elasticity.  The unit for stress and modulus of elasticity are N/m<sup>2</sup>. 
	The change in the value of resistance is quite small as is clear from the following example.<br>
<h3 class="title"> <font color="#000000">Evaporation Deposited Thin Metal Strain Gauges</font></h3><br><p>
Evaporation deposited thin film metal strain gauges are mostly used for the fabrication of transducers.  They are of sputter deposited variety.  Both processes begin with a suitable elastic metal element.  The elastic metal element converts the physical quantity into a strain.  To cite an example of a pressure transducer, a thin, circular metal diaphragm is formed.  Both the evaporation and sputtering processes from all the strain gauges elements directly on the strain surface, they are not separately attached as in the case of bounded strain gauges.<br>
In the evaporation process, the diaphragm is placed in a vacuum chamber with some insulating material.  Heat is applied until the insulating material vapourises and then condenses, forming a thin dielectric film on the diaphragm.   Suitably shaped templates are placed over the diaphragm, and the evaporation and condensation processes are repeated with the metallic gauge material, forming the desired strain gauge pattern on top of the insulating substrate.<br>
 	In the sputtering process, a thin dielectric layer is deposited in vacuum over the entire diaphragm surface.  The detailed mechanism of deposition is, however, entirely different from the evaporation method.  The complete layer of metallic gauge is sputtered on the top of the dielectric material without using any substrate.  The diaphragms are now removed from the vacuum chamber, and microimaging techniques using photomasking materials are used to from the gauge pattern.  The diaphragms are than return to the vacuum chamber.  Sputter etching techniques are used to remove all unmasked metal layer, leaving behind the desired gauge pattern.<br>
	Resistance and gauge factors of film gauges are identical to those of foil gauges.  Since no organic cementing, materials are used, thin film gauges exhibit a better time and temperature stability.<br>
<h3 class="title"> <font color="#000000">Semi-conductor Strain Gauges</font></h3><br><p>It has been explained above in order to have a high sensitivity a high value of gauge factor is desirable.  A high gauge factor means a relatively higher change in resistance which can be easily measured with a good degree of accuracy.<br>
	Semiconductor strain gauges are used where a very high gauge factor and a small envelope are required.  The resistance of the semi-conductor change with change in applied strain.  Unlike in the case of metallic gauges where the change in resistance is mainly due to chance in dimensions when strained, the semi-conductor strain gauge depend for their action upon piezo-resistive effect i.e. the change in the value of the resistance due to change in resistivity.<br>
	Semi-conducting materials such as silicon and germanium are used as resistive materials for semi-conductor strain gauges.  A typical strain gauges consists of a strain sensitive crystal material and leads that are sandwiched in a protective matrix.  The production of these gauges employs conventional semi-conducting wafers or filaments which have a thickness of 0.05 mm and bonding them on suitable insulating substrates, such as teflon. Gold leads are general employed for making the contacts.   These strain gauges can be fabricated along with integrated circuit (IC) operational amplifiers which can act as pressure sensitive transducers.<br>
...
<div align="center"><br>
			  ...
			  <div align="center"></div> 
					 ...
					 <h3 class="style4">&nbsp;</h3>
					 <h3 class="style4">&nbsp;</h3>
			<div ><strong></strong>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="about_exp54.php"><iNPUT 
                        TYPE=IMAGE 
                         SRC="images/back copy.jpg" />
			</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="about_exp56.php">
			<iNPUT 
                        TYPE=IMAGE 
