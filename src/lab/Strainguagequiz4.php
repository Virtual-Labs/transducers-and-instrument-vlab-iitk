...
<script src="strainguagequiz4.js">
</script>
...
1) Mostly resistance strain has a gauge factor of about ?</div>
<div class="qselections">
<input type="radio" value="a" name="question1">a) 2<br>
<input type="radio" value="b" name="question1">b) 10<br>
<input type="radio" value="c" name="question1">c) 100<br>
<input type="radio" value="d" name="question1">d) 0.2<br>
</div>

<br>

<div class="qheader">
2) In a strain measuring equipment, using a resistance strain gauge, the output quantity is ?</div>
<div class="qselections">
<input type="radio" value="a" name="question2">a) Resistance<br>
<input type="radio" value="b" name="question2">b) Voltage<br>
<input type="radio" value="c" name="question1">c) Current<br>
<input type="radio" value="d" name="question1">d) Impedance<br>
</div>

<br>

<div class="qheader">
3) Which statement is true for Rosette ?</div>
<div class="qselections">
<input type="radio" value="a" name="question3">a) It consists of shielding device for instrument<br>
<input type="radio" value="b" name="question3">b) It is heat dissipating device<br>
<input type="radio" value="c" name="question1">c) It controls noise in instruments<br>
<input type="radio" value="d" name="question1">d) It consists of three strain gauges oriented in different directions<br>
</div>

<br>

<div class="qheader">
4) Proper selection and use of the bridge, required for reliable measurements are ?</div>
<div class="qselections">
<input type="radio" value="a" name="question4">a) signal conditioning<br>
<input type="radio" value="b" name="question4">b) wiring<br>
<input type="radio" value="c" name="question1">c) data acquisition components<br>
<input type="radio" value="d" name="question1">d) All of these<br>
</div>

<br>

<div class="qheader">
5) Half-bridge completion resistors provided on the SCXI-1122 signal conditioning module are 2.5 kW resistors a ratio tolerance of ?</div>
<div class="qselections">
<input type="radio" value="a" name="question5">a) 0.02%.<br>
<input type="radio" value="b" name="question5">b) 0.03%<br>
<input type="radio" value="c" name="question1">c) 0.07%<br>
<input type="radio" value="d" name="question1">d) 0.01%<br>
...
<div class="qheader">
6) signal conditioners include a feature , to compensate for voltage drop error is called ?</div>
<div class="qselections">
<input type="radio" value="a" name="question6">a) remote sensing<br>
<input type="radio" value="b" name="question6">b) error sensing<br>
<input type="radio" value="c" name="question6">c) strain sensing<br>
...
<div class="qheader">
7) A strain gage is a device used to measure the strain of an object invented by ?</div>
<div class="qselections">
<input type="radio" value="a" name="question7">a) Edward E. Simmons <br>
<input type="radio" value="b" name="question7">b) Arthur C. Ruge<br>
<input type="radio" value="c" name="question7">c) Both of these<br>
<input type="radio" value="d" name="question7">d) None of these<br>
...
<div class="qheader">
8) Strain gage is a device invented in ?</div>
<div class="qselections">
<input type="radio" value="a" name="question8">a) 1937 <br>
<input type="radio" value="b" name="question8">b) 1938<br>
<input type="radio" value="c" name="question8">c) 1940<br>
<input type="radio" value="d" name="question8">d) 1970<br>
...
<div class="qheader">
9) Strain gage based technology is utilized commonly in the manufacture of ?</div>
<div class="qselections">
<input type="radio" value="a" name="question9">a) Remote sensor<br>
<input type="radio" value="b" name="question9">b) Pressure sensor<br>
<input type="radio" value="c" name="question9">c) Heat sensor<br>
<!--<input type="radio" value="d" name="question9">d) time varying signals<br>
...
<div class="qheader">
10) An transducer converts ?</div>
<div class="qselections">
<input type="radio" value="a" name="question10">a) other form of energy to electrical energy<br>
<input type="radio" value="b" name="question10">b) electrical energy to light energy<br>
<input type="radio" value="c" name="question10">c) mechanical displacement into electrical signal<br>
<input type="radio" value="d" name="question10">d) Electrical energy to mechanical form<br>
<!--<input type="radio" value="e" name="question10">e) none of these<br>-->
</div>
