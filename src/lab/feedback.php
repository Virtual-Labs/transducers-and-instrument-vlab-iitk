...
<a href="/virtuallab/user.php"<?php echo $fet['User_Email_Id'];?> <style="padding-right:0px; text-decoration:none;">Update Profile</a></div><?php } ?>  
	...
	<div id="page-bgbtm">
		...
		<div class="post-bgbtm">
			  ...
			  <div class="entry"><h1 align="center" class="style4">Feedback form </h1>
				<br>
				  
				    <p><form action="sendmail.php" method="POST">
                      <div align="center"><b><font color="#000000">Your name :&nbsp;</font></b> 
                          <input type="text" name="name">
                          <br>
                          
                          <b><font color="#000000">Your e-mail :</font></b> 
                          ...
                          <b><font color="#000000">Message</font></b><br>
                          <textarea name="message" rows="15" cols="50">
                          </textarea>  
                          <br>
                          <input type="submit" value="Send">
                          <input type="reset" value="Clear">                                                                                                                                                                                                           
<!--<a href="about_exp2.php">BACK</a>-->
					 </div>
				    </form>
				    </div>
			</div>
