...
<?php if (isset($_SESSION['user'])) { ?>
	...
	<div id="page-bgbtm">
		...
		<div class="post-bgbtm">
				<h1 class="title"><div align="center"><img src="images/f00011.JPG" alt="" width="285" height="157" /></div> 
				</h1><br><div align="center"><font color="#000000">Figure.6</font></div>
				<div align="center"></div>
				
				
			  <div class="entry"><h3 class="title"> <font color="#000000">Advantages</font></h3><br><p>
			  <b>(i)</b>	Semi conductor strain gauges have the advantage that they have a high gauges factor of about ±130.  This allows measurement of very small strain of the order of 0.01 microstrain.<br>
<b>(ii)</b>	Hysteresis characteristics of semi-conductor strain gauges are excellent.  Some units maintain it to less than 0.05%.<br>
<b>(iii)</b>	Fatigue life is in excess of 10×106 operations and the frequency response is upto 1012 Hz.<br>
<b>(iv)</b>	Semi-conductor strain gauges can be very small ranging in length from 0.7 to 7 mm.  They are very sensitive to changes in temperature.<br>
<h3 class="title"> <font color="#000000">Disadvantages</font></h3><br><p><b>(i)</b>	The major and serious disadvantage of semi-conductor strain gauges is that they are very sensitive to change in temperature.<br>
<b>(ii)</b>	Linearity of the semi-conductor strain gauge is poor.  
      <br>
This gauge is rather non-linear at comparatively high strain levels.  The gauge factor varies with strain.  For example if the gauge factor is 130 at 0.2 percent strain, then it is 112 at 0.4 percent strain.  The characteristics can be made linear by proper doping.
<h3 class="title"> <font color="#000000"> Diffused Strain gauges</font></h3><br><p>The diffused strain and difficult to attach to the object under study.  Diffusion process used in IC manufacture is employed.  In pressure transducers, for example the diaphragm would be of silicon rather than metal and the strain gauge effect would be realized by depositing impurities in the diaphragm to from an intrinsic strain gauge.   This type of construction may allow lower manufacturing costs in some designs, as a large number of diaphragms can be made on a single silicon wafer.<br>
<h3 class="title"> <font color="#000000">Rosettes</font></h3><br>
<p>
In addition to single elements strain gauges, combinations of strain gauges called “Rosettes” are available in many combinations for specific stress analysis or transducer applications.<br>
In practical problem, an element may be subjected to stresses in any direction and hence it is not possible to locate the direction of principle stress.  Therefore, it is not possible to orient the strain, gauges along the direction of principle stress. Hence there is a necessity to evolve a strain gauge measurement system.

			  
			  
			  
<div align="right"><a href="about_exp5.php"><iNPUT 
                        TYPE=IMAGE 
