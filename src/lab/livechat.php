	...
	<div id="menu">
		<ul>
		      ...
		      <li><a href="feedback.php" style="background-image:url(images/images1.jpg)">&nbsp;<strong>FEEDBACK</strong>&nbsp;&nbsp;&nbsp;</a></li>
			   <li><a href="livechat.php" style="background-image:url(images/images1.jpg)" > &nbsp; <strong> LIVE HELP</strong> &nbsp; </a></li>
      </ul>
...
<form action="Google_search_results.php" id="cse-search-box" >
  <div>
   ...
   <br /></td>
    ...
    <td>
         <button><option value="google.com"><b>Search</option></b>
...
<!-- end #menu -->
	...
	<div id="page-bgbtm">
		...
		<div class="post-bgbtm">
				<h1 class="title">Welcome to Virtual Lab</h1>
				<p><font color="#0000CC"><b></b>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</font></p> 
     ...
     <br />
     <script src="http://www.everywherechat.com/e.php?defaultRoom=Virtual_Lab&roomList=true&fontSize=12&width=600&height=500&theme=classic"></script>
