...
<script src="displacementtransducerquiz2.js">
</script>
...
1) LVDT can be used to measure ?</div>
<div class="qselections">
<input type="radio" value="a" name="question1">a) Acceleration<br>
<input type="radio" value="b" name="question1">b) Velocity<br>
<input type="radio" value="c" name="question1">c) Displacement<br>
<input type="radio" value="d" name="question1">d) Any of these<br>
</div>

<br>

<div class="qheader">
2) A seismic transducer is generally used in the instruments for the measurement of ?</div>
<div class="qselections">
<input type="radio" value="a" name="question2">a) Temperature<br>
<input type="radio" value="b" name="question2">b) Relative humidity<br>
<input type="radio" value="c" name="question1">c) Vibration<br>
...
<input type="radio" value="a" name="question3">a) Displacement transducer<br>
<input type="radio" value="b" name="question3">b) Velocity transducer<br>
<input type="radio" value="c" name="question1">c) Acceleration transducer<br>
<input type="radio" value="d" name="question1">d) Pressure transducer<br>
</div>

<br>

<div class="qheader">
4) An E-transformer is a ?</div>
<div class="qselections">
<input type="radio" value="a" name="question4">a) Displacement transducer<br>
<input type="radio" value="b" name="question4">b) Velocity transducer<br>
<input type="radio" value="c" name="question1">c) Acceleration transducer <br>
<input type="radio" value="d" name="question1">d) None of above <br>
</div>

<br>

<div class="qheader">
5) LVDT is always used as ?</div>
<div class="qselections">
<input type="radio" value="a" name="question5">a) Secondary transducer<br>
<input type="radio" value="b" name="question5">b) Primary transducer<br>
<input type="radio" value="c" name="question1">c) Primary signal generator<br>
...
<div class="qheader">
6) Which of the following is a digital transducer ?</div>
<div class="qselections">
<input type="radio" value="a" name="question6">a) Strain gauge <br>
<input type="radio" value="b" name="question6">b) Encoder<br>
<input type="radio" value="c" name="question6">c) Thermistor<br>
<input type="radio" value="d" name="question6">d) LVDT<br>
</div>

<br>

<div class="qheader">
7) The core of LVDT is made from ?</div>
<div class="qselections">
<input type="radio" value="a" name="question7">a) Soft iron<br>
<input type="radio" value="b" name="question7">b) Steel<br>
<input type="radio" value="c" name="question7">c) Copper<br>
...
<div class="qheader">
8) The size of air cored transducers as compare to iron core counter part are ?</div>
<div class="qselections">
<input type="radio" value="a" name="question8">a) Bigger <br>
<input type="radio" value="b" name="question8">b) Smaller<br>
<input type="radio" value="c" name="question8">c) Same<br>
<!--<input type="radio" value="d" name="question8">d)all of the above <br>-->
...
<div class="qheader">
9)  A potentiometer is ?</div>
<div class="qselections">
<input type="radio" value="a" name="question9">a) An active transducer <br>
<input type="radio" value="b" name="question9">b) A passive transducer<br>
<input type="radio" value="c" name="question9">c) A secondary transducer<br>
<input type="radio" value="d" name="question9">d) A current sensing transducer<br>
</div>

<br>

<div class="qheader">
10) The principle of LVDT based on ?</div>
<div class="qselections">
<input type="radio" value="a" name="question10">a) Mutual induction<br>
<input type="radio" value="b" name="question10">b) Self inductance<br>
<!--<input type="radio" value="c" name="question10">c) 17.5 nano second<br>
<input type="radio" value="c" name="question10">c) 0.175 micro second<br>-->
</div>
