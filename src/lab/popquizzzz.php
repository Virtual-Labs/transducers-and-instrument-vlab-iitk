...
</font><a href="/virtuallab/logout.php" style="padding-right:10px; text-decoration:none;">Logout</a>Update Profile</a></div>
<?php } ?>  
<!-- end #menu -->
...
1) A cantilever is used as a primary sensing element for measurement of force. The measured deflection 0.5 mm for a particular set up. Suppose each of the dimentions i.e. length, width and thickness of the cantilever are doubled with the force and material of cantilever remaining the same, the deflection of the cantilever is ?</div>
<div class="qselections">
<input type="radio" value="a" name="question1">a) 0.125 mm<br>
<input type="radio" value="b" name="question1">b) 0.25 mm<br>
...
<div class="qheader">
2) The RTDs use the principle of change of resistance with temperature. The properties of a conductor material to be used as an element of an RTD should possess the following properties  ?</div>

<div class="qselections">
<input type="radio" value="a" name="question2">a) the change in resistance per unit change in temperature should be as small as possible<br>
<input type="radio" value="b" name="question2">b) the change of resistance with temperature should not be linear function<br>
<input type="radio" value="c" name="question2">c) none of the above<br>
...
<div class="qheader">
3) The resistance of a thermometer is  at  and  at . Using linear approximation, the value of resistance temperature co-efficient at   ?</div>
<div class="qselections">

<input type="radio" value="a" name="question3">a) 0.0081/<sup>o</sup>C<br>
<input type="radio" value="b" name="question3">b) 0.0087/<sup>o</sup>C<br>
<!--<input type="radio" value="c" name="question1">c) A jungle refers to the thickest area of a rain forest<br>
<input type="radio" value="d" name="question1">d) A jungle and a rain forest each contain their own group of distinct plants and animals.<br>-->
</div>
...
<div class="qheader">
4) The sensitivity of thermistors as compared with sensitivity of platinum resistance temperature detector over a temperature range of  to  to changes in temperature is  ?</div>
<div class="qselections">
<input type="radio" value="a" name="question4">a) 10<sup>6</sup> times<br>

<input type="radio" value="b" name="question4">b) 100 times<br>
<!--<input type="radio" value="c" name="question1">c) A jungle refers to the thickest area of a rain forest<br>
<input type="radio" value="d" name="question1">d) A jungle and a rain forest each contain their own group of distinct plants and animals.<br>-->
</div>
...
<div class="qheader">
5) A thermistor exhibits  ?</div>
<div class="qselections">
<input type="radio" value="a" name="question5">a) only a negative change of resistance with increase in temperature<br>
<input type="radio" value="b" name="question5">b) can exhibit either a negative or positive change of resistance with increase of temperature depending upon the type of material used<br>
...
<div class="qheader">
6) The temperature transducers exhibit non-linear behaviour. The order in which they exhibit nonlinearity (highest to lowest) is  ?</div>
<div class="qselections">
<input type="radio" value="a" name="question6">a) Thermocouples, RTD. Thermistors <br>
<input type="radio" value="b" name="question6">b) Thermistors, Thermocouples, RTDs<br>
<!--<input type="radio" value="c" name="question1">c) A jungle refers to the thickest area of a rain forest<br>
<input type="radio" value="d" name="question1">d) A jungle and a rain forest each contain their own group of distinct plants and animals.<br>-->
</div>
...
<div class="qheader">
7) Three types of temperature transducers are compared as regards their sensitivity. The order in which they exhibit their sensitivities (highest to lowest) is ?</div>
<div class="qselections">
<input type="radio" value="a" name="question7">a) Thermistors, RTDs, thermocouples <br>
<input type="radio" value="b" name="question7">b) Thermocouples, RTDs, thermistors<br>
<!--<input type="radio" value="c" name="question1">c) A jungle refers to the thickest area of a rain forest<br>
<input type="radio" value="d" name="question1">d) A jungle and a rain forest each contain their own group of distinct plants and animals.<br>-->
...
<div class="qheader">
8) Thermocouples are  ?</div>
<div class="qselections">
<input type="radio" value="a" name="question8">a) active transducers<br>

<input type="radio" value="b" name="question8">b) passive transducers<br>
<!--<input type="radio" value="c" name="question1">c) A jungle refers to the thickest area of a rain forest<br>
<input type="radio" value="d" name="question1">d) A jungle and a rain forest each contain their own group of distinct plants and animals.<br>-->
...
<div class="qheader">
9) A thermocouple produces a voltage of 50 mV. Its internal resistance is 50W . The resistance of its leads is 10W . Its output is real by a PMMC meter having an internal resistance of 120W . The output voltage indicated is ?</div>
<div class="qselections">
<input type="radio" value="a" name="question9">a) 33.3 mV <br>
<input type="radio" value="b" name="question9">b) 40 mV<br>
<!--<input type="radio" value="c" name="question1">c) A jungle refers to the thickest area of a rain forest<br>
<input type="radio" value="d" name="question1">d) A jungle and a rain forest each contain their own group of distinct plants and animals.<br>-->
</div>
...
<div class="qheader">
10) Air cored inductive transducers are suitable for use ?</div>
<div class="qselections">
<input type="radio" value="a" name="question10">a) at lower frequencies<br>
<input type="radio" value="b" name="question10">b) at higher frequencies<br>
