...
1)	The  source of emission of electrons in a CRT is: ?</div>
<div class="qselections">
<input type="radio" value="a" name="question1">a)	PN function diode<br>
<input type="radio" value="b" name="question1">b)a barium and strontium oxide coated cathode<br>
...
<div class="qselections">
<input type="radio" value="a" name="question2">a)Between pre accelerating and accelerating anodes<br>
<input type="radio" value="b" name="question2">b)After accelerating anode<br>
<input type="radio" value="c" name="question1">c)Before pre-accelerating anode<br>
...
<div class="qheader">
3) The deflection of an electron beam on a CRT screen is 10 mm.  suppose the pre accelerating anode voltage Is halved the potential between deflecting plates is doubled, the deflection of the electros beam will be ?</div>
<div class="qselections">

<input type="radio" value="a" name="question3">a)80 mm<br>
<input type="radio" value="b" name="question3">b)40 mm<br>
<input type="radio" value="c" name="question1">c)20 mm<br>
<input type="radio" value="d" name="question1">d)10 mm.<br>
</div>

<br>

<div class="qheader">
4)If the distance of screen from a CRT to center of deflection plates is 15 cm.  The length of deflection plates is 2 cm, the distance between plates is 1 cm and the accelerating voltage is 500 V, the deflection sensitivity is ?</div>
<div class="qselections">
<input type="radio" value="a" name="question4">a)33.2 V/cm<br>
<input type="radio" value="b" name="question4">b)0.03 cm/V<br>
<input type="radio" value="c" name="question1">c)66.4 V/cm<br>
<input type="radio" value="d" name="question1">d)0.015 cm/V.<br>
</div>

<br>

<div class="qheader">
5) 5.	Post acceleration is needed in a Crop If the Frequency of the signal is ?</div>
<div class="qselections">
<input type="radio" value="a" name="question5">a)Less than 1 MHz<br>
<input type="radio" value="b" name="question5">b)More than 1MHz<br>
<input type="radio" value="c" name="question1">c)More than 10 MHz<br>
<input type="radio" value="d" name="question1">d)More than 10 Hz.<br>
</div>

<br>

<div class="qheader">
6) P1 phosphor material is used for display in CRTs for ?</div>
<div class="qselections">
<input type="radio" value="a" name="question6">a)photographic applications<br>
<input type="radio" value="b" name="question6">b)general purpose applications<br>
<input type="radio" value="c" name="question1">c)television applications<br>
...
<div class="qheader">
7)An aquatic is used in a CRO to collect ?</div>
<div class="qselections">
<input type="radio" value="a" name="question7">a)primary electrons<br>
<input type="radio" value="b" name="question7">b)secondary emission electrons<br>
<input type="radio" value="c" name="question1">c)Both primary and secondary emission electrons<br>
...
<div class="qheader">
8)A thin aluminum film is usually deposited on the non viewing side of the phosphor because ?</div>
<div class="qselections">
<input type="radio" value="a" name="question8">a)it acts as heat sink and prevents phosphor <br>
<input type="radio" value="b" name="question8">b)the light scatter from the phosphor is reduced<br>
<input type="radio" value="c" name="question1">c)it does not allow the screen to be negative charged<br>
<input type="radio" value="d" name="question1">d)all of the above .<br>
...
<div class="qheader">
9)9.	During the retrace time, the electrons forming the horizontal Beam ?</div>
<div class="qselections">
<input type="radio" value="a" name="question9">a)move from left to right on the screen<br>
<input type="radio" value="b" name="question9">b)move from right to the left on the screen <br>
<input type="radio" value="c" name="question1">c)move from bottom to top of screen<br>
<input type="radio" value="d" name="question1">d)move from top to bottom of screen.<br>
</div>

<br>

<div class="qheader">
10)The bandwidth of a CRO is from 0-20 MHz The fastest rise time a  sine wave can have to be accurately reproduced by the instrument is ?</div>
<div class="qselections">
<input type="radio" value="a" name="question10">a)35 nano second<br>
<input type="radio" value="b" name="question10">b)35 micro second<br>
<input type="radio" value="c" name="question10">c)17.5 nano second<br>
<input type="radio" value="c" name="question10">d)0.175 micro second<br>
</div>
