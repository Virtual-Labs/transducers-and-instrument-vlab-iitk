...
<?php if (isset($_SESSION['user'])) { ?>
	...
	<div id="page-bgbtm">
		...
		<div class="post-bgbtm">
			  ...
			  <div class="entry">
					 <p>The flow rate through a rotameter is given by:</p><br/>
					 <div align="center"><img src="images/clip_image0023.bmp" alt="" width="470" height="211" /></div><br/>
					 <p align="left" >where,<br />
      u = flow velocity<br />
      b=density of the bob<br />
      f =  density of the fluid<br />
      A  = area of the annulus between the bob and tube wall<br />
      Y  = distance from the bottom of the meter<br />
      f  (y)= the function the defines the tube taper<br />
      C  = a drag coefficient<br />
      Q  = volumetric flow rate</p> 
					 <div align="center"><img src="images/clip_image0024.jpg" alt="" width="470" height="230" /></div>
					 <div  align="right"><strong></strong>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="about_exp4.php"><INPUT 
                        TYPE=IMAGE 
