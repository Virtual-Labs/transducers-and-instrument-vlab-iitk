...
1)The horizontal amplifier should be designed for ?</div>
<div class="qselections">
<input type="radio" value="a" name="question1">a)high frequency signals with a fast rise time<br>
<input type="radio" value="b" name="question1">b)high amplitude signals with a slow rise time<br>
<input type="radio" value="c" name="question1">c)high amplitude signals with a fast rise time <br>
<input type="radio" value="d" name="question1">d)low amplitude signals with a fast rise time<br>
</div>

<br>

<div class="qheader">
2)A vertical amplifier for a CRO can be designed for ?</div>

<div class="qselections">
<input type="radio" value="a" name="question2">a)only a broad bandwidth<br>
<input type="radio" value="b" name="question2">b)a constant gain times bandwidth product<br>
<input type="radio" value="c" name="question1">c)only a high gain<br>
...
<div class="qheader">
3)In an oscilloscope, when the unknown signal applied to the veridical plates is being synchronized with the sweep signal applied to horizontal plates, the pattern, the pattern seen on the CRO screen moves toward the right It means that, ?</div>
<div class="qselections">

<input type="radio" value="a" name="question3">a)the frequency of the signal is greater than that of the sweep signal<br>
<input type="radio" value="b" name="question3">b)the frequency of the signal is lower than that of the sweep signal<br>
<input type="radio" value="c" name="question1">c)the frequency of the signal is equal to the frequency of sweep signal<br>
...
<div class="qheader">
4)An oscilloscope has an input capacitance of 50 pF and a resistance of 2 mega ohm and the voltage divider ratio of 10.  The parameters of a high impedance probe are ?</div>
<div class="qselections">
<input type="radio" value="a" name="question4">a)C1 = 3.33 pF, R1 = 9 Mega ohm<br>
<input type="radio" value="b" name="question4">b)C1 = 5.55 pF, R1 = 18 Mega ohm<br>
<input type="radio" value="c" name="question1">c)C1 = 1.11 pF, R1 = 18 Mega ohm<br>
<input type="radio" value="d" name="question1">d)C1 = 5.55 pF, R1 = 9 Mega ohm<br>
</div>

<br>

<div class="qheader">
5)In a digital storage oscilloscope, the input signals are ?</div>
<div class="qselections">
<input type="radio" value="a" name="question5">a)Directly applied to the oscilloscope<br>
<input type="radio" value="b" name="question5">b)multiplexed, converted to digital from and stored and applied to oscilloscope<br>
<input type="radio" value="c" name="question1">c)applied to amplifier, stored as analog signals , multiplexed, converted to cc  converted to digital from, stored in digital from converted to analog From, and applied to CRO through an amplifier<br>
<input type="radio" value="d" name="question1">d)multiplexed, converted to digital from stored, converted to analog from and applied to oscilloscope.<br>
</div>

<br>

<div class="qheader">
6)waveguide acts as a ?</div>
<div class="qselections">
<input type="radio" value="a" name="question6">a)Low pass filter <br>
<input type="radio" value="b" name="question6">b)high pass filter<br>
<input type="radio" value="c" name="question1">c)band pass filter<br>
...
<div class="qheader">
7) The focus adjustment of an oscillograph varies ?</div>
<div class="qselections">
<input type="radio" value="a" name="question7">a)the grid voltage of CRT<br>
<input type="radio" value="b" name="question7">b)second anode voltage<br>
<input type="radio" value="c" name="question1">c)the filament voltage<br>
<input type="radio" value="d" name="question1">d)the accelerating voltage<br>
...
<div class="qheader">
8)The deflection sensitivity of a CRT is given as 0.2 mm/V.  The voltage applied to the deflection plates for a deflection of 3 inches is?</div>
<div class="qselections">
<input type="radio" value="a" name="question8">a)6<br>
<input type="radio" value="b" name="question8">b)15<br>
<input type="radio" value="c" name="question1">c)318<br>
<input type="radio" value="d" name="question1">d)375<br>
...
<div class="qheader">
9)A sinusoidal waveform of 5 kHz is applied to the vertical input of a free running oscilloscope.  The horizontal sweep speed is set so that a full cycle takes 0.4 sec.  The resulting display for one sweep of beam is ?</div>
<div class="qselections">
<input type="radio" value="a" name="question9">a)a saw tooth<br>
<input type="radio" value="b" name="question9">b)two cycles of the input signal<br>
<input type="radio" value="c" name="question1">c)a sine wave<br>
<input type="radio" value="d" name="question1">d)12.5 kHz<br>
</div>

<br>

<div class="qheader">
10) A sinusoidal waveform as seen on an oscilloscope has peak to peak amplitude of 6 cm.  If the vertical sensitivity setting is 5V/cm the pat to peak and rms values are ?</div>
<div class="qselections">
<input type="radio" value="a" name="question10">a)30,212<br>
<input type="radio" value="b" name="question10">b)21.2,30<br>
<input type="radio" value="c" name="question10">c)5, 3.54<br>
<input type="radio" value="c" name="question10">c)15,10.61<br>
</div>
