...
<script src="strainguagequiz3.js">
</script>
...
1) Load cell essentially is a ?</div>
<div class="qselections">
<input type="radio" value="a" name="question1">a) Thermistor <br>
<input type="radio" value="b" name="question1">b) strain gauge<br>
<input type="radio" value="c" name="question1">c) photo-voltaic cell<br>
...
<div class="qheader">
2) Which of the following quantities cannot be measured by load cell ?</div>
<div class="qselections">
<input type="radio" value="a" name="question2">a) Level<br>
<input type="radio" value="b" name="question2">b) Pressure<br>
<input type="radio" value="c" name="question1">c) Temperature<br>
<input type="radio" value="d" name="question1">d) Weight<br>
</div>

<br>

<div class="qheader">
3) Pirani gage is used to measure ?</div>
<div class="qselections">
<input type="radio" value="a" name="question3">a) very high pressure<br>
<input type="radio" value="b" name="question3">b) very low pressure<br>
<input type="radio" value="c" name="question1">c) atmospheric  pressure<br>
...
<div class="qheader">
4) Piezometer is used to measure ?</div>
<div class="qselections">
<input type="radio" value="a" name="question4">a) pressure in pipes and channels<br>
<input type="radio" value="b" name="question4">b) very high pressure<br>
<input type="radio" value="c" name="question1">c) very low pressure<br>
<input type="radio" value="d" name="question1">d) difference of pressure between two points<br>
</div>

<br>

<div class="qheader">
5) The best method for the measurement of temperature of hot bodies radiating energy in the visible spectrum is ?</div>
<div class="qselections">
<input type="radio" value="a" name="question5">a) bolometer<br>
<input type="radio" value="b" name="question5">b) optical pyrometers<br>
<input type="radio" value="c" name="question1">c) thermocouples<br>
<input type="radio" value="d" name="question1">d) thermopile<br>
...
<div class="qheader">
6) Typical strain gauge resistances range from ?</div>
<div class="qselections">
<input type="radio" value="a" name="question6">a) 30 Ohms to 3 kOhms<br>
<input type="radio" value="b" name="question6">b) 20 ohms to 5 kohms<br>
<input type="radio" value="c" name="question6">c) 5 ohms to 1 kohms<br>
<input type="radio" value="d" name="question6">d) 11ohm to 2 kohms<br>
...
<div class="qheader">
7) In a force-balance transducer ?</div>
<div class="qselections">
<input type="radio" value="a" name="question7">a) the output of the sensing element is amplified <br>
<input type="radio" value="b" name="question7">b) the output is fed back to an element which causes a force-summing member to return to its zero position<br>
<input type="radio" value="c" name="question7">c) the magnitude of the feedback determines the output of the transducer<br>
...
<div class="qheader">
8) Which of the following materials for strain gauges has the highest gauge factor ?</div>
<div class="qselections">
<input type="radio" value="a" name="question8">a) Nicrome<br>
<input type="radio" value="b" name="question8">b) Constantan<br>
<input type="radio" value="c" name="question8">c) Isoelastic<br>
<input type="radio" value="d" name="question8">d) Platinum<br>
...
<div class="qheader">
9) The resistance of resistance strain gauges is likely to be ?</div>
<div class="qselections">
<input type="radio" value="a" name="question9">a) 5 ohms<br>
<input type="radio" value="b" name="question9">b) 50 ohms<br>
<input type="radio" value="c" name="question9">c) 150 ohms<br>
<input type="radio" value="d" name="question9">d) 5000 ohms<br>
</div>

<br>

<div class="qheader">
10) stress is applied to the bonded strain gauge,a resistive changes takes
place ?</div>
<div class="qselections">
