...
<?php if (isset($_SESSION['user'])) { ?>
	...
	<div id="page-bgbtm">
		...
		<div class="post-bgbtm">
			...
			<div class="entry">
			 <p><strong><font color="#000000"><span class="style5">Applications :</span></font></strong><br/>
				<strong><font color="#000000"><span class="style5">Audio :</span></font></strong><br/>				
				<strong><font color="#000000"><span class="style5">1.</span></font></strong>	Most modern audio signals are stored in digital form (for example MP3s and CDs) and in order to be heard through speakers they must be converted into an analog signal. DACs are therefore found in<br/>
                        <font color="#000000">i.</font>&nbsp;&nbsp;CD players,<br/> 
                       <font color="#000000">ii.</font>&nbsp;&nbsp;Digital music players, and PC sound cards,<br/> 
                      <font color="#000000">iii.</font>&nbsp;&nbsp;Digital Telephone/Answering Machines.<br/>                       
<strong><font color="#000000"><span class="style5">2.</span></font></strong>	Specialist standalone DACs can also be found in high-end hi-fi systems. These normally take the digital output of a compatible CD player or dedicated transport and convert the signal into an analog line-level output that can then be fed into an amplifier to drive speakers.<br/>
<strong><font color="#000000"><span class="style5">3.</span></font></strong>	Digital-to-analog converters can be found in digital speakers such as USB speakers, and in sound cards.<br/> 
<strong><font color="#000000"><span class="style5">4.</span></font></strong>	VOIP (Voice over IP) Phone, Data transmission over the Internet is done digitally so in order for voice to be transmitted it must be converted to digital using an Analog-to-Digital Converter and be converted into analog again using a DAC so the voice it can be heard on the other end.<br/>
			     
<strong><font color="#000000"><span class="style5">Video :</span></font></strong><br/>
<strong><font color="#000000"><span class="style5">1.</span></font></strong>	Video signals from a digital source, such as a computer, must be converted to analog form if they are to be displayed on an analog monitor. As of 2007, analog inputs are more commonly used than digital, but this may change as flat panel displays with DVI and/or HDMI connections become more widespread. A video DAC is, however, incorporated in any digital video player with analog outputs. The DAC is usually integrated with some memory (RAM), which contains conversion tables for gamma correction, contrast and brightness, to make a device called a RAMDAC.<br/>
<strong><font color="#000000"><span class="style5">2.</span></font></strong>	A device that is distantly related to the DAC is the digitally controlled potentiometer, used to control an analog signal digitally.<br/></p>
			<div align="right"><a href="theory7.php"><INPUT 
                        TYPE=IMAGE 
