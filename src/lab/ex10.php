...
<?php if (isset($_SESSION['user'])) { ?>
    ...
    <a href="logout.php" style="padding-right:10px;">Logout</a><a href="user.php"></a> 
    </div>
    <?php } ?>  
    ...
    <div id="page-bgbtm">
        ...
        <div class="post-bgbtm">
                ...
                <h3><p class="title"><a href="under_construction.php"> Exercise (a)</a><br><br>
            <a href="under_construction.php"> Exercise (b)</a><br><br>
            <a href="under_construction.php"> Exercise (c)</a><br><br>
            <a href="under_construction.php"> Exercise (d)</a><br><br>
            <a href="under_construction.php"> Exercise (e)</a></p></h3><div align="right"><br> <a href="about experiment8.php"><INPUT 
                        TYPE=IMAGE 
