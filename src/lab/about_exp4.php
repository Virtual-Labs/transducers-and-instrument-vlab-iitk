...
<a href="/virtuallab/user.php" style="padding-right:0px; text-decoration:none;">Update Profile</a></div><?php } ?>  
	...
	<div id="page-bgbtm">
		...
		<div class="post-bgbtm">
			  ...
			  <div class="entry">
					  <p>Flowmeters  are used in fluid systems (liquid and gas) to indicate the rate of flow of the  fluid. They can also control the rate of flow if they are equipped with a flow  control valve.<br/>
					 Rotameters  are a particular kind of flowmeter, based on the variable area principle.  They provide a simple, precise and economical means of indicating flow rates in  fluid systems.<br/>
					This  variable area principle consists of three basic elements: A uniformly tapered  flow tube, a float, and a measurement scale. A control valve may be added if  flow control is also desired.</p>
					   <p>In operation, the rotameter is  positioned vertically in the fluid system with the smallest diameter end of the  tapered flow tube at the bottom. This is the fluid inlet. The float, typically  spherical, is located inside the flow tube, and is engineered so that its  diameter is nearly identical to the flow tube's inlet diameter. The tube was slightly tapered in bore with the diameter  decreasing downwards; and the fluid flow to be measured passed upwards through  the conical tube, which was inserted in the flow circuit. The floats was  carried upwards by the passage of the fluid until it reached a position in the  tube where its weight was balanced by the force due to the fluid flowing past  it. The displacement of the float in the tube is a measure of the volume rate  of flow and the tube may be calibrated in volume flow units.</p>
			    <div align="center"><img src="images/clip_image002.jpg" alt="" width="213" height="278" /></div><br>
                         <p>The equipment could be thought as an orifice with variable area. Downwards resultant force, consisting the difference between gravitational force and buoyancy force, is constant. Due to this, upward force which is the product of pressure difference and projection area of the float should be constant to equalize with the downward force. Because of the cross-sectional area of the float is constant,pressure difference through the float should also be constant.  </p>
                         
					<strong><font color="#000000"><span class="style5">Procedure :</span></font></strong><br/><br/>
					 <ol>
					 <li> When fluid —gas or liquid — is introduced into the tube,  the float is lifted from its initial position at the inlet, allowing the fluid  to pass between it and the tube wall. </li>
					 <li > The float rises, more and more fluid flows by the float because the tapered tube's  diameter is increasing</li>
					 <li>Ultimately, a point is reached where the flow area is large enough to allow the entire volume of the fluid to flow past the float. This flow area is called the annular passage.The float is now stationary at that level within the tube, as its weight is being supported by the fluid forces which caused it to rise. This position corresponds to a point on the tube's measurement scale and provides an indication of the fluid's flow rate.<p>One  way to change the capacity, or flow range, of a rotameter is to change the  float material, and thus its density, while keeping the flow tube and float  size constant. Floats which are made from less dense materials will rise higher  in the tube and therefore will yield lower flow capacities for the same  diameter flow tube. Floats made from more dense materials will rise less  thereby yielding higher flow capacities.</p><p>Another way to change the capacity is to change the diameter of the flow tube and the size of the float.</p></li>
					 </ol>
					 <div ><strong></strong>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="about experiment5.php"><INPUT 
                        TYPE=IMAGE 
                         SRC="images/back copy.jpg" />
					 </a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="about_exp41.php">
					 <INPUT 
                        TYPE=IMAGE 
