...
<a href="/virtuallab/user.php"<?php echo $fet['User_Email_Id'];?> <style="padding-right:0px; text-decoration:none;">Update Profile</a></div><?php } ?>  
	...
	<div id="page-bgbtm">
		...
		<div class="post-bgbtm">
				...
				<div class="entry">
				<h3 class="style4"><font color="#000000">4.	Other Applications  </font></h3><p>
					 <p> The other applications of thermistors include:<br>
<b>(i)</b>	measurement of power at high frequencies <br>
<b>(ii)</b>	measurement of thermal conductivity <br>
<b>(iii)</b>	measurement of level, flow and pressure of liquids<br> 
<b>(iv)</b>	measurement of composition of gases <br>
<b>(v)</b>	vacuum measurements <br>      
<b>(vi)</b>	providing time delay.<br> 

					
 </p>
			<h3 class="style4"><font color="#000000">Salient Features of Thermistors   </font></h3><p><P><b> 1.</b> Thermistors, are compact, rugged and inexpensive. <br>
<b>2.</b>  Thermistors when properly aged, have good stability. <br>
<b>3.</b> The response time of thermistors can vary from a fraction of a second to minutes, depending on the size of the detecting mass and thermal capacity of the thermistor. It varies inversely with the dissipation factor. The power dissipation factor varies with the degree of thermal isolation of the thermistor element.<br>
<b>4.</b> The upper operating limit of temperature for thermistors is dependent on physical changes in the material or solder used in attaching the electrical connections and is usually 400  or less. The lower temperature limit of temperature is normally determined by the resistance such a high value that it cannot be measured by standard methods.<br> 
<b>5.</b> The measuring current should be maintained to as low a value as possible so that self heating of thermistors is avoided otherwise errors are introduced on account of change of resistance caused by self heating. Where it is not possible to avoid self heating, thermistor stability can be maintained at given temperature by using an auxiliary heating element. The average power dissipation can be effectively reduced and the highest sensitivity retained by energizing the thermistor with pulses of measuring power.<br> 
<b>6.</b> Thermistors can be installed at a distance from their associated measuring circuits if elements of high resistance are used such that the resistance of leads (even though the leads may be very long) is negligible. This way the resistance of leads does not affect the readings and hence errors on this count are negligible. 
The above features give thermistors advantages over conventional thermocouples, resistance thermometers, and filled system thermometer sensing elements for measurement of temperature. </p>
			<br>
<h3 class="style4"><font color="#000000">Thermocouples   </font></h3><p><br>
The operation of thermocouples has been explained here, The emf produced in a thermocouple circuit is given by: <br>
E = a(Dq) + b(Dq)<sup>2</sup><br>
where Dq = difference in temperature between the hot thermocouple junction and the reference junction of the thermocouple; <sup>0</sup>C, 
and	a,b =constants. <br>
 a is usually very large as compared with b and therefore emf thermocouple is <br>
  E ~ a(Dq)<br>
  In a thermocouple temperature measuring circuit, the emf set up is measured by sending current through a moving coil instrument, the deflection being directly proportional to the emf. Since emf is a function of temperature difference Dq , the instrument can be calibrated to read the temperature. The emf may also be measured by a potentiometer.<br>
  Since the themo-electric emf depends upon the difference in temperature between the hot junction and the reference junction, the temperature of the latter should remain absolutely constant in order that the calibration holds good and there are no errors on account of change in ambient temperature. The temperature of the reference junction is controlled for this purpose. The reference junction temperature is usually 0<sup>0</sup>C . Thermocouples are used for measurement of temperature upto 1400<sup>0</sup>C . It should be mentioned here that the combination of metals be so chosen that a rise in temperature should always produce a linear rise in emf i.e. the value of 'b' should be negligible. 
			...
			<div ><strong></strong>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<strong>&nbsp;<a href="about_exppp.php"> <INPUT 
                        TYPE=IMAGE 
                         SRC="images/back copy.jpg" />
	</a></strong>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="about_expppp1.php">
			<INPUT 
                        TYPE=IMAGE 
