...
<a href="user.php" style="padding-right:0px; text-decoration:none;">Update Profile</a></div><?php } ?>  
...
<!-- end #menu -->
	...
	<div id="page-bgbtm">
		...
		<div class="post-bgbtm">
			  ...
			  <div class="entry">
			    <p>Now a days signal processing typical requirements are increased, resulting to employment of digital rather than analog processing, since digital processing has better potentials. Consequently, signal conversion is mandatory, since more often the output signals are analog. Signal conversion requirements continuously increase, in terms of conversion-speed, resolution, accuracy and power dissipation.</p>
              <strong><font color="#000000"><span class="style5">DAC:</span></font></strong><br/> 
        		 <ul>
        		   <li>A Digital to analog converter converts an abstract finite-precision number (usually a fixed-point binary number) into a concrete physical quantity (e.g., a voltage or a pressure).</li> 
        		   <li>A device for converting information in the form of combinations of discrete (usually binary) states or a signal to information in the form of the value or magnitude of some characteristics of a signal, in relation to a standard oreference. Most often, it is a device which has electrical inputs representing a parallel binary number, and an output in the form of voltage or current.</li>
        		   <li>Digital-to-analog (D/A) converters (sometimes called DACs) are used to present the results of digital computation, storage, or transmission, typically for graphical display or for the control of devices that operate with continuously 										varying quantities.</li>
        		   <li>The output of the D/A converter is proportional to the product of the digital input value and the reference. In many applications, the reference is fixed, and the output bears a fixed proportion to the digital input. In other     				applications, the reference, as well as the digital input, can vary; a D/A converter that is used in these applications are thus called a multiplying D/A converter. It is principally used for imparting a digitally controlled scale                    factor, or “gain,” to an analog input signal applied at the reference terminal.</li>
        		   <li>The fundamental circuit of most D/A converters involves a voltage or current reference; a resistive “ladder network” that derives weighted currents or voltages, usually as discrete fractions of the reference; and a set of switches, operated by the digital input, that determines which currents or voltages will be summed to constitute the output.</li> 
       		       </li>
      		   </ul>
			     <strong><font color="#000000"><span class="style5">R-2R DACs :</span></font></strong>&nbsp;&nbsp;R-2R resistor ladder network is a binary linear circuit which has following remarkable features:<br/><br/>
	    	     <p><span class="style8">1.</span> Only two resistance values are used anywhere in the entire circuit. This means that only two values of precision resistance are needed, in a ratio of 2:1. This requirement is easy to meet, and not especially expensive.<br/>
				 <span class="style8">2.</span>	The input resistance seen by each digital input is the same as for every other input. The actual impedance seen by each digital source gate is 3R.<br/>
				 <span class="style8">3.</span>	The circuit is indefinitely extensible for binary numbers. Thus, if we use binary inputs we can simply double the length of the ladder network for an 8-bit number (0 to 255) or double it again for a 16-bit number    (0 to 65535). We only need to add two resistors for each additional binary.</p>
				 <div align="center"><img src="images/N-bit R-2R resistor ladder.bmp" alt="" /><br>
					 <font color="#000000">N-bit R-2R resistor ladder</font></div>
					 <p>DAC using R-2R is actually just a variant of a simple op amp summer circuit, i.e., an operational amplifier configured to output a voltage that is proportional to the sum of the input voltages. </p>
			      <div ><strong></strong>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="about experiment7.php"><INPUT 
                        TYPE=IMAGE 
                         SRC="images/back copy.jpg" />
			      </a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="about_exp16.php">
			      <INPUT 
                        TYPE=IMAGE 
