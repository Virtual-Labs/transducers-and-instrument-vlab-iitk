...
<?php if (isset($_SESSION['user'])) { ?>
	...
	<div id="page-bgbtm">
		...
		<div class="post-bgbtm">
				<h1 class="title"><div align="center"><img src="images/F0006.JPG" alt="" width="355" height="253" /></div> </h1>
				<br>
				<div align="center"><font color="#000000">Figure.3</font></div>
			  <div class="entry"><h3 class="title"> <font color="#000000">Bonded Wire Strain Gauges</font></h3><br><p>
			  The bounded metal-wire strain gauges are used for both stress analysis and for construction of transducers.<br>
A resistance wire strain gauge consists of a grid of fine resistance wire of about 0.025 mm in diameter or less.  The grid is cemented to carrier (base) which may be a thin sheet of paper, a thin sheet of Bakelite or a sheet of Teflon.  The wire is covered on top with a thin sheet of material so as to prevent it from any mechanical damage.  The spreading of wire permits a uniform distribution of stress over the grid.  The carrier is bonded with an adhesive material to the specimen under study.  This permits a good transfer of strain from carrier to gird of wire.  The wires cannot buckle as they are embedded in a matrix of cement and hence faithfully follow both the tensile and compressive strain of the specimen.  Since, the materials and the wire sizes used for bonded wire strain gauges are the same as used for unbounded wire strain gauges, the gauges factors and resistances for both are comparable.<br>
			  <div align="center"><img src="images/f0007.JPG" alt="" width="300" height="361" /></div><br>
			  <div align="center"><font color="#000000">Figure.4</font></div>
			 <p> The size of the strain gauges varies with application.  They can be as small as 3 mm by 3 cm square. Usually they are larger but seldom more than 52 mm long and 12.5 mm wide.<br>
For excellent and reproducible result, it is desirable that the resistance wire strain gauge should have the following characteristics:<br>
<b>(i)</b> The strain gauge should have a high value of gauges factor . A high value of gauge factor indicates a large change in resistance for a particular strain resulting in high sensitivity.<br>
<b>(ii)</b>	The resistance of the strain gauge should be as high as possible since the minimizes the effects of undesirable variations of resistance in the measurement circuit.  Although undesirable, but necessary, are the resistance of connecting leads and terminals, etc.  Typical resistances of strain gauges are 120 ohm, 350 ohm and 1000 ohm .  Although a high resistance value of strain gauges a desirable from the point of view of swamping out the effects of variations of resistance in other parts of the bridge circuit in which they are invariably used but it result in lower sensitivity.<br>   
Thus in orders to get high sensitivity higher bridge voltages have to be used.  The bridge voltage is limited by the maximum current carrying capacity of the wires which is typically 30 mA.<br>
<b>(iii)</b> The strain gauges should have a low resistance temperature co-efficient.  This is essential to minimize errors on account of temperature variations which affect the accuracy of measurements.<br>
<b>(iv)</b>	The strain gauges should not have any hysteresis effects in its response.<br>
<b>(v)</b>	In order to maintain constancy of calibration over the entire range of the strain gauges, it should have linear characteristics i.e., the variations in resistance should be a linear function of the strain.<br>
<b>(vi)</b>	The strain gauges are frequency used for dynamic measurements and their frequency response should be good.  The linearity should be maintained within accuracy limits over the entire frequency range.<br>
The desirable characteristics of resistance wire strain gauges are listed above but no single material is able to satisfy all the properties since they are, many a times, conflicting in nature.  A number of metals and their alloys have been used in making resistance wire strain gauges.  Some popular metals and alloys used for construction of resistance wire strain gauges are listed in Table 25.5 along with their properties.<br>
			 
			 <div ><strong></strong>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="about_exp52.php"><iNPUT 
                        TYPE=IMAGE 
                         SRC="images/back copy.jpg" />
			 </a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="about_exp54.php">
			 <iNPUT 
                        TYPE=IMAGE 
