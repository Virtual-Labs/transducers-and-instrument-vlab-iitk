    ...
    <div id="page-bgbtm">
        ...
        <div class="post-bgbtm">
              ...
              <div class="entry"><h3 class="style4"><font color="#000000">Procedure   </font></h3><br>
                <ul>
                  <li>Log on the virtual lab (Transducer and  Instrumentation).</li>
                  <li>If you are a new user than first  register yourself to the virtual lab.</li>
                  <li>Download the runtime engine.</li>
                  <li>You have a choice for doing a experiment  both in simulated and real time.</li>
                  <li> Now  for simulated one, click on the experiment window, and then went to the  experiment no 10 (To study of speed measurement using photoelectric and  magnetic pickup).</li>
                  <li>Now click the simulated option, and you  are ready to do your experiment.</li>
                  <li>Experiment through ON button.              </li>
                </ul>
                <div align="center"><img src="images/p_s1.jpg" /></div>
               <p> •	Now if you hit speed measurement then there is a tow option-</p>
<p>a)	Photoelectric pickup<br />
b)	Magnetic pickup
</p>
                <div align="center"><img src="images/p_s2.jpg" /></div>
              <p><b>a).</b>	<font color="#000000">	For Photoelectric pickup-</font><br />
•	Select the speed measurement using Photoelectric Pickup experiment.<br />
•	The model contains a Motor whose speed to be measured and the photoelectric pickup is mounted near to the motor shaft.<br />
•	Change the input voltage of motor through the knob. The motor speed will increase by increasing the motor voltage.<br />
•	The motor speed is detected by photoelectric pickup. The emitting light pulses reflect back depending upon the speed of motor.<br />
</p>              
             
<div align="center"><img src="images/p_s4.jpg" /></div>
<p>The graph plot a motor speed against time-</p>
<div align="center"><img src="images/p_s5.jpg" /></div>
<p>The full front panel is given below-</p>
<div align="center"><img src="images/p_s3.jpg" /></div>

<div><a href="about experiment10.php"><INPUT 
                        TYPE=IMAGE 
                         SRC="images/back copy.jpg" /></a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;                     
<a href="p_s2.php"><INPUT 
                        TYPE=IMAGE 
