...
1)What does AC and DC stand for in the electrical field ?</div>
<div class="qselections">
<input type="radio" value="a" name="question1">a)Alternating Current and Direct Current <br>
<input type="radio" value="b" name="question1">b)A Rock Band from Australia <br>
...
<div class="qheader">
2)Which consists of two plates separated by a dielectric and can store a charge?</div>

<div class="qselections">
<input type="radio" value="a" name="question2">a)Inductor  <br>
<input type="radio" value="b" name="question2">b)Capacitor <br>
<input type="radio" value="c" name="question2">c)Transistor <br>
<input type="radio" value="d" name="question2">d)Relay<br>
</div>

<br>

<div class="qheader">
3)Made from a variety of materials, such as carbon, which inhibits the flow of current..?</div>
<div class="qselections">

<input type="radio" value="a" name="question3">a)Choke <br>
<input type="radio" value="b" name="question3">b)Inductor <br>
<input type="radio" value="c" name="question3">c)Resistor <br>
<input type="radio" value="d" name="question3">d)Capacitor.<br>
</div>

<br>

<div class="qheader">
4)The FFT, a mathematical process, is used extensively in digital signal processing (DSP). For what word does the second "F" in FFT stand ?</div>
<div class="qselections">
<input type="radio" value="a" name="question4">a)Fast  <br>
<input type="radio" value="b" name="question4">b)Fourier <br>
<input type="radio" value="c" name="question4">c)Ford  <br>
<input type="radio" value="d" name="question4">d)Footed.<br>
</div>

<br>

<div class="qheader">
5)Which is a type of Electrically-Erasable Programmable Read-Only Memory ?</div>
<div class="qselections">
<input type="radio" value="a" name="question5">a)Flash<br>
<input type="radio" value="b" name="question5">b)Flange <br>
<input type="radio" value="c" name="question5">c)Fury <br>
<input type="radio" value="d" name="question5">d)FRAM<br>
</div>
...
<div class="qheader">
7)Voltage is sometimes referred to as EMF, or Electromotive..?</div>
<div class="qselections">
<input type="radio" value="a" name="question7">a)Field <br>
<input type="radio" value="b" name="question7">b)Factor  <br>
<input type="radio" value="c" name="question7">c)Flash <br>
<input type="radio" value="d" name="question7">d)Force<br>
...
<div class="qheader">
9)When measuring the characteristics of a small-signal amplifier, say for a radio receiver, one might be concerned with its "Noise..." ?</div>
<div class="qselections">
<input type="radio" value="a" name="question9">a)Fundamentals  <br>
<input type="radio" value="b" name="question9">b)Fall <br>
<input type="radio" value="c" name="question9">c)Figure<br>
