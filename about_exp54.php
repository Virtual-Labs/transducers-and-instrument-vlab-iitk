...
<?php if (isset($_SESSION['user'])) { ?>
	...
	<div id="page-bgbtm">
		...
		<div class="post-bgbtm">
				<h1 class="title"><div align="left"><img src="images/f0008.JPG" alt="" width="670" height="430" /></div> 
				</h1><br>
				<div align="center"><font color="#000000"> TABLE: Materials for Strain Gauges</font></div>
				
			  <div class="entry"><h3 class="title"> <font color="#000000">Base (Carrier) Materials</font></h3><br><p>
			  Several type of base or carrier materials are used to support the wires.  Impregnated paper is used for room temperature applications.  The ranges of some of the other materials are:<br>
Epoxy-200°C to 150°C, Bakelite cellulose or fibre glass materials- upto 200°C for continuous operation and 300°C for limited operation.<br>
<br><h3 class="title"> <font color="#000000">Adhesives</font></h3><br><p>The adhesives act as bonding materials. Like other bonding operations, successful strain gauge bonding depends upon careful surface preparation and use of the correct bonding agent.  In order that the strain be faithfully transferred on to the strain gauge, the bond has to be formed between the surface to be strained and the plastic backing material on which the gauge is mounted.  It is important that the adhesive should be suited to this backing; numerous materials are used for backing which require different adhesive materials.  It is usually desirable that the adhesive material should be of quick drying type and also be insensitive to moisture in order to have good adherence.<br>
	Ethylcellucose cement, nitrocellucose cement, Bakelite cement and qpoxy cement are some of the commonly used adhesive materials.  The temperature range up to which they can be used is usually below 175°C.<br>
	<h3 class="title"> <font color="#000000">Leads</font></h3><br><p>The leads should be of such materials which have low and stable resistivity and also a low resistance temperature co-efficient.<br>
	<h3 class="title"> <font color="#000000">Bonded Metal Foil Strain Gauges</font></h3><br><p>This class of strain gauges is only an extension of the bonded metal wire strain gauges. The bounded metal wire strain gauges have been completely superseded by bonded metal foil strain gauges. Metal foil strain gauges use identical or similar materials to wire strain gauges and re used today for most general propose stress analysis application and for many transducers.  Foil type gauges have a much greater heat dissipation capacity as compared with wire wound strain gauges on account of their greater surface area leads to better bonding.<br>
	 <div align="center"> <img src="images/f0009.JPG" alt="" width="279" height="148" /></div><br>
	 <div align="center"><font color="#000000">Figure.5</font></div>
	<p> The sensing element of foil gauges are formed from sheets less than 0.005 mm thick by photo-etching processes, which allow greater flexibility with regard to shape. For example, the three linear grid gauges are designed with fat end turns.  This local increase in area reduces the transverse sensitivity which is a spurious input since the gauge is designed to measure the strain component along the length of grid elements.<br>
For foil type strain gauges, the manufacturing process also easily provides convenient soldering tabs, which are integral to the sensing grid, on all four gauges.</div>
			  <div ><strong></strong>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="about_exp53.php"><iNPUT 
                        TYPE=IMAGE 
                         SRC="images/back copy.jpg" /></a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;<a href="about_exp55.php"><iNPUT 
                        TYPE=IMAGE 
