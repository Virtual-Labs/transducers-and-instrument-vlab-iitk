...
1) If you were a piece of chromatography paper and your chin was a solute after an Experiment, the RF value of your chin would be approximately:
</div>
<div class="qselections">
<input type="radio" value="a" name="question1">a) 0.15<br>
<input type="radio" value="b" name="question1">b) 0.50<br>
<input type="radio" value="c" name="question1">c) 0.85<br>
<input type="radio" value="d" name="question1">d) It's impossible to guess, because you're not sitting in a solvent<br>
<!--<input type="radio" value="e" name="question1">d)e) Moving iron attraction type voltmeter<br>-->
</div>

<br>

<div class="qheader">
2) The difference between dipole-dipole forces and hydrogen bonds are that:</div>
<div class="qselections">
<input type="radio" value="a" name="question2">a) Dipole-dipole forces only exist between no polar molecules<br>
<input type="radio" value="b" name="question2">b) Dipole-dipole forces occur between polar molecules<br>
<input type="radio" value="c" name="question1">c) Dipole-dipole forces are caused by the interaction of partial charges on both molecules.<br>
<input type="radio" value="d" name="question1">d) None of the above is able to distinguish between dipole-dipole forces and hydrogen bonds<br>
<!--<input type="radio" value="e" name="question1">e) In moving iron voltmeter, frequency compensation is achieved by connecting a capacitor across its fixed coil<br>-->
</div>

<br>

<div class="qheader">
3) The vapor pressure of a liquid increases when:</div>
<div class="qselections">
<input type="radio" value="a" name="question3">a) The temperature is raised<br>
<input type="radio" value="b" name="question3">b) The temperature is lowered<br>
<input type="radio" value="c" name="question1">c) The pressure is lowered<br>
...
<div class="qheader">
4) What's the velocity of hydrogen at 298 K: </div>
<div class="qselections">
<input type="radio" value="a" name="question4">a) 1930 m/sec<br>
<input type="radio" value="b" name="question4">b) 2730 m/sec<br>
<input type="radio" value="c" name="question1">c)c)	61.0 m/sec<br>
<input type="radio" value="d" name="question1">d)d)	none of these<br> 
</div>

<br>

<div class="qheader">
5) Why don't hydrogen molecules really move as fast as the calculation in problem 104 would suggest:</div>
<div class="qselections">
<input type="radio" value="a" name="question5">a) Hydrogen molecules experience intermolecular forces<br>
<input type="radio" value="b" name="question5">b) Hydrogen molecules bump into other hydrogen molecules, slowing them down<br>
<input type="radio" value="c" name="question1">c) Hydrogen molecules are a liquid at 298 K<br>
<input type="radio" value="d" name="question1">d) None of these<br>
...
<div class="qheader">
6) The opposite of sublimation is called:</div>
<div class="qselections">
<input type="radio" value="a" name="question6">a) Melting<br>
<input type="radio" value="b" name="question6">b) Condensing<br>
<input type="radio" value="c" name="question6">c) Freezing<br>
<input type="radio" value="d" name="question6">d) none of these<br>
...
<div class="qheader">
7) For which process would the heat be negative:</div>
<div class="qselections">
<input type="radio" value="a" name="question7">a) Changing the temperature of ice water to 50 to 0 degree centigrade. <br>
<input type="radio" value="b" name="question7">b) Condensing steam.<br>
<input type="radio" value="c" name="question7">c) Boiling water<br>
<input type="radio" value="d" name="question7">d) More than one of the above<br>
<!--<input type="radio" value="d" name="question7">d) Comparator<br>-->
...
<div class="qheader">
8) A calorimeter is used to:</div>
<div class="qselections">
<input type="radio" value="a" name="question8">a) Determine the heat of a reaction.<br>
<input type="radio" value="b" name="question8">b) Nitrogen trichloride<br>
<input type="radio" value="c" name="question8">c) Store the heat from a chemical reaction<br>
...
<div class="qheader">
9) Misalignment prevents formation of a true stagnation point at the measuring hole since the velocity is:</div>
<div class="qselections">
<input type="radio" value="a" name="question9">a) Aluminum tri fluoride<br>
<input type="radio" value="b" name="question9">b) Nitrogen tri chloride<br>
<input type="radio" value="c" name="question9">c) Fluorine<br>
<input type="radio" value="d" name="question9">d) Hydrogen sulfide<br>
...
<div class="qheader">
10) An important application of the ………….tube is found in aircraft and missiles:</div>
<div class="qselections">
<input type="radio" value="a" name="question10">a) Pitot static<br>
<input type="radio" value="b" name="question10">b) Pitot non static<br>
<!--<input type="radio" value="c" name="question10">c) Separate two or more compounds based on how strongly they interact with other compounds.<br>
<input type="radio" value="d" name="question10">d) More than one of the above<br>
