...
<!-- end #menu -->
	...
	<div id="page-bgbtm">
		...
		<div class="post-bgbtm">
			  <div class="entry">
			    <ul>
			      <li>	In this circuit, the inputs are binary weighted with respect to each other, with the binary weighting of the inputs achieved by the R-2R ladder resistor network at the non-inverting input of the op-amp.</li>
		        </ul><br/>
				<div align="center"><img src="images/Circuit Diagram for 4 bit R-2R Ladder Network DAC.bmp" alt="" /><br>
					 <font color="#000000">Circuit Diagram for 4 bit R-2R Ladder Network DAC</font></div><br/>
				 <ul>
        		   <li>As its name implies, the R-2R network consists of resistors with only two values, R and 2R (10K and 20K, respectively, in the circuit shown).  The input SN to bit N is '1' if it is connected to a voltage VR and '0' if it is grounded. The output Vo of an R-2R ladder DAC with N bits is:</li></ul><br/>
				   <div align="center"><img src="images/R2Rladderformula1.bmp" alt="" height="42" /></div><br/>
				   Thus, the output Vo of the 4-bit R-2R ladder DAC in Fig 7 is:<br/><br/>
				   <div align="center"><img src="images/R2Rladderformula2.bmp" alt="" height="42" /></div><br/>
			       Where  S3, S2, S1, and S0 are the logic inputs ('1' or '0') for bits 3, 2, 1, and 0, respectively. )<br/>
				   <strong><font color="#000000"><span class="style5">Resolution:</span></font></strong>&nbsp;&nbsp;
				  <ul>
				     <li>The number of bits of this DAC may be increased by connecting more switches with corresponding R/2R resistors.  Since there are two possible states at each input, ground or Vr, (also designated as “0” or “1” in digital lingo for positive logic) there are 2N combinations of Vr and ground to the inputs of an R/2R ladder.</li>
				     <li>The resolution of the ladder is the smallest possible output change for any input change to the ladder.</li> 
			         </li>
		        </ul>
				   <div align="center"><font size="+1" color="#000000">Resolution=1/2N </font></div>
				   Where N is the number of bits.<br/><br/>
                   This is the output change that would occur for a change in the least significant bit.<br/>

       		    <ul><li>For a 10bit R/2R there are 2N or 1024 possible binary combinations at the inputs. The resolution of the network is 1/1024 or .0009766. A change in state at the LSB input should change the output of the ladder by .09766% of the full scale output voltage.</li></ul>
				<strong><font color="#000000"><span class="style5">Accuracy: </span></font></strong>&nbsp;&nbsp;
				<p>The output accuracy of the R/2R ladder is typically specified in terms of full-scale output ± some number of least significant bits. R/2R ladders are usually specified with output accuracies of ±1 LSB or ±1/2 LSB. For example, a ±1/2 LSB specification on a 10 bit ladder is exactly the same as ±0.04883% full-scale accuracy.</p>
 				
			     <div align="right"><a href="about_exp6.php"><INPUT 
                        TYPE=IMAGE 
