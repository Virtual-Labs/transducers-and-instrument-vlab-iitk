...
1)The cartridge from condenser microphone uses?</div>
<div class="qselections">
<input type="radio" value="a" name="question1">a)Basic transduction principle <br>
<input type="radio" value="b" name="question1">b)Basic resistance principle <br>
<!--<input type="radio" value="c" name="question1">c)Average Current and Discharged Capacitor <br>
<input type="radio" value="d" name="question1">d)Atlantic City and District of Columbia.<br>-->
</div>

<br>

<div class="qheader">
2)To control frequency we need?</div>

<div class="qselections">
<input type="radio" value="a" name="question2">a)Amplitude parameter control <br>
<input type="radio" value="b" name="question2">b)Frequency parameter control <br>
<!--<input type="radio" value="c" name="question1">c)Transistor <br>
<input type="radio" value="d" name="question1">d)Relay<br>-->
</div>

<br>

<div class="qheader">
3)What frequency range is the High Frequency band?</div>
<div class="qselections">

<input type="radio" value="a" name="question3">a)100 kHz <br>
<input type="radio" value="b" name="question3">b)1 GHz <br>
<input type="radio" value="c" name="question3">c)30 to 300 MHz  <br>
<input type="radio" value="d" name="question3">d)3 to 30 MHz<br>
</div>

<br>

<div class="qheader">
4)The sampling rate, (how many samples per second are stored) for a CD is.. ?</div>
<div class="qselections">
<input type="radio" value="a" name="question4">a)48.4 kHz  <br>
<input type="radio" value="b" name="question4">b)22,050 Hz <br>
<input type="radio" value="c" name="question4">c)44.1 kHz  <br>
<input type="radio" value="d" name="question4">d)48 kHz<br>
</div>

<br>

<div class="qheader">
5)Which consists of two plates separated by a dielectric and can store a charge?</div>
<div class="qselections">
<input type="radio" value="a" name="question5">a)Inductor<br>
<input type="radio" value="b" name="question5">b)Capacitor <br>
<input type="radio" value="c" name="question5">c)Transistor<br>
<input type="radio" value="d" name="question5">d)Relay<br>
</div>

<br>

<div class="qheader">
6)A given signal's second harmonic is twice the given signal's __________ frequency.. ?</div>
<div class="qselections">
<input type="radio" value="a" name="question6">a)Fourier   <br>
<input type="radio" value="b" name="question6">b)Foundation <br>
<input type="radio" value="c" name="question6">c)Fundamental  <br>
<input type="radio" value="d" name="question6">d)Field.<br>
</div>

<br>

<div class="qheader">
7)What does the term PLC stand for.?</div>
<div class="qselections">
<input type="radio" value="a" name="question7">a)Programmable Lift Computer <br>
<input type="radio" value="b" name="question7">b)Program List Control  <br>
<input type="radio" value="c" name="question7">c)Programmable Logic Controller <br>
<input type="radio" value="d" name="question7">d)Piezo Lamp Connector<br>
...
<div class="qheader">
8)"FET" is a type of transistor, Its full name is ________ Effect Transistor ?</div>
<div class="qselections">
<input type="radio" value="a" name="question8">a)Field<br>
<input type="radio" value="b" name="question8">b)Factor <br>
<input type="radio" value="c" name="question8">c)Flash<br>
<input type="radio" value="d" name="question8">d)Force<br>
...
<div class="qheader">
9)What does AC and DC stand for in the electrical field ?</div>
<div class="qselections">
<input type="radio" value="a" name="question9">a)Alternating Current and Direct Current <br>
<input type="radio" value="b" name="question9">b)A Rock Band from Australia <br>
<input type="radio" value="c" name="question9">c)Average Current and Discharged Capacitor<br>
<input type="radio" value="d" name="question9">d)Atlantic City and District of Columbia<br>
</div>

<br>

<div class="qheader">
10)Discrete time nonperiodic signals have a spectrum which is ?</div>
<div class="qselections">
<input type="radio" value="a" name="question10">a)Continous and periodic in omega <br>
<input type="radio" value="b" name="question10">b)Discrete and periodic in omega <br>
<input type="radio" value="c" name="question10">c)Continous and nonperiodic in omega <br>
<input type="radio" value="d" name="question10">d)Discrete and nonperiodic in omega <br>
</div>
