...
1) The ability of a conductor to produce induced voltage when the current varies ?</div>
<div class="qselections">
<input type="radio" value="a" name="question1">a) Inductance<br>
<input type="radio" value="b" name="question1">b) Capacitance<br>
...
<div class="qheader">
2) The ratio of reactance to resistance frequency dependent ?</div>

<div class="qselections">
<input type="radio" value="a" name="question2">a) Dissipation factor<br>
<input type="radio" value="b" name="question2">b) Quality factor of bridge<br>
...
<div class="qheader">
3) A ............ measure resistance indirectly by comparision with a similar resistance ?</div>
<div class="qselections">

<input type="radio" value="a" name="question3">a) Bridge<br>
<input type="radio" value="b" name="question3">b) Sensor<br>
<!--<input type="radio" value="c" name="question1">c) A jungle refers to the thickest area of a rain forest<br>
<input type="radio" value="d" name="question1">d) A jungle and a rain forest each contain their own group of distinct plants and animals.<br>-->
</div>
...
<div class="qheader">
4) The ratio of the maximum expected change in the output voltage to the excitation voltage ?</div>
<div class="qselections">
<input type="radio" value="a" name="question4">a) The sensitivity of bridge<br>

<input type="radio" value="b" name="question4">b) Coercivity<br>
<!--<input type="radio" value="c" name="question1">c) A jungle refers to the thickest area of a rain forest<br>
<input type="radio" value="d" name="question1">d) A jungle and a rain forest each contain their own group of distinct plants and animals.<br>-->
</div>
...
<div class="qheader">
5) The bridge which is most suited for temperature sensing using RTDs or thermistors ?</div>
<div class="qselections">
<input type="radio" value="a" name="question5">a) The single element varrying bridge<br>
<input type="radio" value="b" name="question5">b) The three element varrying bridge<br>
...
<div class="qheader">
6) The output of a single element varying bridge may be amplified by a ......... OP-amp connected in the inverting mode ?</div>
<div class="qselections">
<input type="radio" value="a" name="question6">a) Single precision <br>
<input type="radio" value="b" name="question6">b) double precision<br>
<!--<input type="radio" value="c" name="question1">c) A jungle refers to the thickest area of a rain forest<br>
<input type="radio" value="d" name="question1">d) A jungle and a rain forest each contain their own group of distinct plants and animals.<br>-->
</div>
...
<div class="qheader">
7) The transformer is built with the coil of wire wound arround the common core each coil is sometimes also called a ?</div>
<div class="qselections">
<input type="radio" value="a" name="question7">a) Winding<br>
<input type="radio" value="b" name="question7">b) Primary Winding<br>
<!--<input type="radio" value="c" name="question1">c) A jungle refers to the thickest area of a rain forest<br>
<input type="radio" value="d" name="question1">d) A jungle and a rain forest each contain their own group of distinct plants and animals.<br>-->
...
<div class="qheader">
8)   A ......... has the property of being able to conduct electrical current in the direction through itself,but not in the opposite direction ?</div>
<div class="qselections">
<input type="radio" value="a" name="question8">a) A semiconductor diode<br>

<input type="radio" value="b" name="question8">b) Transistor<br>
<!--<input type="radio" value="c" name="question1">c) A jungle refers to the thickest area of a rain forest<br>
<input type="radio" value="d" name="question1">d) A jungle and a rain forest each contain their own group of distinct plants and animals.<br>-->
...
<div class="qheader">
9) Work done per unit time ?</div>
<div class="qselections">
<input type="radio" value="a" name="question9">a) Power<br>
<input type="radio" value="b" name="question9">b) Energy<br>
<!--<input type="radio" value="c" name="question1">c) A jungle refers to the thickest area of a rain forest<br>
<input type="radio" value="d" name="question1">d) A jungle and a rain forest each contain their own group of distinct plants and animals.<br>-->
</div>
...
<div class="qheader">
10) Current direction indicate the direction of flow of ?</div>
<div class="qselections">
<input type="radio" value="a" name="question10">a) Negative charge<br>
<input type="radio" value="b" name="question10">b) Positive charge<br>
