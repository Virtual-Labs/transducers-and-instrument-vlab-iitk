...
1)Devices used to measure physical variable are called ?</div>
<div class="qselections">
<input type="radio" value="a" name="question1">a)Sensors<br>
<input type="radio" value="b" name="question1">b)Tachometers<br>
...
<div class="qheader">
2)A device that measures a physical quantity and converts it into a signal which can be read by an observer or by an instrument ?</div>

<div class="qselections">
<input type="radio" value="a" name="question2">a)Actuator<br>
<input type="radio" value="b" name="question2">b)Sensors<br>
...
<div class="qheader">
3)The best known bridge circuit is ?</div>
<div class="qselections">

<input type="radio" value="a" name="question3">a)Wein bridge <br>
<input type="radio" value="b" name="question3">b)Wheatstone bridge<br>
<!--<input type="radio" value="c" name="question1">c) A jungle refers to the thickest area of a rain forest<br>
<input type="radio" value="d" name="question1">d) A jungle and a rain forest each contain their own group of distinct plants and animals.<br>-->
</div>
...
<div class="qheader">
4)An electronic circuit in which circuit branches are bridged by a third branch connected between the first two branches at some intermediate point along them ?</div>
<div class="qselections">
<input type="radio" value="a" name="question4">a)Bridge circuit<br>

<input type="radio" value="b" name="question4">b)Resonance circuit<br>
<!--<input type="radio" value="c" name="question1">c) A jungle refers to the thickest area of a rain forest<br>
<input type="radio" value="d" name="question1">d) A jungle and a rain forest each contain their own group of distinct plants and animals.<br>-->
</div>
...
<input type="radio" value="b" name="question5">b)Actuators<br>
...
<div class="qheader">
6)A bridge circuit used for measuring unknown capacitance by balancing the load if its four arm, one of which contain the unknown capacitance ?</div>
<div class="qselections">
<input type="radio" value="a" name="question6">a)Wheatstone bridge <br>
<input type="radio" value="b" name="question6">b)Wein bridge<br>
<!--<input type="radio" value="c" name="question1">c) A jungle refers to the thickest area of a rain forest<br>
<input type="radio" value="d" name="question1">d) A jungle and a rain forest each contain their own group of distinct plants and animals.<br>-->
</div>
...
<div class="qheader">
7)The ability of dielectric to store electrical charge per unit voltage ?</div>
<div class="qselections">
<input type="radio" value="a" name="question7">a)Capacitance <br>
...
<div class="qheader">
8)The transformer is built with the coil of wire wound around the common core each coil is sometimes also called a?</div>
<div class="qselections">
<input type="radio" value="a" name="question8">a)Secondary winding <br>
<input type="radio" value="b" name="question8">b)Primary winding<br>
<!--<input type="radio" value="c" name="question1">c) A jungle refers to the thickest area of a rain forest<br>
<input type="radio" value="d" name="question1">d) A jungle and a rain forest each contain their own group of distinct plants and animals.<br>-->
...
<div class="qheader">
9)The ability of a conductor to produce induced voltage when the current varies ?</div>
<div class="qselections">
<input type="radio" value="a" name="question9">a)Inductance<br>
<input type="radio" value="b" name="question9">b)Capacitance<br>
<!--<input type="radio" value="c" name="question1">c) A jungle refers to the thickest area of a rain forest<br>
<input type="radio" value="d" name="question1">d) A jungle and a rain forest each contain their own group of distinct plants and animals.<br>-->
</div>
...
<div class="qheader">
10)The ratio of reactance to resistance frequency dependent ?</div>
<div class="qselections">
<input type="radio" value="a" name="question10">a)Dissipation factor<br>
<input type="radio" value="b" name="question10">b)Quality factor of the bridge<br>
