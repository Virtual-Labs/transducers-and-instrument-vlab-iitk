...
<?php if (isset($_SESSION['user'])) { ?>
	...
	<div id="page-bgbtm">
		...
		<div class="post-bgbtm">
				<h1 class="title"><div align="center"><img src="images/f12.JPG" alt="" width="423" height="253" /></div></h1><br>
				<div align="center"><font color="#000000">Lissajous figure: same frequency, zero degrees phase shift</font></div><br>
				
				
			  <div class="entry">
			    <p>If the two AC voltages are not in phase with each other, a straight line will not be formed. Rather, the Lissajous figure will take on the appearance of an oval, becoming perfectly circular if the phase shift is exactly 90 degrees between the two signals, and if their amplitudes are equal: (Figure below).</p>
					 <p><div align="center"><img src="images/f13.JPG" alt="" width="423" height="253" /></div><br>
					 <div align="center"><font color="#000000">Lissajous figure: same frequency, 90 or 270 degrees phase shift</font></div><br>
					   <p>Finally, if the two AC signals are directly opposing one another in phase (180 degrees shift), we will end up with a line again, only this time it will be oriented in the opposite direction: (Figure below)
					   <p><div align="center"><img src="images/f14.JPG" alt="" width="423" height="253" /></div><br>
					   <div align="center"><font color="#000000">Lissajous figure: same frequency, 180 degrees phase shift</font></div><br>
					  <p> When we are faced with signal frequencies that are not the same, Lissajous figures get quite a bit more complex. Consider the following examples and their given vertical/horizontal frequency ratios:
		        
					   <h3 class="style4">&nbsp;</h3>
			<div ><strong></strong>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="about_exp32.php"><INPUT 
                        TYPE=IMAGE 
                         SRC="images/back copy.jpg" />
			</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="about_exp34.php">
			<INPUT 
                        TYPE=IMAGE 
