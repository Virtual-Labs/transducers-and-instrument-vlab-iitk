...
1)Power spectrum of the signal is calculated with ?</div>
<div class="qselections">
<input type="radio" value="a" name="question1">a) TFT<br>
<input type="radio" value="b" name="question1">b) FFT<br>
...
<div class="qheader">
2) The cartridge from condensor microphone uses ?<</div>

<div class="qselections">
<input type="radio" value="a" name="question2">a) Basic transduction priciples<br>
<input type="radio" value="b" name="question2">b) Basic resistance priciples<br>
...
<div class="qheader">
3) Which can work with higher frequency ?</div>
<div class="qselections">

<input type="radio" value="a" name="question3">a) Analog<br>
<input type="radio" value="b" name="question3">b) Digital<br>
<!--<input type="radio" value="c" name="question1">c) A jungle refers to the thickest area of a rain forest<br>
<input type="radio" value="d" name="question1">d) A jungle and a rain forest each contain their own group of distinct plants and animals.<br>-->
</div>
...
<div class="qheader">
4) Optical analyzer can be used to measure the output of ?</div>
<div class="qselections">
<input type="radio" value="a" name="question4">a) Resistance<br>

<input type="radio" value="b" name="question4">b) Light-emitting devices<br>
<!--<input type="radio" value="c" name="question1">c) A jungle refers to the thickest area of a rain forest<br>
<input type="radio" value="d" name="question1">d) A jungle and a rain forest each contain their own group of distinct plants and animals.<br>-->
</div>
...
<div class="qheader">
5) Using LabVIEW analysis function we can generate ?</div>
<div class="qselections">
<input type="radio" value="a" name="question5">a) Step, Tone , Ramp, etc.<br>
<input type="radio" value="b" name="question5">b) None<br>
