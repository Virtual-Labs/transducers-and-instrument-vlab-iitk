...
<?php if (isset($_SESSION['user'])) { ?>
    <div id="date" align="right"><font color="#009933">Logged as:&nbsp;&nbsp; <?php echo $_SESSION['user']; ?></font>
	...
	<div id="page-bgbtm">
		...
		<div class="post-bgbtm">
			  ...
			  <div class="entry">
			    <p>The gauge factor can be written as:<br>
			    <div align="center"><img src="images/f0002.JPG" alt="" width="121" height="42" /></div><br>
			    <div align="center"><img src="images/f0003.JPG" alt="" width="193" height="42" /></div><br>
				The strain is usually expressed in terms of microstrain.  1 microstrain = 1 micro m/m.
If the change in the value of resistivity of a material when strained is neglected, the gauge factor is:<br><p>
<div align="center"><img src="images/f0004.JPG" alt="" width="84" height="26" /></div>
<br><p>The above equation is valid only when Piezoresistive Effect i.e.  change in resistivity due to strain is almost negligible.<br>
The Poisson’s ratio for all metals is between 0 and 0.5, This gives a gauge factor of approximately,<br>
 The common value for Poisson’s ratio for wires is 0.3.  This gives of 1.6 for wire 
      wound strain gauges.<br><br>
      <div align="center"><img src="images/f0005.JPG" alt="" />
	 <font color="#000000"> TABLE: Gauge factors</font></div>

<h3 class="title"> <font color="#000000">Type of Strain gauges</font></h3><br><p>

The following are the major types of strain gauges:<br>
<b>1.</b>	Unbonded metal strain gauges<br>
<b>2.</b>	Bonded metal wire strain gauges<br>
<b>3.</b>	Bonded metal foil strain gauges<br>
<b>4.</b>	Vacuum deposit thin metal film strain gauges<br>
<b>5.</b>	Sputter deposit thin metal strain gauges<br>
<b>6.</b>	Bonded semiconductor strain gauges<br>
<b>7.</b>	Diffused metal strain gauges.<br>
Strain gauges are broadly used for two major types of applications and they are:<br>
<b>(i)</b>	experimental stress analysis of machines and structures,
     and <b>(ii)</b> construction of force, torque, pressure, flow and acceleration transducers.<br>
<h3 class="title"> <font color="#000000">Unbonded Metal Strain Gauges</font></h3><br><p>
This gauges consists of a wire stretched between two points in an insulating medium such as air.  The wires may be made of various copper nickel, chrome nickel or nickel iron alloys.  They are about 0.003 mm in diameter have a gauge factor of 2 to 4 and sustain a force of 2 mN.  The length of wire is 25 mm or less.<br>
The flexture element is connected via a rod a diaphragm which is used for sensing of pressure.  The wires are tensioned to avoid buckling when they experience a compressive force.<br>
The unbounded metal wire gauges, used almost exclusively in transducer applications, employ preloaded resistance wires connected in a wheatstone bridge. At initial preload, the strains and resistances of the four arms are nominally equal, with the result the output voltage of the bridge   Application of pressure produces a small displacement which is about 0.004 mm (full scale), the displacement increases tension in two wires and decreases it in the other two, thereby increase the resistance of two wires which are in tension and decreasing the resistance of the remaining two wires.  This causes an unbalance of the bridge producing an output voltage which is proportional to the input displacement and hence to the applied pressure.<br>
Electric resistance of each arm is 120 ohm to 1000 ohm the input voltage to the bridge is 5 to 10 V, and the full scale output of the bridge is typically about 20 mV to 50 m V.





<div ><strong></strong>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="about_exp51.php"><iNPUT 
                        TYPE=IMAGE 
                         SRC="images/back copy.jpg" />
</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="about_exp53.php">
<iNPUT 
                        TYPE=IMAGE 
