...
<?php if (isset($_SESSION['user'])) { ?>
	...
	<div id="page-bgbtm">
		...
		<div class="post-bgbtm">
			  ...
			  <div class="entry">
			    <p>It is interesting to consider the patterns that appear on the screen of a CRT when sinusoidal voltages are simultaneously applied to horizontal and vertical plates. These patterns are called lissajous patterns. When two sinusoidal voltages of equal frequency which are in phase with each other are applied to the horizontal and vertical deflection plates, the pattern appearing on the screen is a straight line. Thus when two equal voltages of equal frequency but with 90 degrees phase displacement are applied to a CRO, the trace on the screen is a circle. When two equal voltages of equal frequency but with phase shift (fi) are applied to a CRO we obtain an ellipse. An ellipse is also obtained when unequal voltages of same frequency are applied to the CRO.</p>
					 <p><div align="center"><img src="images/phase.JPG" alt="" width="260" height="211" /></div>
					 <br>
					 <div align="center"></div>
					 <br>
					   <p> When two sinusoidal voltages of same frequency are applied:<br>
<b>(i)</b>	A straight line results when two voltages are equal and either in phase with each other or 180 degrees out of phase with each other. The angle formed with the horizontal is 45 when the magnitudes of voltages are equal. An increase in the vertical deflection voltages causes the line to have an angle greater than 45 degrees with the horizontal. On the other hand a greater horizontal voltage makes the angle less than 45 degrees with the horizontal.<br>
<b>(ii)</b>	Two sinusoidal waveforms of the same frequency produce a lissajous pattern, which may be a straight line a circle or an ellipse depending on the phase and magnitude of the voltages.<br>
<b>(iii)</b> A circle can be formed only when the magnitudes of two signals are equal and the phase difference between them is 90 or 270 degrees. However if two voltages are not equal and/or out of phase an ellipse is formed. If the Y voltage is larger, an ellipse with vertical major axis is formed while if the X plate voltage has a greater magnitude, the major axis of the ellipse lies along the horizontal axis.<br>
<b>(iv)</b>	For equal voltages of same frequency progressive variation of phase voltage causes the pattern to vary from a straight diagonal line to ellipses of different eccentricities and then to a circle, after that through another series of ellipses and finally a diagonal straight line again.<br>
Regardless of the two amplitudes of the applied voltages the ellipse provides a simple means of finding phase difference between two voltages. The sine of the phase angle between the voltages is given by:<br>
<div align="center"><img src="images/pha.JPG" alt="" /></div><br>
<p><div align="center"><img src="images/phas.JPG" alt="" width="357" height="360" /></div>
<br><p>

<h3 class="style4">&nbsp;</h3>
			<div ><strong></strong>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="about_exp34.php"><INPUT 
                        TYPE=IMAGE 
                         SRC="images/back copy.jpg" />
			</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="about_exp36.php">
			<INPUT 
                        TYPE=IMAGE 
