...
<script src="strainguagequiz5.js">
</script>
...
1) The RTDs use the principle of change of resistance with temperature. The properties of a conductor material to be used as an element of an RTD should possess the following properties ?</div>
<div class="qselections">
<input type="radio" value="a" name="question1">a) the change in resistance per unit change in temperature should be as small as possible <br>
<input type="radio" value="b" name="question1">b) the resistance of the materials should not have a continuous and stable relationship with temperature <br>
<input type="radio" value="c" name="question1">c) the change of resistance with temperature should not be linear function <br>
<input type="radio" value="d" name="question1">d) none of the above <br>
<!--<input type="radio" value="e" name="question1">d)  <br>-->
</div>

<br>

<div class="qheader">
2) Platinum is the commonly used metal for RTDs. This is because ?</div>
<div class="qselections">
<input type="radio" value="a" name="question2">a) Platinum has a constant value of resistance temperature co-efficient of for a temperature range between 0 to <br>
<input type="radio" value="b" name="question2">b) the resistivity of platinum tends to increase less rapidly at higher temperatures <br>
<input type="radio" value="c" name="question1">c) platinum is available in pure form for commercial applications and has a stability over higher ranges of temperature <br>
...
<div class="qheader">
3) Murphy's Law was originally coined in response to ?</div>
<div class="qselections">
<input type="radio" value="a" name="question3">a) a set of gauges being incorrectly wired into a Wheatstone bridge<br>
<input type="radio" value="b" name="question3">b) a set of gauges being correctly wired into a Wheatstone bridge<br>
<input type="radio" value="c" name="question1">c) both of these<br>
...
<div class="qheader">
4) Most strain gauges are made from a ?</div>
<div class="qselections">
<input type="radio" value="a" name="question4">a) Constantan alloy<br>
<input type="radio" value="b" name="question4">b) Karma alloys<br>
<input type="radio" value="c" name="question1">c) Both of these<br>
<input type="radio" value="d" name="question1">d) None of these<br>
</div>
...
<div class="qheader">
5) For measurements of small strain, semiconductor strain gauges, so called ?</div>
<div class="qselections">
<input type="radio" value="a" name="question5">a) Piezoresistors<br>
<input type="radio" value="b" name="question5">b) Piezocrystals<br>
<input type="radio" value="c" name="question1">c) Both of these<br>
<input type="radio" value="d" name="question1">d) None of these<br>
...
<div class="qheader">
6) Fiber optic sensing can be employed to measure strain along an ?</div>
<div class="qselections">
<input type="radio" value="a" name="question6">a) optical fiber<br>
<input type="radio" value="b" name="question6">b) sensor<br>
<input type="radio" value="c" name="question6">c) both of these<br>
...
<div class="qheader">
7) TCGF  is the change of sensitivity of the device to strain with change in ?</div>
<div class="qselections">
<input type="radio" value="a" name="question7">a) Temperature<br>
<input type="radio" value="b" name="question7">b) Resistance<br>
<input type="radio" value="c" name="question7">c) Capacitance<br>
<input type="radio" value="d" name="question7">d) Strain<br>
...
<div class="qheader">
8) A semiconductor gauge usually has a ?</div>
<div class="qselections">
<input type="radio" value="a" name="question8">a) Small gage factor than a foil gauge<br>
<input type="radio" value="b" name="question8">b) larger gage factor than a foil gauge<br>
<input type="radio" value="c" name="question8">c) Equal gage factor to foil gauge<br>
...
<div class="qheader">
9) Mechanical properties of fiber-reinforced plastics are directionally ?</div>
<div class="qselections">
<input type="radio" value="a" name="question9">a) dependent<br>
<input type="radio" value="b" name="question9">b) independent<br>
<input type="radio" value="c" name="question9">c) partially dependent<br>
<!--<input type="radio" value="d" name="question9">d) a kWh meter<br>
...
<div class="qheader">
10) The theoretical approach of Hooke’s Law ?</div>
<div class="qselections">
<input type="radio" value="a" name="question10">a) can be applied anymore with fiber-reinforced plastics<br>
<input type="radio" value="b" name="question10">b) cannot be applied anymore with fiber-reinforced plastics<br>
<input type="radio" value="c" name="question10">c) none of these<br>
<!--<input type="radio" value="d" name="question10">d) 5000 ohms<br>
