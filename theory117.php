...
//  End -->
    ...
    <td width="128">&nbsp;</td>
    <td width="169" align="right"><a href="" style="padding-left:04px;"><script src="http://connect.facebook.net/en_US/all.js#xfbml=1"></script><fb:like href="http://202.3.77.143/virtuallab" send="false" width="275" show_faces="false" colorscheme="dark" font="arial"></fb:like>
 </a></td><td width="" align="right"><a href="http://www.twitter.com/TI_Virtuallab" target="_blank"><img src="http://twitter-badges.s3.amazonaws.com/twitter-a.png" alt="Follow TI_Virtuallab on Twitter"/></a></td>
  </tr>
  </table>
</div>
...
<?php if (isset($_SESSION['user'])) { ?>
    ...
    <a href="logout.php" style="padding-right:10px;">Logout</a><a href="user.php">Update Profile</a> 
    </div>
    <?php } ?>  
	...
	<div id="page-bgbtm">
		<div id="content">
			...
			<div class="entry">
			<strong><font color="#000000"><span class="style5">Basic ideal operation :</span></font></strong><br/><br/><br />
<div align="center"><img src="images/Ideally sampled signal.bmp" alt=""/><br/><font color="#000000">Ideally sampled signal</font></div><br/>
			<p>DACs are often used to convert finite-precision time series data to a continually varying physical signal. A typical DAC converts the abstract numbers into a concrete sequence of impulses that are then processed by a reconstruction filter usingsome form of interpolation to fill in data between the impulses. 
By the Nyquist–Shannon sampling theorem, sampled data can be reconstructed perfectly provided that its bandwidth meets certain requirements (e.g., a base band signal with bandwidth less than the Nyquist frequency; BUT requires an infinite number of samples. The finite number used in real life cause other problems especially with the D/A reconstruction of the original signal. However, even with an ideal reconstruction filter, digital sampling introduces quantization error that makes perfect reconstruction practically impossible. Increasing the digital resolution can reduce this error.</p>
			<strong><font color="#000000"><span class="style5">Practical operation :</span></font></strong><br/><br/><br /> 
			<p>Instead of impulses, usually the sequence of numbers updates the analogue voltage at uniform sampling intervals. These numbers are written to the DAC, typically with a clock signal that causes each number to be latched in sequence, at which time the DAC output voltage changes rapidly from the previous value to the value represented by the currently latched number. The effect of this is that the output voltage is held in time at the current value until the next input number is latched resulting in a piecewise constant or 'staircase' shaped output. This is equivalent to a zero-order hold operation and has an effect on the frequency response of the reconstructed signal.</p>  
			<div align="center"><img src="images/Piecewise constant output of a conventional practical DAC.bmp" alt=""/><br/><font color="#000000">Piecewise constant output of a conventional practical DAC</font></div><br/>
			<p>The fact that practical DACs output a sequence of piecewise constant values or rectangular pulses causes multiple harmonics above the Nyquist frequency. However, these are typically removed with a low pass filter acting as a reconstruction filter.<br/>
			<div ><strong></strong>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="theory17.php"><INPUT 
                        TYPE=IMAGE 
                         SRC="images/back copy.jpg" />
			</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="theory1117.php">
			<INPUT 
                        TYPE=IMAGE 
                         SRC="images/nect copy.jpg" /></a></div>
				
				 <!-- &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<img src="images/wien.JPG" alt="" width="390" height="244" /><br><p>Measure frequency of the voltage source using series
RC in one arm and parallel RC in the adjoining arm</p><p>At balance point:             Z2 = Z1 Z4 Y3 </p>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<img src="images/for9.JPG" alt="" width="490" height="66" /><br><br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<img src="images/for10.JPG" alt="" width="363" height="81" /><br><p>which expands to</p>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<img src="images/for11.JPG" alt="" width="424" height="81" /><br><p> then</p>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<img src="images/for12.JPG" alt="" width="188" height="76" /><br>-->




				
				<!--<p>Separation of the real and imaginary terms yields:</p>
				  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<img src="images/for7.JPG" alt="" width="128" height="66" /><br><p>and</p>
				  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<img src="images/for8.JPG" alt="" width="132" height="48" /><br><p>Frequency independent<br>
Suitable for Medium Q coil (1-10), impractical for high Q coil: since    will be very large.</p>-->

				<!--In the Schering Bridge above, the resistance values of resistors R1 and R2 are known, while the resistance value of resistor R3 is unknown.  The capacitance values of C1 and C2 are also known, while the capacitance of C3 is the value being measured.  To measure R3 and C3, the values of C2 and R2 are fixed, while the values of R1 and C1 are adjusted until the current through the ammeter between points A and B becomes zero.  This happens when the voltages at points A and B are equal, in which case the bridge is said to be 'balanced'. <br> 
When the bridge is balanced, Z1/C2 = R2/Z3, where Z1 is the impedance of R1 in parallel with C1 and Z3 is the impedance of R3 in series with C3. In an AC circuit that has a capacitor, the capacitor contributes a capacitive reactance to the impedance. The capacitive reactance of a capacitor C is 1/2πfC.<br> 
   
As such, Z1 = R1/[2πfC1((1/2πfC1) + R1)] = R1/(1 + 2πfC1R1) while Z3 = 1/2πfC3 + R3.  Thus, when the bridge is balanced: <br> 
2πfC2R1/(1+2πfC1R1) = R2/(1/2πfC3 + R3); or<br> 
2πfC2(1/2πfC3 + R3) = (R2/R1)(1+2πfC1R1); or<br> 
C2/C3 + 2πfC2R3 = R2/R1 + 2πfC1R2.<br> 
    
When the bridge is balanced, the negative and positive reactive components are equal and cancel out, so<br> 
2πfC2R3 = 2πfC1R2 or <br> 
R3 = C1R2 / C2.<br> 
Similarly, when the bridge is balanced, the purely resistive components are equal, so<br> 
C2/C3 = R2/R1 or<br> 
C3 = R1C2 / R2. <br>     
Note that the balancing of a Schering Bridge is independent of frequency.</p><br>-->

				<!--<h3 class="style4"><font color="#000000">The Hay Bridge </font></h3><p>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp;<img src="images/bridge15.bmp" alt="" /></p><br>
				<p>As shown in the Figure above, one arm of the Hay bridge consists of a capacitor in series with a resistor (C1 and R2) and another arm consists of an inductor L1 in series with a resistor (L1 and R4).  The other two arms simply contain a resistor each (R1 and R3).  The values of R1and R3 are known, and R2 and C1 are both adjustable. The unknown values are those of L1 and R4. </p>
				<p>&nbsp;</p><p>
					 -->
