...
<?php if (isset($_SESSION['user'])) { ?>
	...
	<div id="page-bgbtm">
		...
		<div class="post-bgbtm">
				...
				<div class="entry">
					 <p>Study of Speed measurement using Photoelectric and magnetic pick-up.</p><p>                     
					 <!--<h3 class="style4"><font color="#000000">Apparatus Used</font>  </h3></p>
					 <p>  Personal computer.
Lab view 2009 runtime engine.
Internet facility for performing(on-line experiment)
For(off-line experiment) executable file of to experiment can be
downloaded through the download link given on the website.
</p>-->
					 <h4 class="style4">&nbsp;</h4>
					 <p>
				</div>
	...
	<div class="post-bgbtm">
				...
				<div class="entry">
					...
					<p>2. Lab view 2009 runtime engine. </p>
					    <P>3.Internet facility for performing(on-line experiment)
For(off-line experiment) executable file of to experiment can be
downloaded through the download link given on the website.
</P> 
		</P></div>
