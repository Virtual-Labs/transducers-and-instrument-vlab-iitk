...
<?php if (isset($_SESSION['user'])) { ?>
	...
	<div id="page-bgbtm">
		...
		<div class="post-bgbtm">
			  ...
			  <div class="entry"><h3 class="style4"><font color="#000000">Wien Bridge </font></h3><br>
				  <div align="center"><img src="images/wien.bmp" alt="" width="390" height="244" /></div><br>
				  <p>Measure frequency of the voltage source using series<br>
RC in one arm and parallel RC in the adjoining arm</p><p>At balance point:             Z2 = Z1 Z4 Y3 </p>
<div align="center"><img src="images/acdcformula7.bmp" alt="" width="490" height="66" /></div><br>
<div align="center"><img src="images/acdcformula8.bmp" alt="" width="363" height="81" /></div><br>
...
                  <p>&nbsp;</p>                                                                                                                                                                                         
<div align="right"><a href="about_exp2.php"><INPUT 
                        TYPE=IMAGE 
