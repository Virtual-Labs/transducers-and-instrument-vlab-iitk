...
<?php if (isset($_SESSION['user'])) { ?>
	...
	<div id="page-bgbtm">
		...
		<div class="post-bgbtm">
			  ...
			  <div class="entry"><h3 class="style4">&nbsp;</h3>
			  <br><p><strong>e)</strong> When water level reaches at low a message will display. Press OK again.<br />
			    <p align="center"><img width="269" height="227" src="images/procedure19_clip_image002.jpg" /></p>
			    <p><strong>f)</strong> According to change in water level in the beaker a graph will generate between  voltage and water level.</p>
			    <p align="center"><img width="296" height="170" src="images/procedure19_clip_image002_0000.jpg" /></p>
			    <p align="center"><strong>g)</strong> The another graph is showing the Actual versus Measured level according  to Analog Scale and   Digital Meter.  </p>
			    <p align="center"><img width="299" height="217" src="images/procedure19_clip_image002_0001.jpg" /></p>
			    <p ><strong>h)</strong> Switch OFF the supply to STOP the Experiment</p>
			    <p align="center"><img width="108" height="57" src="images/procedure19_clip_image002_0002.jpg" /></p><br />
		        </p>
			    <p>&nbsp;</p>
                  <p align="center"><br>
                </p>
			  ...
			  </div><div ><strong></strong>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="procedure18.php"><strong><INPUT 
                        TYPE=IMAGE 
                         SRC="images/back copy.jpg" />
			     </strong></a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="procedure20.php"><strong>
			     <INPUT 
                        TYPE=IMAGE 
