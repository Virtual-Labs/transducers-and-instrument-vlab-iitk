...
1)A sinusoidal waveform as seen on an oscilloscope has peak to peak amplitude of 6 cm.  If the vertical sensitivity setting is 5V/cm the pat to peak and rms values are ?</div>
<div class="qselections">
<input type="radio" value="a" name="question1">a)30,212<br>
<input type="radio" value="b" name="question1">b)5, 3.54<br>
<input type="radio" value="c" name="question1">c)21.2,30<br>
<input type="radio" value="d" name="question1">d)15,10.61<br>
</div>

<br>

<div class="qheader">
2)In modern electronic multimeter, a FET or MOSFET is preferred over BJT because?</div>
<div class="qselections">
<input type="radio" value="a" name="question2">a)its input resistance is high<br>
<input type="radio" value="b" name="question2">b)its input resistance is high and does not changes with range switch<br>
<input type="radio" value="c" name="question1">c)its input resistance is low<br>
<input type="radio" value="d" name="question1">d)it is cheaper<br>
</div>

<br>

<div class="qheader">
3). Two helical springs are used in a D' Arsonval meter movement because?</div>
<div class="qselections">

<input type="radio" value="a" name="question3">a)Its improves damping <br>
<input type="radio" value="b" name="question3">b)it compensates for temperature changes<br>
<input type="radio" value="c" name="question1">c)it controls the deflecting torque effectively<br>
<input type="radio" value="d" name="question1">d)it improves torque-weight ratio<br>
</div>

<br>

<div class="qheader">
4)A moving waveform on an oscilloscope can be made stationary by adjusting ?</div>
<div class="qselections">
<input type="radio" value="a" name="question4">a)horizontal position control<br>
<input type="radio" value="b" name="question4">b)coarse frequency control<br>
<input type="radio" value="c" name="question1">c)sync-amplitude control<br>
<input type="radio" value="d" name="question1">d)vertical positioning control.<br>
</div>

<br>

<div class="qheader">
5)Reed frequency meter is essentially a?</div>
<div class="qselections">
<input type="radio" value="a" name="question5">a)recording system<br>
<input type="radio" value="b" name="question5">b)deflection measuring system<br>
<input type="radio" value="c" name="question1">c)vibration measuring system<br>
<input type="radio" value="d" name="question1">d)oscillatory measuring system<br>
</div>

<br>

<div class="qheader">
6)Instrument is a device for determining ?</div>
<div class="qselections">
<input type="radio" value="a" name="question6">a)the magnitude of a quantity <br>
<input type="radio" value="b" name="question6">b)the physics of a variable<br>
<input type="radio" value="c" name="question6">c)either of the above<br>
<input type="radio" value="d" name="question6">d)both (a) and (b)<br>
</div>

<br>

<div class="qheader">
7)Electronic instruments are preferred because they have ?</div>
<div class="qselections">
<input type="radio" value="a" name="question7">a)no indicating part<br>
<input type="radio" value="b" name="question7">b)low resistance in parallel circuit<br>
<input type="radio" value="c" name="question7">c)very fast response<br>
<input type="radio" value="d" name="question7">d)high resistance in series circuit<br>
<input type="radio" value="d" name="question7">e)no passive elements<br>
</div>

<br>

<div class="qheader">
8)Basic charge measuring instrument is?</div>
<div class="qselections">
<input type="radio" value="a" name="question8">a)Duddel's oscillograph <br>
<input type="radio" value="b" name="question8">b)Cathode ray oscillograph<br>
<input type="radio" value="c" name="question8">c)Vibration Galvanometer<br>
<input type="radio" value="d" name="question8">d)Bailastic Galvanometer<br>
<input type="radio" value="d" name="question8">e)Battery Charging equipment<br>
</div>

<br>

<div class="qheader">
9)	A.C. voltage can be measured (using a d.c. instrument) as a value obtained?</div>
<div class="qselections">
<input type="radio" value="a" name="question9">a)6 <br>
<input type="radio" value="b" name="question9">b)15<br>
<input type="radio" value="c" name="question9">c)318<br>
<input type="radio" value="d" name="question9">d)375.<br>
</div>

<br>

<div class="qheader">
10)	Swamping resistance is used in moving coil instruments to reduce error due to ?</div>
<div class="qselections">
<input type="radio" value="a" name="question10">a)Thermal EMF<br>
<input type="radio" value="b" name="question10">b)Temperature<br>
<input type="radio" value="c" name="question10">c)Power taken by the instrument<br>
<input type="radio" value="c" name="question10">d)Galvanometer sensitivity.<br>
</div>
