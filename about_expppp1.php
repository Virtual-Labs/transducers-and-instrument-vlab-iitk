...
<a href="/virtuallab/user.php"<?php echo $fet['User_Email_Id'];?> <style="padding-right:0px; text-decoration:none;">Update Profile</a></div><?php } ?>  
	...
	<div id="page-bgbtm">
		...
		<div class="post-bgbtm">
				...
				<div class="entry">
				<h3 class="style4"><div align="center"><img src="images/ff2.JPG" alt="" width="544" height="258" /></div></h3><br>
				<div align="center"><font color="#000000">Measurement of temperature with thermocouple</font></div><br>
				<p>The emf of many thermocouples follows the quadratic relationship that shows curves for several combinations of metals, when one of the junctions, reference junction, is kept at a temperature  and the temperature of the other junction, the detecting junction, is the variable temperature (i.e. the temperature to be measured).<br>
				
				 

				<h3 class="style4"><font color="#000000">Construction of Thermocouples   </font></h3><p><br>In industrial applications the choice of materials used to make up a thermocouple depends upon the temperature range to be measured, the kind of atmosphere to</p>
				<p><div align="center"><img src="images/ff3.JPG" alt="" width="661" height="477" /></div><br>
				<div align="center"><font color="#000000">Table: Industrial Thermocouples</font></div><br>
				
				<br> 
				<p>which the material will be exposed, to output emf and its stability, mechanical strength, and the accuracy required in measurements. Thermocouple materials are divided into two categories:    (i) Rate metal types using platinum, rhodium, etc. and (ii) Base metal type.<br>
	Several combinations of dissimilar metals make good thermocouples for industrial use. These combinations apart from having linear response and high sensitivity, should be physically strong to withstand high temperatures, rapid temperature changes, and the effect of corrosive and reducing atmospheres. Based on years of experience in application of thermocouples, industry has standardized a few wire combinations.<br>
	A pair of two dissimilar metals that are in physical contact with each other form a thermocouple. These metals may be twisted, screwed, peened, clamped or welded together. The most commonly used method for fabricating is to weld the metals together.
				...
				<div ><strong></strong>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<strong>&nbsp;<a href="about_expppp.php"><INPUT 
                        TYPE=IMAGE 
                         SRC="images/back copy.jpg" />
				</a></strong>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="about_expppp2.php"><strong>
				<INPUT 
                        TYPE=IMAGE 
