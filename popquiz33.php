...
1)A ............ measure resistance indirectly by comparison with a similar resistance ?</div>
<div class="qselections">
<input type="radio" value="a" name="question1">a)Bridge<br>
<input type="radio" value="b" name="question1">b)Sensor<br>
...
<div class="qheader">
2)The ratio of the maximum expected change in the output voltage to the excitation voltage?</div>

<div class="qselections">
<input type="radio" value="a" name="question2">a)Sensitivity of the bridge<br>
<input type="radio" value="b" name="question2">b)coercivety<br>
<!--<input type="radio" value="c" name="question1">c) A jungle refers to the thickest area of a rain forest<br>
<input type="radio" value="d" name="question1">d) A jungle and a rain forest each contain their own group of distinct plants and animals.<br>-->
</div>
...
<div class="qheader">
3)The bridge which is most suited for temperature sensing using RTDs or thermistors?</div>
<div class="qselections">

<input type="radio" value="a" name="question3">a)Three element varying bridge<br>
<input type="radio" value="b" name="question3">b)Single element varying bridge<br>
<!--<input type="radio" value="c" name="question1">c) A jungle refers to the thickest area of a rain forest<br>
<input type="radio" value="d" name="question1">d) A jungle and a rain forest each contain their own group of distinct plants and animals.<br>-->
</div>
...
<div class="qheader">
4)The output of a single element varying bridge may be amplified by a......... OP-amp connected in the inverting mode ?</div>
<div class="qselections">
<input type="radio" value="a" name="question4">a)Double precision<br>
<input type="radio" value="b" name="question4">b)Single precision <br>
<!--<input type="radio" value="c" name="question1">c) A jungle refers to the thickest area of a rain forest<br>
<input type="radio" value="d" name="question1">d) A jungle and a rain forest each contain their own group of distinct plants and animals.<br>-->
</div>
...
<div class="qheader">
5)A ......... has the property of being able to conduct electrical current in the direction through itself, but not in the opposite direction ?</div>
<div class="qselections">
<input type="radio" value="a" name="question5">a)A semiconductor diode<br>
<input type="radio" value="b" name="question5">b)Transistor<br>
<!--<input type="radio" value="c" name="question1">c) A jungle refers to the thickest area of a rain forest<br>
<input type="radio" value="d" name="question1">d) A jungle and a rain forest each contain their own group of distinct plants and animals.<br>-->
</div>
...
<div class="qheader">
6)In an audio amplifier audio signals become garbled and hence difficult to understand when an ac input current is large enough to drive the output to  ?</div>
<div class="qselections">
<input type="radio" value="a" name="question6">a)saturation only <br>
<input type="radio" value="b" name="question6">b)Cut off only<br>
<input type="radio" value="c" name="question6">c)A value off the load line<br>
<input type="radio" value="d" name="question6">d)A value off the load line.<br>
</div>

<br>

<div class="qheader">
7)In a Wheatstone bridge, the know resistances are correct to within + 0.1%.  The  accuracy to which an unknown resistance can be measured will be ?</div>
<div class="qselections">
<input type="radio" value="a" name="question7">a)0.1%<br>
<input type="radio" value="b" name="question7">b)0.3%<br>
<input type="radio" value="c" name="question7">c)0.4%<br>
<input type="radio" value="d" name="question7">d)0.5%<br>
...
<div class="qheader">
8)In a Wheatstone bridge, all resistance are of value R ohms and the battery has zero internal resistance.  The value of the galvanometer resistance for the maximum sensitivity of the bridge should be ?</div>
<div class="qselections">
<input type="radio" value="a" name="question8">a)R ohms<br>
<input type="radio" value="b" name="question8">b)1.5 R ohms<br>
<input type="radio" value="c" name="question8">c)2 R ohms<br>
<input type="radio" value="d" name="question8">d)4 R ohms.<br>
...
<div class="qheader">
9)Wheatstone bridge is analogous to ?</div>
<div class="qselections">
<input type="radio" value="a" name="question9">a)gear train <br>
<input type="radio" value="b" name="question9">b)simple lever system<br>
<input type="radio" value="c" name="question9">c)cantilever<br>
...
<div class="qheader">
10)The bridge circuit given below employs a NTC of 2000 ohms resistance at ambient temperature.  When temperature falls, NTC resistance changes by 5 ohms.  The unbalanced voltage across the galvanometer would be?</div>
<div class="qselections">
<input type="radio" value="a" name="question10">a)2.2 mV<br>
<input type="radio" value="b" name="question10">b)1.2 V<br>
<input type="radio" value="c" name="question10">c)0.5 V<br>
<input type="radio" value="c" name="question10">c)	10.1 mV<br>
</div>
