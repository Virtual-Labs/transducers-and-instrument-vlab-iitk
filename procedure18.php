...
<?php if (isset($_SESSION['user'])) { ?>
	...
	<div id="page-bgbtm">
		...
		<div class="post-bgbtm">
			  ...
			  <div class="entry"><h3 class="style4"><font color="#000000">Procedure   </font></h3><br><p><b>1.</b>To perform the experiment first  install Lab VIEW Runtime Engine setup present in the website Setup link.<br />
<b>2.</b>  Now select the experiment you want to perform (online/ offline) from the experiments link.              
			    <br /><strong>A) Now if you opted for Resistive  Displacement Transducer,</strong><br />
			    <strong>a)</strong> Click to ON  the Switch
		        <p align="center"><img width="108" height="57" src="images/procedure18_clip_image002.jpg" /><br /></p>
                <p><b>b.</b> b) After switch on, the tap will open and water level in beaker starts to increase.</p>
                  <p align="center"><img width="256" height="232" src="images/procedure18_clip_image002_0000.jpg" /></p>As the water increases in the beaker the level of the water shows in analog and digital meter.<br />
                  <p><strong>c)</strong> When water level reaches at desired level then a message will display. Press OK  on message to close the tap and open the outlet valve.</p><p align="center"><img width="271" height="237" src="images/procedure18_clip_image002_0001.jpg" /></p>
                 ...
                 <p align="center"> <img width="271" height="222" src="images/procedure18_clip_image002_0002.jpg" /><br>
                    </p>
                  <h3 class="style4"><br>
</h3>
			  </div><div ><strong></strong>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="about experiment8.php"><strong><INPUT 
                        TYPE=IMAGE 
                         SRC="images/back copy.jpg" />
			     </strong></a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="procedure19.php"><strong>
			     <INPUT 
                        TYPE=IMAGE 
