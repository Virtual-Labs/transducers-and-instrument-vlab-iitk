...
<a href="/virtuallab/user.php"<?php echo $fet['User_Email_Id'];?> <style="padding-right:0px; text-decoration:none;">Update Profile</a></div><?php } ?>  
	...
	<div id="page-bgbtm">
		...
		<div class="post-bgbtm">
				<h1 class="title">Aim of the Experiment </h1>
				
				<div class="entry">
					 <p>Study of Spectrum analyzer. </p><p>                     
					 <!--<h3 class="style4"><font color="#000000">Apparatus Used</font>  </h3></p>
					 <p>  Computer running LabVIEW ,National Instruments (NI) USB data acquisition unit ,USB cable, Thermistor temperature sensor, Digital multi-meter that can read resistanceThermometer, Solid wire ,vessel of water</p>-->
					 <h4 class="style4">&nbsp;</h4>
					 <p>
				</div>
			</div>
			...
			<div class="post-bgtop">
	<div class="post-bgbtm">
				<h2 class="title"><font color="#000000">Apparatus Used</font></h2><P>
				
			  <div class="entry">
					<p>1. When signal is simulated externally through DAQ apparatus required are:</p>  
					<p> a. Computer with  LabVIEW Runtime Engine. </p>
					    <P>b. National Instruments (NI) USB data acquisition unit</P> 
						<P>2. When we are using computer generated signal we just need a computer with runtime engine. </P>
			...
			<div class="post-bgbtm">
				...
				<!--<p class="meta">Posted by <a href="#">Sushanth Poojary</a> on March 8, 2010
					&nbsp;&bull;&nbsp; <a href="#" class="comments">Comments</a>&nbsp; </p>	-->			<span class="style4"></span>
			  <div class="entry">
...
<p>Here we will create a LabVIEW virtual instrument (VI) that generates a waveform (sawtooth,square,triangle,sin manually or any of the desired waveform through DAQ ), uses one of the LabVIEW analysis functions to calculate the power spectrum of the signal with a Fast Fourier Transform (FFT), and creates a plot of the frequency spectrum.</p>
                                                                                                                                                                                                    <a href="about experiment2.php"><strong>
<INPUT 
                        TYPE=IMAGE 
