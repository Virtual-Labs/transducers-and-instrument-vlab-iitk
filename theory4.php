...
<?php if (isset($_SESSION['user'])) { ?>
	...
	<div id="page-bgbtm">
		...
		<div class="post-bgbtm">
			  ...
			  <div class="entry"><p><br>Lissajous Figures are a special case of parametric equations, where x and y are in the following form:<br>
x = A sin(at + δ)<br> 
y = B sin(bt + γ)<br>
Lissajous curves can be seen on oscilloscopes and are the result of combining 2 trigonometric curves at right angles.<br>
Consider any two branch variables in a circuit under ac steady-state conditions, which can be written
in general as<br>
x(t) = Xm cos (ωt + φx) y(t) = Ym cos (ωt + φy)<br>
The corresponding phasor ratio is Y/X = (Ym /φy)/(Xm /φx) = a /θ, where<br>
a = Ym/Xm θ = φy - φx<br>
which are the amplitude ratio and phase shift, respectively.<br>
One way of measuring these quantities involves the elliptical Lissajous figure produced by applying<br>
x(t) to the horizontal input of a scope and y(t) to the vertical input.</p>
				  <P><div align="center"><img src="images/ff1.JPG" alt="" width="645" height="253" /></div><br>
				  <p>As illustrated in  the above Fig, ymax appears in the first quadrant when -90° < θ < 90° and in the second quadrant when 90° < θ < 270°<br>
The peak-to-peak vertical excursion is A = 2Ym, and the peak-to-peak horizontal excursion is<br>
C = 2Xm. Hence, we can calculate the amplitude ratio via<br>
a = Ym/Xm = A/C<br>
To find the phase shift, we note that x(t) = 0 when ωt + φx = ±90°, so ωt = -φx ± 90°.<br>
Correspondingly, we have y(t) = Ym cos (φy - φx ± 90°) = Ym cos (θ ± 90°) = ±Ym sin θ, so<br>
B = 2Ym|sin θ| = A|sin θ| . Hence, we can calculate the phase shift via<br>
θ = ± sin-1 (B/A) -90° < θ < 90°<br>
= 180° ± sin-1 (B/A) 90° < θ < 270°<br>
The quadrant of θ must be determined by a dual-trace display or other means.
...
<a href="about experiment4.php"><INPUT 
                        TYPE=IMAGE 
