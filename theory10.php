...
<?php if (isset($_SESSION['user'])) { ?>
    ...
    <a href="logout.php" style="padding-right:10px;">Logout</a><a href="user.php"></a> <a href="user.php">Update Profile</a>
    </div>
    <?php } ?>  
    ...
    <div id="page-bgbtm">
        ...
        <div class="post-bgbtm">
                <div class="entry">
                  <h1><font color="#000000">Theory</font> </h1><p>Speed measurements are very important task according to the large use of motors, generators and other rotating devices. Also for the high speed of rotation other than speed is a function of many other variables such as acceleration and speed
</p>
                  <h3><font color="#000000">Sensors for RPM measurement: -</font></h3> <p> A sensor is necessary to sense shaft speed. Typical devices used for this purpose are shaft encoders (rotary pulse generators), proximit sensor, and photoelectric sensor.
Each of these devices sends speed data in factors affect the quality of this data:-</p>
                  1.	Number of pulses per revolution of the shaft .higher PPR values result in better resolution.<p>2.	Symmetry of pulses, the symmetry of one pulse to the next can play a role in how consistent the RPM readings are symmetrical pulses give more accurate data. </p><p> Various commercial sensors are available to measure the rotate Speeds of the engine categories are optical and magnetic. Magnetic Sensor such a magneto resistive is commonly used in practice to measure angular velocity. These sensors are employed because of its inexpensive, rugged, reliable and no contacting device that need no calibration. A magnetic pickup consists of a permanent magnet, a pole –piece and a sensing coil all encapsulated in a cylindrical case. An object of iron, steel or other magnetic material passing closely by its pole-piece causes distortion of the magnetic flux passing through the sensing coil and pole-Piece which in turn generates a signal voltage. The magnitude of the signal voltage depends on the relative size of the magnetic target.In this experiment there are the two sensors  are used to speed measurement-</p>
                  <ol>
                    <li>Photoelectric  Sensor</li>
                    <li>Magnetic  Sensor</li>
                  </ol>
                  </p>
               <h3><font color="#000000">A.	Photoelectric Sensor:-</font></h3>
               <p>Photoelectric sensor usually provides low resolution, due to the low number of pulses measured per revolution. A photoelectric sensor must sense a reflective target on the shaft.
If more than one target is used to increase the PPR, then the symmetry from one pulse to the next is likely to be poor. 
 </p>
                <div 
align="center"><img src="images/t10.jpg"  /><br />Figure 1 photoelectric sensor</div>
                <h3><font color="#000000">B.	Magnetic Sensor:-</font></h3><p>A magnetic pickup consists of a permanent magnet such as an Alnico, wrapped with a coil of a few thousand turns of fine enameled copper wire. The pickup is most often mounted on the body of the instrument, but can be attached to the bridge, neck, as on many electro-acoustic arch top jazz guitars and string basses. The vibration of the nearby soft-magnetic string modulates the magnetic flux linking the coil, there by inducing an alternating current through the coil of wire. The signal is then carried to amplification or recording equipment via a cable. There may also be an internal preamplifier stag described using the concept of a magnetic between the pickup and cable. More generally, the pickup operation can be described using the concept of a magnetic circuit in which the motion of the string varying the magnetic reluctance in the circuit created by the permanent Magnet.</p>
   <div 
align="center"><img src="images/t101.jpg"  /><br />Figure 2 magnetic pickup</div> <h4><font color="#000000">For photoelectric pickup-</font> </h4><p>A piece of reflecting mark is affixed at a point on the rotating object. The steady light source is focused on the reflecting mark. The light get reflected from the mark which is sensed by a Photodetector.it produces an electrical signal in the form of pulse. The reflected light produces one pulse per revolution
The electronic counting system consists of a gate and counter. The gate length Control as one input and a pulse from photodetector as the other input. The gate Pulse and revolution relation is known the counter converts the information into speed. The angular speed value is then gives value to the digital readout where it is displayed on a digital display. This display gives value of angular speed directly in RPM.
</p> <h4><font color="#000000">For magnetic pickup-</font> </h4><p>It consist of a cylindrical permaent magnet placed behind a soft-iron pole piece . The magnetic pickup sensor is placed is front of the shaft gear,made of ferrousmaterial Whose speed is to be measured. As the gear,rotates, the magnetic flux in the soft-iron pole Becomes high when the tooth of the ferromagnetic gear comes in front of the magnetic pick up,and the flux drops off as the tooth of the gear passed. Thus a voltage is genrated in the coil which is proportional to the rate of change of flux in the pole piece and also proportional to the speed at which the ferromagnetic gear make the flux bulid up. The output voltage waveform varies depending upon the teeth shape of the gear,thickness and spacing and the output voltage amplitude is proportional to the voltage build-up is linearly proportional to the learnce between tip and surface of the gera. The frequency of the voltage build-ups is linearly proportional to RPM. </p>
     <div align="right">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;                      
<a href="about experiment10.php"><INPUT 
                        TYPE=IMAGE 
                         SRC="images/back copy.jpg" /></a></div>
              </div>
            </div>
            </div>
            </div>
