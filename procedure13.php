...
<?php if (isset($_SESSION['user'])) { ?>
	...
	<div id="page-bgbtm">
		...
		<div class="post-bgbtm">
				...
				<div class="entry"><h3 class="style4"><font color="#000000">Procedure   </font></h3><br>
				  
				    <p><b>1.</b> To perform the experiment first install the LabVIEW Runtime Engine setup present in the website Setup link.<br />
                      <b>2.</b> Now select the experiment you want to perform (online/offline) from the Experiments link.<br>
                      <b>3.</b> Now follow the step by step procedure to perform the Experiments<br>
<b>4.</b> On the front panel of the vi as we can see contain a tab where we can select the type of waveform we want to take, the computer generated waveform or the waveform simulated through DAQ.<br>
<b>5.</b> Simulate the waveform either using DAQ or computer generated signal<br>.
(a)	Now if you are using DAQ for signal generation then input the sampling rate and no. of samples required per channel, here the temperature is varied from outside to get the waveform.<br>
<b>6.</b> In case of computer generated signal temperature can be varied using the knob from inside the set up, from which we can select the desired temperature and get the waveform.<br> 

<b>7.</b> After that we come to the type of bridges to be taken the ac  bridge or the dc bridge. If the ac bridge is selected there is a choice between two types of bridges: the Maxwell bridge or the Wien bridge, in case of DC bridge we have wheat stone bridge, the setup of all the bridges are available with a graph alongside.<br>
<b>8.</b>	The values of [Vs,R1,R2,R3] are taken to be constant.<br>
<b>9.</b> By entering the values of Rt, C1 and C2 will get the corresponding values thus the graph can be plotted using those values.</p>

<h3 class="style4"><font color="#000000">Results :   </font></h3><br><p>

  <span class="style5">For DC Bridge:</span><br>
  We can vary the resistance through the slider and the corresponding values of the output voltage can be obtain.<br>
  <span class="style5">For AC Bridge:</span><br/> 
  the variable capacitance C1 and C2 are taken through slider.<br>
  <span class="style5">For Maxwell bridge:</span><br/> 
  Rx=R2*R3/R1<br>
  <span class="style5"> For wien bridge:</span><br/> 
  f=1/2*3.14*(sqrt(C1*C3*R1*R3)).
  </p>
<h3 class="style4"><font color="#000000">Conclusion :</font></h3><br>
<p> 
For a single value entered here we get a single reading which is plotted thus we get a horizontal or a vertical graph or both for the given readings. 
</p>
			<div align="right">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;                       
