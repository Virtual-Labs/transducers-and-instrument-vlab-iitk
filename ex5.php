...
<?php if (isset($_SESSION['user'])) { ?>
	...
	<div id="page-bgbtm">
		...
		<div class="post-bgbtm">
				...
				<h3><p class="title"><a href="popquiz51.php"> Exercise (a)</a><br><br>
			<a href="popquiz52.php"> Exercise (b)</a><br><br>
			<a href="popquiz53.php"> Exercise (c)</a><br><br>
			<a href="popquiz54.php"> Exercise (d)</a><br><br>
			<a href="rotameterquiz5.php"> Exercise (e)</a></p></h3>
			<div align="right" ><strong></strong>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="about experiment5.php"><INPUT 
                        TYPE=IMAGE 
