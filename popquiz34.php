...
1)The simplest and most convenient from of director in a Wheatstone bridge for audio frequency range is?</div>
<div class="qselections">
<input type="radio" value="a" name="question1">a)galvanometer<br>
<input type="radio" value="b" name="question1">b)Vibration galvanometer<br>
<input type="radio" value="c" name="question1">c)Pair of headphones<br>
<input type="radio" value="d" name="question1">d)Cathode ray tube indicator<br>
</div>

<br>

<div class="qheader">
2)Which of the following indicators cannot be used in the bride shown below?</div>

<div class="qselections">
<input type="radio" value="a" name="question2">a)Ac voltmeter <br>
<input type="radio" value="b" name="question2">b)Earphones<br>
<input type="radio" value="c" name="question2">c)Tuning eye tubes<br>
<input type="radio" value="d" name="question2">d)None of these<br>
</div>

<br>

<div class="qheader">
3)Which of the following bridge is used to measure inductance of a low Q-inductor? A hay bridge is ?</div>
<div class="qselections">

<input type="radio" value="a" name="question3">a)Maxwell bridge<br>
<input type="radio" value="b" name="question3">b)Hay bridge<br>
<input type="radio" value="c" name="question3">c)Wien bridge<br>
<input type="radio" value="d" name="question3">d)Anderson bridge<br>
</div>

<br>

<div class="qheader">
4)The dielectric loss of a capacitance can be measured by ?</div>
<div class="qselections">
<input type="radio" value="a" name="question4">a)Wien bridge<br>
<input type="radio" value="b" name="question4">b)Owen bridge<br>
<input type="radio" value="c" name="question4">c)Schering bridge<br>
<input type="radio" value="d" name="question4">d)Maxwell bridge<br>
</div>

<br>

<div class="qheader">
5)In measurements made using a Q meter, high impedance elements should preferably be connected in ?</div>
<div class="qselections">
<input type="radio" value="a" name="question5">a)Star<br>
<input type="radio" value="b" name="question5">b)Delta<br>
<input type="radio" value="c" name="question5">c)Series<br>
<input type="radio" value="d" name="question5">d)Parallel<br>
</div>

<br>

<div class="qheader">
6)A digital voltmeter measures ?</div>
<div class="qselections">
<input type="radio" value="a" name="question6">a)peak value <br>
<input type="radio" value="b" name="question6">b)peak-to-peak value<br>
<input type="radio" value="c" name="question6">c)rms value<br>
<input type="radio" value="d" name="question6">d)average value<br>
</div>

<br>

<div class="qheader">
7)Which of the following meters has the best accuracy?</div>
<div class="qselections">
<input type="radio" value="a" name="question7">a)moving iron meter<br>
<input type="radio" value="b" name="question7">b)moving coil meter<br>
<input type="radio" value="c" name="question7">c)rectifier type meter<br>
<input type="radio" value="d" name="question7">d)thermocouple meter<br>
...
<div class="qheader">
8)The function of the safety resistor in ohm meter is to ?</div>
<div class="qselections">
<input type="radio" value="a" name="question8">a)limit the current in the coil<br>
<input type="radio" value="b" name="question8">b)increase the voltage drop across the coil<br>
<input type="radio" value="c" name="question8">c)increase the current in the coil<br>
<input type="radio" value="d" name="question8">d)protect the battery<br>
...
<div class="qheader">
9)Which of the following instruments is free from hysteresis and eddy current losses? ?</div>
<div class="qselections">
<input type="radio" value="a" name="question9">a)M.l. instrument<br>
<input type="radio" value="b" name="question9">b)electrostatic instrument<br>
<input type="radio" value="c" name="question9">c)electrodynamometer type instrument<br>
<input type="radio" value="d" name="question9">d)all of these.<br>
</div>

<br>

<div class="qheader">
10)The function of the safety resistor in ohm meter is to ?</div>
<div class="qselections">
<input type="radio" value="a" name="question10">a)limit the current in the coil<br>
<input type="radio" value="b" name="question10">b)increase the voltage drop across the coilResistance<br>
<input type="radio" value="c" name="question10">c)increase the current in the coil<br>
<input type="radio" value="d" name="question10">d)protect the battery<br>
</div>
