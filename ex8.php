...
<?php if (isset($_SESSION['user'])) { ?>
	...
	<div id="page-bgbtm">
		...
		<div class="post-bgbtm">
				<h1 class="title"><font color="#0000FF">Quiz Exercise </font></h1><br>
				<h3 class="title"><font color="#0000FF">NOTE - Fill All The Options.</font></h3>
				<h3><p class="title"><a href="displacementtransducerquiz1.php"> Exercise (a)</a><br><br>
			<a href="displacementtransducerquiz2.php"> Exercise (b)</a><br><br>
			<a href="displacementtransducerquiz3.php"> Exercise (c)</a><br><br>
			<a href="displacementtransducerquiz4.php"> Exercise (d)</a><br><br>
			<a href="displacementtransducerquiz5.php"> Exercise (e)</a></p></h3><div align="right"><br> <a href="about experiment8.php"><INPUT 
                        TYPE=IMAGE 
