...
<?php if (isset($_SESSION['user'])) { ?>
	...
	<div id="page-bgbtm">
		...
		<div class="post-bgbtm">
			  ...
			  <div class="entry"><p><strong>B)  Now if you opted for Capacitive Displacement Transducer</strong><br />
 <strong>a)</strong> Click to ON  the Switch. 
			  <p align="center"><img width="108" height="57" src="images/procedure20_clip_image002.jpg" /></p>
			  <strong>b)</strong> After switch on, the tap will open and water level in beaker starts to  increase.<br />
			  
			    <p align="center"><img width="309" height="247" src="images/procedure20_clip_image002_0005.jpg" /></p>
			    <p>As  the water increases in the beaker the level of the water shows in analog and  digital meter.</p>
			    <p><strong>c)</strong> When water level  reaches at desired level then a message will display. Press OK on message to close the tap 
			    and open  the outlet valve. </p>
			    <p align="center"><img width="345" height="273" src="images/procedure20_clip_image002_0006.jpg" /></p>
			    <p><strong>d)</strong> After that the tap will close and the outlet valve will open so that water level  starts to decrease in beaker.</p>
			    <p align="center"><img width="338" height="243" src="images/procedure20_clip_image002_0007.jpg" /></p>
			    <p><strong>e)</strong> When water level reaches at low level a massage will display. Press OK again.</p>
			    <p align="center"><img width="290" height="235" src="images/procedure20_clip_image002_0008.jpg" /></p>
			    <p><strong> f)</strong> According to change in water level in the  beaker a graph will generate between Change in capacitance and water level.</p>
			    <p align="center"><img width="328" height="193" src="images/procedure20_clip_image002_0009.jpg" /></p>
			    <p><strong>g)</strong> The another graph is showing the Actual versus Measured level according to  Analog    Scale and Digital Meter.<br />
                <p align="center">  <img width="358" height="228" src="images/procedure20_clip_image002_0010.jpg" /></p>
			    <p ><strong>h)</strong> Switch OFF the supply to STOP the Experiment</p>
			    <p align="center"><img width="108" height="57" src="images/procedure19_clip_image002_0002.jpg" /></p>
			    <h3 class="style4"><br>
</h3>
			  </div><div ><strong></strong>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="procedure19.php"><strong><INPUT 
                        TYPE=IMAGE 
                         SRC="images/back copy.jpg" />
			     </strong></a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="procedure21.php"><strong>
			     <INPUT 
                        TYPE=IMAGE 
