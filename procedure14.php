	...
	<div id="page-bgbtm">
		...
		<div class="post-bgbtm">
			  ...
			  <div class="entry"><h3 class="style4"><font color="#000000">Procedure   </font></h3><br><p><b>1.</b> To perform the experiment first install the LabVIEW Runtime Engine setup present in the website Setup link.<br />
					...
					<b>4.</b> As we can see on the front panel there are two graphs sinus A and sinus B, we can set the frequency and phase of the waves andget the lissajeous pattern accordingly.<br>
<b>5.</b> The other two graphs give the phase versus time and frequency versus time of the lissajeous pattern obtained with their magnitudes alongside.<br>
<b>6.</b> As we press the run button given above we get these graphs.
	...
	<div class="post-bgbtm">
		...
		<div id="sidebar">
			<ul>
				...
				<li>
					<h2>Live Help</h2><div align="center">
					<ul>
