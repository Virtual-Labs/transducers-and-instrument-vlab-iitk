...
<?php if (isset($_SESSION['user'])) { ?>
	...
	<div id="page-bgbtm">
		...
		<div class="post-bgbtm">
				...
				<div class="entry">
					 <p>Study of DAC using R-2R Ladder Network.</p><p>                     
	...
	<div class="post-bgbtm">
				...
				<div class="entry">
					...
					<p> a. Computer with  LabVIEW Runtime Engine. </p>
						...
						<P>2. When we use computer generated signal we just need a  computer with Runtime Engine. </P>
						</P></div>
			</div>
			</div>
			</div>
			...
			<div class="post-bgbtm">
				...
				<div class="entry">
					...
					<div align="right"><a href="about experiment7.php"><INPUT 
                        TYPE=IMAGE 
