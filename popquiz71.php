...
1)Convert the 101101 Binary number into octal no ?</div>
<div class="qselections">
<input type="radio" value="a" name="question1">a)55<br>
<input type="radio" value="b" name="question1">b)65<br>
...
<div class="qheader">
2) which logic gate has the output is compliment of its input ---------- ?</div>

<div class="qselections">
<input type="radio" value="a" name="question2">a)OR<br>
<input type="radio" value="b" name="question2">b)AND<br>
<input type="radio" value="c" name="question2">c)NOT<br>
<input type="radio" value="d" name="question2">d)X-OR<br>
</div>
...
<input type="radio" value="a" name="question3">a)10100<br>
<input type="radio" value="b" name="question3">b)1100<br>
<input type="radio" value="c" name="question3">c)010111<br>
<input type="radio" value="d" name="question3">d)None of these.<br>
</div>

<br>

<div class="qheader">
4) If the output of the gate is always high then the gates applied to this logic are 0,0?</div>
<div class="qselections">
<input type="radio" value="a" name="question4">a)NAND and EX-NOR<br>
<input type="radio" value="b" name="question4">b)NAND and NOR<br>
<!--<input type="radio" value="c" name="question1">c) A jungle refers to the thickest area of a rain forest<br>
<input type="radio" value="d" name="question1">d) A jungle and a rain forest each contain their own group of distinct plants and animals.<br>-->
</div>
...
<input type="radio" value="b" name="question5">b)5<br>
<!--<input type="radio" value="c" name="question1">c) A jungle refers to the thickest area of a rain forest<br>
<input type="radio" value="d" name="question1">d) A jungle and a rain forest each contain their own group of distinct plants and animals.<br>-->
</div>
...
<div class="qheader">
6) Thermal Run away is not possible in FET bcz the flow of ?</div>
<div class="qselections">
<input type="radio" value="a" name="question6">a)minority careers <br>
<input type="radio" value="b" name="question6">b)Tran conductance<br>
<!--<input type="radio" value="c" name="question1">c) A jungle refers to the thickest area of a rain forest<br>
<input type="radio" value="d" name="question1">d) A jungle and a rain forest each contain their own group of distinct plants and animals.<br>-->
</div>
...
<div class="qheader">
7) How many NAND gates are needed to realize OR gate ------------- ?</div>
<div class="qselections">
<input type="radio" value="a" name="question7">a)1 <br>
<input type="radio" value="b" name="question7">b)2<br>
<input type="radio" value="c" name="question1">c)3<br>
<input type="radio" value="d" name="question1">d)4<br>
</div>

<br>

<div class="qheader">
8) The resolution for a DAC is given by 0.4% then no. of bits of DAC is?</div>
<div class="qselections">
<input type="radio" value="a" name="question8">a)8- bits<br>
<input type="radio" value="b" name="question8">b)16- bits<br>
<!--<input type="radio" value="c" name="question1">c) A jungle refers to the thickest area of a rain forest<br>
<input type="radio" value="d" name="question1">d) A jungle and a rain forest each contain their own group of distinct plants and animals.<br>-->
...
<div class="qheader">
9) How many flip-flops are required to construct Mod -12 counter?</div>
<div class="qselections">
<input type="radio" value="a" name="question9">a)5 <br>
<input type="radio" value="b" name="question9">b)4<br>
<!--<input type="radio" value="c" name="question1">c) A jungle refers to the thickest area of a rain forest<br>
<input type="radio" value="d" name="question1">d) A jungle and a rain forest each contain their own group of distinct plants and animals.<br>-->
</div>
...
<div class="qheader">
10)According to Boolean algebra 1+A+B+C =  ?</div>
<div class="qselections">
<input type="radio" value="a" name="question10">a)A<br>
<input type="radio" value="b" name="question10">b)A+B+C<br>
<input type="radio" value="c" name="question10">c) 1<br>
</div>
