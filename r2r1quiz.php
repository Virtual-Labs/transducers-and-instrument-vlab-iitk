...
1) Which of the following error is common in digital to analog converter ?</div>
<div class="qselections">
<input type="radio" value="a" name="question1">a) Nonmonotonic error<br>
<input type="radio" value="b" name="question1">b) Incorrect output codes<br>
<input type="radio" value="c" name="question1">c) Offset error<br>
<input type="radio" value="d" name="question1">d) Nonmonotonic error and output codes<br>

<br>

<div class="qheader">
2) The practical use of binary-weighted digital-to-analog converters is limited to ?</div>
<div class="qselections">
<input type="radio" value="a" name="question2">a) R/2R ladder D/A converter<br>
<input type="radio" value="b" name="question2">b) 4-bit d/a converter<br>
<input type="radio" value="c" name="question1">c) 8-bit d/a converter<br>
<input type="radio" value="d" name="question1">d) Op amp comparators<br>
</div>

<br>

<div class="qheader">
3) Convert the 101101 Binary number into octal no ?</div>
<div class="qselections">

<input type="radio" value="a" name="question3">a) 65 <br>
<input type="radio" value="b" name="question3">b) 55 <br>
<input type="radio" value="c" name="question1">c) 51 <br>
<input type="radio" value="d" name="question1">d) 45 <br>
</div>
...
4) 10 in BCD ?</div>
<div class="qselections">
<input type="radio" value="a" name="question4">a) 10100<br>
<input type="radio" value="b" name="question4">b) 1100 <br>
<input type="radio" value="c" name="question1">c) 010111 <br>
...
<div class="qheader">
5) The radix or base of hexadecimal number system is ----------- ?</div>
<div class="qselections">
<input type="radio" value="a" name="question5">a) 8<br>
<input type="radio" value="b" name="question5">b) 16<br>
<input type="radio" value="c" name="question1">c) 5<br>
<input type="radio" value="d" name="question1">d) none of these<br>
</div>
...
<div class="qheader">
6) How many flip-flops are required to construct Mod -12 counter ?</div>
<div class="qselections">
<input type="radio" value="a" name="question6">a) 5 <br>
<input type="radio" value="b" name="question6">b) 4<br>
<input type="radio" value="c" name="question6">c) 12<br>
<input type="radio" value="d" name="question6">d) None<br>
</div>

<br>

<div class="qheader">
7) which logic gate has the output is compliment of its input ---------- ?</div>
<div class="qselections">
<input type="radio" value="a" name="question7">a) OR<br>
<input type="radio" value="b" name="question7">b) AND<br>
<input type="radio" value="c" name="question7">c) NOT<br>
<input type="radio" value="d" name="question7">d) X-OR<br>
...
<div class="qheader">
8) By adding inverters to the inputs and output of a AND gate we can obtain. …………… ?</div>
<div class="qselections">
<input type="radio" value="a" name="question8">a) OR <br>
<input type="radio" value="b" name="question8">b) AND<br>
<input type="radio" value="c" name="question8">c) NOT<br>
<input type="radio" value="d" name="question8">d) X-OR <br>
...
<div class="qheader">
9) How many NAND gates are needed to realize OR gate ------------- ?</div>
<div class="qselections">
<input type="radio" value="a" name="question9">a) 1 <br>
<input type="radio" value="b" name="question9">b) 2<br>
<input type="radio" value="c" name="question9">c) 3<br>
<input type="radio" value="d" name="question9">d) 4<br>
</div>

<br>

<div class="qheader">
10)  Which logic gate has output high if and only if all inputs are low --------- ?</div>
<div class="qselections">
<input type="radio" value="a" name="question10">a) NOR <br>
<input type="radio" value="b" name="question10">b) NAND <br>
<input type="radio" value="c" name="question10">c) X-NOR<br>
<input type="radio" value="c" name="question10">c) AND<br>
</div>
