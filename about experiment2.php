...
<a href="/virtuallab/user.php"<?php echo $fet['User_Email_Id'];?> <style="padding-right:0px; text-decoration:none;">Update Profile</a></div><?php } ?>  
	...
	<div id="page-bgbtm">
		...
		<div class="post-bgbtm">
				&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
				<h1 class="title">Spectrum Analyzer </h1>
				
				<div class="entry">
				 <ul>
				   <li><h3><a href="aim_of_exp1.php">Aim of Experiment</a></h3>&nbsp;&nbsp;&nbsp;&nbsp;
				   <li><h3><a href="about_exp1.php">
						About Experiment</a></h3>&nbsp;&nbsp;&nbsp;&nbsp;
				   <li><h3><a href="theory2.php">Theory</a></h3>&nbsp;&nbsp;&nbsp;&nbsp;
				   <li><h3><a href="procedure12.php">Procedure</a></h3>&nbsp;&nbsp;&nbsp;&nbsp;
				  <!-- <li><h3><a href="http://202.141.40.214:50001/Spectra_.html">Simulation</a></h3>&nbsp;&nbsp;&nbsp;&nbsp;

				   <li><h3><a href="Spectrum Analyzer.exe">Download</a></h3>&nbsp;&nbsp;&nbsp;&nbsp;-->
					<li><h3><a href="ex2.php">Quiz</a></h3>&nbsp;&nbsp;&nbsp;&nbsp;<li><h3><a href="p_experiment2.php">Perform Experiment</a></h3></li>&nbsp;&nbsp;&nbsp;&nbsp;<li><h3><a href="SPECTRAL ANALYSIS.pdf">Experiment Manual</a></h3>&nbsp;&nbsp;&nbsp;&nbsp;</li>
