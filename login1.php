...
</h1><h4><font color="#006666"><div align="center"><font color="#006666">Transducer &amp; Instrumentation Virtual Laboratory </font></div><p></p><div><font color="#000000">Your login detail sent to your mail id Successful.</font></div>
</font></h4>
<div align="center" class="style10"><h3>User Login 
        </h3></div>
<form name="form1" method="post" action="" id="form1">
        <p>&nbsp;</p>
       <p align="center"><strong><span class="style3">Your Email</span></strong>:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
          <input name="User_Email" type="text" id="User_Email">
       </p>
       <p align="center">
       </p>
       <p align="center"> <strong><span class="style3">Password:</span></strong>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
          <input name="Password" type="password" id="Password" >
        </p>
        <p align="center"> 
          <input type="Submit" name="Submit" value="Submit" id="Submit" >
        </p>
        <p align="center"><a href="Myregistration.php" style="text-decoration:none;"> New User Register Here </a> ~ <a href="index.php" style="text-decoration:none;">BACK</a> ~ <a href="forgot.php" style="text-decoration:none;">Forgot Password</a></p>
      </form></td>
      </div>
              </div>
          </div>
