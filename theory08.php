...
<?php if (isset($_SESSION['user'])) { ?>
	...
	<div id="page-bgbtm">
		...
		<div class="post-bgbtm">
				...
				<div class="entry">
					 <p align="left"><strong><font color="#000000"><h3 > Resistive Displacement Transducer:</h3></font></strong><strong> -</strong></p>
					 <p>The principle of the resistive position  transducer is that the measured quantity causes a resistance change in the  sensing element.<br />
					   A common type of resistive displacement  transducers uses a resistive element with a sliding contact linked to the  object being monitored (a contact type transducer).  For this purpose, a variant of the voltage  divider called a potentiometer (or simply a pot) can be used.</p>
					 <p><font color="#000000"><h4 class="style5">Potentiometer:-</h4></font> 
<p>A potentiometer (colloquially known as a pot) is a three-terminalresistor with a sliding  contact that forms an adjustable voltage divider. If  only two terminals are used (one side and the wiper), it acts as a variable resistor or rheostat. Potentiometers are  commonly used to control electrical devices such as volume controls on audio  equipment. Potentiometers operated by a mechanism can be used as position transducers,  for example, in a joystick.<br />
