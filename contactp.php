...
<div id="wrapper">
	<div id="header">
	  ...
	  <h1>Virtual Labs -IIT Kanpur</h1>
					<br><p>Transducers and Instrumentation Virtual lab </p></div></div>
					<div id="menu">
		<ul>
...
<a href="/virtuallab/user.php"<?php echo $fet['User_Email_Id'];?> <style="padding-right:0px; text-decoration:none;">Update Profile</a></div><?php } ?>  
	...
	<div id="page-bgbtm">
		...
		<div class="post-bgbtm">
			  ...
			  <div class="entry">
			    <p>                <h1>Project Team</h1><br>
		        
			      <table width="660" border="0">
                    <tr>
                      <th width="556" scope="row"> <h2 align="left"><b><br>
			        <a href="http://home.iitk.ac.in/~nishchal"><font color="#0033FF"><strong>Dr.Nishchal K.Verma(Project Investigator)</strong></font></a></h2>
			        </th>
                      <td width="94"><a href="contactp.php"><INPUT 
                        TYPE=IMAGE 
                         SRC="images/p1.gif"
                          HEIGHT=85 WIDTH=75 
                           align="right" />
			    &nbsp;</a></td>
				  ...
				  <table width="660" border="0">
                    <tr>
                      <th width="557" scope="row"> <h2 align="left"><b><br>
			       <a href="http://home.iitk.ac.in/~ynsingh"> <font color="#0033FF"><strong>Dr.Y.N.Singh(Co.Project Investigator)</strong></font></a><br/></h2>
                       </th>
                      <td width="93"><a href="contactp.php"><INPUT 
                        TYPE=IMAGE 
                         SRC="images/ynsingh.jpg"
                          HEIGHT=85 WIDTH=75 
                           align="right" />
			    &nbsp;</a></td>
                    </tr>
					...
					<table width="660" border="0">
                    <tr>
                      <th width="559" scope="row"> <h2 align="left"><font color="#0033FF"><b><br>
			        Tanu Shukla</b></font></h2>
                       </th>
                      <td width="91"><a href="contactp.php"><INPUT 
                        TYPE=IMAGE 
                         SRC="images/TANU SHUKLA.jpg"
                          HEIGHT=85 WIDTH=75 
                           align="right" />
			    &nbsp;</a></td>
                    </tr>
			      ...
			      <table width="660" border="0">
                    <tr>
                      <th width="562" scope="row"> <h2 align="left"><font color="#0033FF"><b><br>
			        Manuj Bhatt</b></font></h2>
                       </th>
                      <td width="88"><a href="contactp.php"><INPUT 
                        TYPE=IMAGE 
                         SRC="images/manuj.jpg"
                          HEIGHT=85 WIDTH=75 
                           align="right" />
			    &nbsp;</a></td>
                    </tr>
					...
					<table width="660" border="0">
                    <tr>
                      <th width="563" scope="row"> <h2 align="left"><font color="#0033FF"><b><br>
			       Neeraj Jain</b></font></h2>
                       </th>
                      <td width="87"><a href="contactp.php"><INPUT 
                        TYPE=IMAGE 
			    ...
			    &nbsp;</a></td>
			      ...
			      <table width="660" border="0">
			        ...
			        Rishi Gupta</b></font></h2>
                       </th>
                      <td width="87"><a href="contactp.php"><INPUT 
                        TYPE=IMAGE 
                         SRC="images/Rishi Photo.jpg"
                          HEIGHT=85 WIDTH=75 
                           align="right" />
			    &nbsp;</a></td>
                    </tr>
			    ...
			    &nbsp;</a></td>
					...
					<p>&nbsp;</p><table width="660" border="0">
                    <tr>
                      <th width="563" scope="row"> <h2 align="left"><font color="#0033FF"><b><br>
			        Saikiran Bonthu</b></font></h2>
                       </th>
                      <td width="87"><a href="contactp.php"><INPUT 
                        TYPE=IMAGE 
