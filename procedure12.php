...
<b>4.</b> The input signal used in the present experiment can either be taken from DAQ,  externally or computer generated signals can be used as input to get the frequency spectrum of the respective signals (sine, square, triangle, sawtooth).<br>
<b>5.</b> In case of DAQ the sampling rate and no. of samples taken per channel needs to be entered by the user and input the desired waveforms to get their frequency spectrum.<br>
<b>6.</b> Computer generated waveforms can also be used to plot the frequency spectrum.<br>
<b>a.</b>Choose the type of waveform(sawtooth,sin,square,triangular)u want to use.<br>
<b>b.</b>Set the amplitude and frequency value with the help of knob
<b>7.</b> Run the vi using run button.
<h3 class="style4"><font color="#000000">Results</font></h3><br><p>The spectrum analyzer works by calculating the fast Fourier transform of the signal. Here we show the results for a single sample in case of a sawtooth waveform with computer generated signal. The given value of power is one of the values when the vi is stopped randomly.<br>
At frequency =2, and amplitude=4, power (dB) = 0.981<br>
At frequency =4, and amplitude=6, power (dB) = 1.08<br>
At frequency =8, and amplitude=6, power (dB) = 5.7<br>
At frequency =6, and amplitude=2, power (dB) = 1.36<br>
At frequency =6, and amplitude=10, power (dB) = 3.7</p>
<div align="right">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;                       
<a href="about experiment2.php"><INPUT 
                        TYPE=IMAGE 
