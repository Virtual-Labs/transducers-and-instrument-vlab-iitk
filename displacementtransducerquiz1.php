...
<script src="displacementtransducerquiz1.js">
</script>
...
1) How many secondary coils are there in LVDT ?</div>
<div class="qselections">
<input type="radio" value="a" name="question1">a) One<br>
<input type="radio" value="b" name="question1">b) Two<br>
<!--<input type="radio" value="c" name="question1">c) accelerating anodes<br>
<input type="radio" value="d" name="question1">d) post-accelerating.<br>-->
</div>

<br>

<div class="qheader">
2) In a CRT the focusing anode is located ?</div>
<div class="qselections">
<input type="radio" value="a" name="question2">a) Strain gauge<br>
<input type="radio" value="b" name="question2">b) a) Microphone<br>
<input type="radio" value="c" name="question1">c) Potentiometer<br>
<input type="radio" value="d" name="question1">d) Thermocouple<br>
</div>

<br>

<div class="qheader">
3) Which transducer converts heat energy into electrical energy ?</div>
<div class="qselections">

<input type="radio" value="a" name="question3">a) LVDT <br>
<input type="radio" value="b" name="question3">b) Thermocouple <br>
<input type="radio" value="c" name="question1">c) Photoconductor <br>
<input type="radio" value="d" name="question1">d) None of the above <br>
</div>

<br>

<div class="qheader">
4) Which of the following is electromechanical device ?</div>
<div class="qselections">
<input type="radio" value="a" name="question4">a) Direct current motor<br>
<input type="radio" value="b" name="question4">b) LVDT <br>
<input type="radio" value="c" name="question1">c) Induction relay <br>
...
<div class="qheader">
5) A potentiometer is ?</div>
<div class="qselections">
<input type="radio" value="a" name="question5">a) An active transducer<br>
<input type="radio" value="b" name="question5">b) A passive transducer<br>
<input type="radio" value="c" name="question1">c) A secondary transducer<br>
<input type="radio" value="d" name="question1">d) A current sensing transducer<br>
</div>

<br>

<div class="qheader">
6) What is the appropriate SI unit for distance ?</div>
<div class="qselections">
<input type="radio" value="a" name="question6">a) Centimeters <br>
<input type="radio" value="b" name="question6">b) Inches<br>
<input type="radio" value="c" name="question6">c) Meters<br>
<input type="radio" value="d" name="question6">d) Kilometers<br>
</div>

<br>

<div class="qheader">
7) LVDT is always used as ?</div>
<div class="qselections">
<input type="radio" value="a" name="question7">a) Secondary transducer<br>
<input type="radio" value="b" name="question7">b) Primary transducer<br>
<input type="radio" value="c" name="question7">c) Primary signal generator<br>
<input type="radio" value="d" name="question7">d) None of above<br>
...
<div class="qheader">
8) Which transducer converts heat energy into electrical energy ?</div>
<div class="qselections">
<input type="radio" value="a" name="question8">a) L.V.D.T. <br>
<input type="radio" value="b" name="question8">b) thermocouple<br>
<input type="radio" value="c" name="question8">c) photoconductor<br>
...
<div class="qheader">
9) The energy of a charged capacitor resides in ?</div>
<div class="qselections">
<input type="radio" value="a" name="question9">a) The electric field only <br>
<input type="radio" value="b" name="question9">b) The magnetic field only<br>
<input type="radio" value="c" name="question9">c) Both the electric and magnetic field<br>
<input type="radio" value="d" name="question9">d) Neither in electric nor magnetic field stroke<br>
</div>

<br>

<div class="qheader">
10) Capacity of a parallel plate condenser can be increased by ?</div>
<div class="qselections">
<input type="radio" value="a" name="question10">a) Increasing the distance between the plates <br>
<input type="radio" value="b" name="question10">b) Decreasing the thickness of the plates <br>
<input type="radio" value="c" name="question10">c) Decreasing the distance between the plates<br>
<input type="radio" value="c" name="question10">c) Increasing the thickness of the plates<br>
</div>
