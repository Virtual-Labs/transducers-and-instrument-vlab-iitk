...
<?php if (isset($_SESSION['user'])) { ?>
	...
	<div id="page-bgbtm">
		...
		<div class="entry">
					        <li>If the  displacement <em>x </em>causes the effective area to decrease by <em>ax</em>, the  capacitance of the sensor becomes-</li>                                                  
<div align="center"><img src="images/d10.jpg" alt="" /></div>
This is linear in x.
               
<div align="center"><img src="images/d11.jpg" alt="" /></div><br/>
<b><span class="style5"></span></b>
<h2><font color="#000000">Inductive Displacement Transducer:</font></h2>
<b><span class="style5"></span></b><br />
<b><span class="style5"><h4 >Introduction of L.V.D.T.: -</h4></span></b> <p>The letters LVDT are an acronym for Linear Variable Differential Transformer   , a common type of electromechanical transducer that can convert the rectilinear motion of an object to which it is coupled mechanically into a corresponding electrical signal. LVDT linear position sensors are readily available that can measure movements as small as a few millionths of an inch up to several inches, but are also capable of measuring positions up to ±20 inches (±0.5 m).</p>
<b><span class="style5"><h4>Basic Technology of L.V.D.T.: -</h4></span></b> 
  <p>Linear Variable Differential Transformer is a sensor that uses a differential transformer with a sliding magnetic core to sense displacement.  LVDTs are driven by an AC excitation source(0 to 15Vrms), typically a sine wave in the 50 to 20 kHz range, and generate an AC output signal that is proportional to the mechanical position of the core.</p> <br />

<b><span class="style5"><h4>Construction of L.V.D.T.: -</h4></span> </b><p>The basic construction of an LVDT is shown in Figure 2. The device consists of a primary coil, two secondary coils, and a moveable magnetic core which is connected to an external device whose position is of interest. A sinusoidal excitation is applied to the primary coil, which couples with the secondary coils through the magnetic core (ie. voltages are induced in the secondary coils). The position of the magnetic core determines the strength of coupling between the primary and each of the secondary cores, and the difference between the voltages generated across each of the secondary cores is proportional to the displacement of the core from the neutral position, or null point.</p>
<div align="center"><img src="images/d12.jpg" alt="" /></div>
<b><span class="style5"><h4>Working of L.V.D.T.: -</h4></span></b> <p>Figure 2 illustrates what happens when the LVDT's core is in different axial positions. The LVDT's primary winding, P, is energized by a constant amplitude AC source. The magnetic flux thus developed is coupled by the core to the adjacent secondary windings, S1 and S2. If the core is located midway between S1 and S2, equal flux is coupled to each secondary so the voltages, E1 and E2, induced in windings S1 and S2 respectively, are equal. At this reference midway core position, known as the null point, the differential voltage output, (E1 - E2), is essentially zero.
	
Displacing the core to the left (Figure 3) causes the first secondary (S1) to be more strongly coupled to the primary than the second secondary (S2). The resulting higher voltage E1 of the first secondary in relation to the second secondary E2 causes an output voltage (E1-E2) that is in phase with the primary voltage.</p>
<div align="center">
  <p><img src="images/d13.jpg" alt="" /></p>
  <p align="center">Figure3: Coe Movement at Left Side</p>
  <p>&nbsp;</p>
</div>

<p><br/>
</p>
<div ><strong></strong>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="about_exp17.php"><INPUT 
                        TYPE=IMAGE 
                         SRC="images/back copy.jpg" />
</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="about_exp1117.php">
<INPUT 
                        TYPE=IMAGE 
